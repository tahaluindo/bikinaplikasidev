...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-indigo-600"
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center">
            ...
            <span class="navbar-brand-text hidden-xs-down"> <img src="{{ url('image/logo.png') }}" height="40"
                                                                 style="margin-top: -10px;">  {{ env('APP_OBJECT_NAME') }}</span>
        </div>
...
<!-- Core  -->
<script
    src="{{ url('') }}/global/vendor/babel-external-helpers/babel-external-helpers599c.js?v4.0.2"></script>
