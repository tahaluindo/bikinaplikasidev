                    ...
                    <select class="form-control form-control-line" name='status'>
                        <?php $__currentLoopData = ['', 'Selesai', 'Belum Selesai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"
                                    <?php if(old('status')==$status): ?> selected <?php endif; ?>><?php echo e($status); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="number" placeholder="<?php echo e($limit); ?>" class="form-control form-control-line"
                           id="example-limit"
                           value='<?php echo e(old('limit') == "" ? $limit : old('limit')); ?>' name='limit' max='<?php echo e($limit); ?>'
                           min=1 required>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-andri.bikinaplikasi.dev\resources\views/layouts/peminjaman/laporan/index.blade.php ENDPATH**/ ?>