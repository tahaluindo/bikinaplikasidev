    ...
    <div class="page">
        <div class="page-header h-300 mb-30">
            <div class="text-center blue-grey-800 mt-50 m-xs-0">
                <div class="font-size-50 mb-30 blue-grey-800"><?php echo e(env('APP_OBJECT_NAME')); ?></div>
                <ul class="list-inline font-size-14">
                    <li class="list-inline-item">
                        <i class="icon wb-map mr-5" aria-hidden="true"></i> <?php echo e(env('APP_OBJECT_DESCRIPTION')); ?>
                ...
                <div class="col-xxl-3 col-xl-4">
                    ...
                    <div class="card card-shadow">
                        <div class="card-block text-center bg-white p-40">
                            ...
                            <p class="blue-grey-400 mb-20"><?php echo e(auth()->user()->level); ?></p>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-andri.bikinaplikasi.dev\resources\views/home.blade.php ENDPATH**/ ?>