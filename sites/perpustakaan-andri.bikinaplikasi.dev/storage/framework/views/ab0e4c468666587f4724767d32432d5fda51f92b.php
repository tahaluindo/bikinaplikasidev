                    ...
                    <select class="form-control form-control-line" name='jenis_kelamin'>
                        <?php $__currentLoopData = ['', 'Laki - Laki', 'Perempuan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_kelamin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($jenis_kelamin); ?>"
                                    <?php if(old('jenis_kelamin')==$jenis_kelamin): ?> selected <?php endif; ?>>
                    ...
                    <select class="form-control form-control-line" name='status'>
                        <?php $__currentLoopData = ['', 'Aktif', 'Tidak Aktif']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"
                                    <?php if(old('status')==$status): ?> selected <?php endif; ?>><?php echo e(ucwords($status)); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-line" name='field' required>
                        <?php $__currentLoopData = ['id','no_identitas','nama','jenis_kelamin','alamat','no_telepon','status','dibuat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp2\htdocs\perpustakaan-andri.bikinaplikasi.dev\resources\views/layouts/anggota/laporan/index.blade.php ENDPATH**/ ?>