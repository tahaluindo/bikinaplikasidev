<div class="form-group <?php echo e($errors->has('anggota_id') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <input list="anggota_id" class="form-control form-control-line" required name="anggota_id" value="<?php echo e(isset($peminjaman->anggota_id) ? $peminjaman->anggota_id : ""); ?>">
        ...
        <datalist id="anggota_id" >
            ...
            <option value="<?php echo e($anggota->id); ?>" <?php echo e((isset($peminjaman->anggota_id) && $peminjaman->anggota_id == $anggota->id) || old('anggota_id') == $anggota->id ? 'selected' : ''); ?>><?php echo e("$anggota->nama (no identitas: $anggota->no_identitas)"); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="tanggal" type="text" id="tanggal" value="<?php echo e(isset($peminjaman->tanggal) ? $peminjaman->tanggal : (old('tanggal') == "" ? date('Y-m-d') : old('tanggal'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="tanggal_pengembalian" type="text" id="tanggal_pengembalian" value="<?php echo e(isset($peminjaman->tanggal_pengembalian) ? $peminjaman->tanggal_pengembalian : (old('tanggal_pengembalian') == "" ? now()->addday(env('APP_WAKTU_TERLAMBAT'))->format('Y-m-d') : old('tanggal_pengembalian'))); ?>" required>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-andri.bikinaplikasi.dev\resources\views/peminjaman/form.blade.php ENDPATH**/ ?>