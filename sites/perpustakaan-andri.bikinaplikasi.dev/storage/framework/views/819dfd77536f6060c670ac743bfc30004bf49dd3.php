...
unset($__errorArgs, $__bag); ?>" name="tanggal"
            type="text" id="tanggal" value="<?php echo e(isset($pengembalian->tanggal) ? $pengembalian->tanggal : now()->format('Y-m-d')); ?>"
            required>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-andri.bikinaplikasi.dev\resources\views/pengembalian/form.blade.php ENDPATH**/ ?>