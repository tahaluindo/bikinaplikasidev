...
class AnggotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $requestData = $request->except(['level']);
    ...
    public function update(Request $request, Anggota $anggota)
    {
        ...
        $requestData['user_id'] = $anggota->user_id;
    ...
    public function print(Request $request)
    {
        ...
        $tanggal_awal = $request->tanggal_awal ? $request->tanggal_awal : (Anggota::get()->first()->created_at ?? date('d-M-Y'));
        $tanggal_akhir = $request->tanggal_akhir ? $request->tanggal_akhir : (Anggota::get()->last()->created_at ?? date('d-M-Y'));
