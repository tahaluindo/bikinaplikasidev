...
class BukuController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $tanggal_awal = $request->tanggal_awal ? $request->tanggal_awal : (Buku::get()->first()->created_at ?? date('d-M-Y'));
        $tanggal_akhir = $request->tanggal_akhir ? $request->tanggal_akhir : (Buku::get()->last()->created_at ?? date('d-M-Y'));
