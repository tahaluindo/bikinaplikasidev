                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item @if($index ==0 ) active @endif">
                                        <img class="d-block w-100" src="{{ url($foto) }}" alt="{{ $index }} slide" style='width: 100%;'>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal form-material" action="{{ url(route('komentar.store')) }}"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <textarea style="height: 100px !important;"
                                            ...
                                            name='isi' @if(in_array(auth()->user()->level, ['tu', ''])) disabled @endif>{{ old('isi') }}</textarea>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary btn-block" type="submit" @if(in_array(auth()->user()->level, ['tu', ''])) disabled @endif>
