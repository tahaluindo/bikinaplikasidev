...
<!-- BOOTSTRAP STYLES-->
    ...
    <style>
        ...
        #page-inner {
            ...
            padding: 10px;
            min-height: 1200px;
            background-image: url("{{ url('image/background-dashboard.jpg') }}");
...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation"
         style="margin-bottom: 0; background-color: #2B3A55;">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li>
                    <div class="user-img-div text-center" style="background-color: #E8C4C4;">
        ...
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line" style="@if(Request::segment(1) == 'dashboard')color: white !important; @endif">
...
<script>
    $(document).ready(function () {
        ...
        $('#uang_pembeli').keyup(function() {
            ...
            var total = {{ $penjualan_detail->sum('total') }}
            var uang_pembeli = parseInt($(this).val())
