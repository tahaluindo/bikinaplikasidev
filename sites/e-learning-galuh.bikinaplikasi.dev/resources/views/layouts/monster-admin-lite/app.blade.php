...
<head>
    ...
    <title>E-LEARNING SMA NEGERI 12 KOTA JAMBI</title>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <h3 class="mt-3 ml-4 text-white"
                                ...
                                E-LEARNING SMA NEGERI 12 KOTA JAMBI
                            </h3>
                        </li>
                    </ul>
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark"
                                ...
                                aria-expanded="false"><img src="{{ Str::length(auth()->user()->foto) <= 3 ? Avatar::create(auth()->user()->nama)->toBase64() : url(auth()->user()->foto) }}" alt="user"
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="{{ route('soal.index') }}" class="waves-effect @if(in_array(request()->segment(1), ['soal_essay', 'soal_pilgan'])) active @endif"><i class="fa fa-table m-r-10"
                    ...
                    <div class="text-center m-t-30">
                        <form action="{{ url(route('logout')) }}" method='post' style='display: inline;' method="post" onsubmit='return confirm("Yakin akan logout?");'>
                            @csrf
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                © 2020 E-LEARNING SMA NEGERI 12 KOTA JAMBI
            </footer>
        </div>
    </div>
