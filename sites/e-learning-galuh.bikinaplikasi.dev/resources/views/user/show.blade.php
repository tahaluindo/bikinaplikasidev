            ...
            <div class="card">
                <div class="card-block">
                    <center class="m-t-30"> 
                        ...
                        <img src="{{ Str::length(auth()->user()->foto) <= 3 ? Avatar::create(auth()->user()->nama)->toBase64() : url(auth()->user()->foto) }}" class="img-circle" width="150" />
                        @else
                        <img src="{{ Str::length($user->foto) <= 3 ? Avatar::create($user->nama)->toBase64() : url($user->foto) }}" class="img-circle" width="150" />
                        @endif
                        ...
                        <div class="row text-center justify-content-md-center">
                            ...
                            @else
                            <div class="col-4">
                                <a href="{{ route('test_detail.index') }}" class="link">
                                    <i class="fa fa-paper-plane-o"></i>
                                    <font class="font-medium">{{ $user->test_details->count() }}</font>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="{{ route('tugas.index') }}" class="link">
                                    <i class="fa fa-paper-plane"></i>
                                    <font class="font-medium">{{ $user->tugas_details->count() }}</font>
                                </a>
                            </div>
                            @endif
                        </div>
