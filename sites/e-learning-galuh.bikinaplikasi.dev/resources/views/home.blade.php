        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="text-right">
                        <h2 class="font-light m-b-0"><i class="fa fa-book text-success"></i> {{ $latihans->count() }}
                        </h2>
                        <span class="text-muted">Total</span>
                    </div>
        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="text-right">
                        <h2 class="font-light m-b-0"><i class="fa fa-book text-success"></i> {{ $ujians->count() }}</h2>
                        <span class="text-muted">Total</span>
                    </div>
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item @if($index ==0 ) active @endif">
                                            <a href="{{ route('informasi.show', $informasi->id) }}" class="w-100">
