            ...
            <div class="card">
                <div class="card-block">
                    <form class="form-horizontal form-material"
                        action="{{ url(route('informasi.update', ['informasi' => $informasi->id])) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Informasi 1"
                                    ...
                                    value='{{ old('judul') == "" ? $informasi->judul : old('judul') }}' name='judul'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea id='editor-1' style="height: 130px !important;" class="form-control form-control-line @error('deskripsi') is-invalid @enderror" name='deskripsi'>{{ old('deskripsi') == "" ? $informasi->deskripsi : old('deskripsi') }}</textarea>
