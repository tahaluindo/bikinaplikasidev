...
[forum](//groups.google.com/group/flot-graphs) first, and confirm that
...
Flot follows the [jQuery Core Style Guidelines](//docs.jquery.com/JQuery_Core_Style_Guidelines),
...
Use [jsDoc](//usejsdoc.org) comments for all file and function headers.
