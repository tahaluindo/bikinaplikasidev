...
if ($_GET['module'] == 'home') {
    ...
    echo "<span class='judulhead'><b>Manajeman Tugas</b></span>";
 ...
 elseif ($_GET['module'] == 'buattugas') {
    echo "<span class='judulhead'><b>Manajeman tugas &#187; Buat tugas</b></span>";
} elseif ($_GET['module'] == 'buattugasesay') {
    echo "<span class='judulhead'><b>Manajeman tugas &#187; Buat tugas &#187; Buat tugas Esay</b></span>";
} elseif ($_GET['module'] == 'buattugaspilganda') {
    echo "<span class='judulhead'><b>Manajeman tugas &#187; Buat tugas &#187; Buat tugas Pilihan Ganda</b></span>";
} elseif ($_GET['module'] == 'daftartugas') {
    echo "<span class='judulhead'><b>Manajeman tugas &#187; Daftar tugas</b></span>";
} elseif ($_GET['module'] == 'daftartugasesay') {
    echo "<span class='judulhead'><b>Manajeman tugas &#187; Daftar tugas &#187; Daftar tugas Esay</b></span>";
} elseif ($_GET['module'] == 'daftartugaspilganda') {
    echo "<span class='judulhead'><b>Manajeman tugas &#187; Daftar tugas &#187; Daftar tugas Pilihan Ganda</b></span>";
}
?>
