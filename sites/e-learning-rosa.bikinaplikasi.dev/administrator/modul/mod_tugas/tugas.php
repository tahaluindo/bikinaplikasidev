...
switch($_GET[act]){
  ...
  default:
      ...
      if ($_SESSION[leveluser]=='admin'){    
        echo "<h2>Manajemen Tugas/Tugas</h2><hr>
          <input type=button class='button blue' value='Tambah Topik' onclick=\"window.location.href='?module=tugas&act=tambahtopiktugas';\">";
        ...
        $tampil_topik = mysql_query("SELECT * FROM topik_tugas ORDER BY id_kelas");
    ...
    while ($r=mysql_fetch_array($tampil_topik)){
      ...
      $tgl_buat   = tgl_indo($r[tgl_buat]);
       echo "<tr><td>$no</td>
             ...
             <td><ul><li><a href='?module=tugas&act=edittopiktugas&id=$r[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /></a> | 
                 <a href=javascript:confirmdelete('$aksi?module=tugas&act=hapustopiktugas&id=$r[id_tq]') title='Hapus'><img src='images/icons/cross.png' alt='Delete' /></a></li>
                 <li><a href=?module=buattugas&act=buattugas&id=$r[id_tq]>Buat Tugas</a></li>
                 <li><a href=?module=daftartugas&act=daftartugas&id=$r[id_tq]>Daftar Tugas</a></li>
                 <li><a href=?module=tugas&act=daftarsiswayangtelahmengerjakan&id=$r[id_tq]>Daftar Peserta & Koreksi</a></li></ul></td></tr>";
      $no++;
    }
    echo "</table>";
    ...
    $tampil_topik = mysql_query("SELECT * FROM topik_tugas WHERE pembuat = '$_SESSION[idpengajar]'");
        echo "<h2>Daftar Topik Tugas</h2><hr>
          <input class='button blue' type=button value='Tambah Topik' onclick=\"window.location.href='?module=tugas&act=tambahtopiktugas';\">";
        echo "<br><br><table id='table1' class='gtable sortable'><thead>
        ...
        echo "<tr><td>$no</td>
             ...
             <td>$r[info]</td>
             <td><p align='center'>$r[terbit]</p></td>
             <td><a href='?module=tugas&act=edittopiktugas&id=$r[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /> | 
                         <a href=javascript:confirmdelete('$aksi?module=tugas&act=hapustopiktugas&id=$r[id_tq]') title='Hapus'><img src='images/icons/cross.png' alt='Delete' /></a><br><br>
                 <input type=button class='button small white' value='Buat Tugas' onclick=\"window.location.href='?module=buattugas&act=buattugas&id=$r[id_tq]';\"></input><br>
                <input type=button class='button small white' value='Daftar Tugas' onclick=\"window.location.href='?module=daftartugas&act=daftartugas&id=$r[id_tq]';\"></input><br>
                <input type=button class='button small white' value='Peserta & koreksi' onclick=\"window.location.href='?module=tugas&act=daftarsiswayangtelahmengerjakan&id=$r[id_tq]';\"></input></td></tr>";
      $no++;
    }
    echo "</table>";      
    }
    elseif ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_mapel)){
            echo"<br><b class='judul'>tugas</b><br><p class='garisbawah'></p>
            <table>
            ...
            while ($t=mysql_fetch_array($mapel)){                
                echo "<tr><td>$no</td>
                        ...
                        echo"<td><input type=button class='tombol' value='Lihat tugas'
                       onclick=\"window.location.href='?module=tugas&act=daftartopik&id=$t[id_matapelajaran]&id_kelas=$data_siswa[id_kelas]';\"></td></tr>";
            $no++;
            }
            echo"</table>";
        }else{
...
case "daftarsiswayangtelahmengerjakan":
    if ($_SESSION[leveluser]=='admin'){
        $siswa_yangmengerjakan = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_tugas WHERE id_tq = '$_GET[id]'");
        ...
        $siswa_yangmengerjakan2 = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_tugas WHERE id_tq = '$_GET[id]'");
        ...
        while ($t=mysql_fetch_array($siswa_yangmengerjakan2)){
            ...
            $nilai = mysql_query("SELECT * FROM nilai_soal_esay_tugas WHERE id_tq='$_GET[id]' AND id_siswa ='$t[id_siswa]'");
            $n = mysql_fetch_array($nilai);
            $nilai2 = mysql_query("SELECT * FROM nilai_tugas WHERE id_tq='$_GET[id]' AND id_siswa = '$t[id_siswa]'");
            ...
            echo "<tr><td>$no</td>                      
                      ...
                      if ($t[dikoreksi]=='B'){
                          echo "<td>Jawaban soal essay <b>belum di koreksi</b>
                                    <br>Nilai Tugas/Tugas Pilihan Ganda : $n2[persentase]</td>";
                          echo "
                          <td><a href=$aksi?module=tugas&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a> |
                          <a href=?module=tugas&act=koreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Koreksi Jawaban Esay</a></td></tr>";
                      }else{
                          echo "<td>Jawaban soal essay <b>sudah di koreksi</b><br>Nilai Tugas/Tugas Pilihan Ganda : $n2[persentase]<br>
                                                         Nilai Tugas/Tugas Essay: $n[nilai]</td>";
                          echo "
                          <td><a href=$aksi?module=tugas&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a> |
                          <a href=?module=tugas&act=editkoreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Edit Koreksi</a></td></tr>";
                      }
                      
            $no++;
        }
        echo "</table>";
        echo "<br><input class='button blue' type=button value=Kembali onclick=\"window.location.href='?module=tugas';\">";
        
        }else{
            echo "<script>window.alert('Belum ada siswa yang mengikuti ujian.');
                    window.location=(href='media_admin.php?module=tugas')</script>";
        }
    }
    elseif ($_SESSION[leveluser]=='pengajar'){
        $siswa_yangmengerjakan = mysql_query("SELECT id_siswa FROM siswa_sudah_mengerjakan_tugas WHERE id_tq = '$_GET[id]'");
        $cek_siswa = mysql_num_rows($siswa_yangmengerjakan);

        if (!empty($cek_siswa)){

        $soal_pilganda = mysql_query("SELECT * FROM tugas_pilganda WHERE id_tq='$_GET[id]'");
        $pilganda = mysql_num_rows($soal_pilganda);
        $soal_esay = mysql_query("SELECT * FROM tugas_esay WHERE id_tq='$_GET[id]'");
            ...
            echo "<tr><td>$no</td>
                      ...
                      if ($t[dikoreksi]=='B'){
                          ...
                          echo "<td>Jawaban soal essay <b>sudah di koreksi</b><br>Nilai Tugas/Tugas Pilihan Ganda : $n2[persentase]<br>
                                                         Nilai Tugas/Tugas Essay: $n[nilai]</td>";
                          echo "
                          <td><a href=javascript:confirmdelete('$aksi?module=tugas&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]')>Hapus Siswa</a> |
                          <a href=?module=tugas&act=editkoreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Edit Koreksi</a></td></tr>";
                      }
            $no++;
        }
        ...
        while ($t=mysql_fetch_array($siswa_yangmengerjakan2)){
            ...
            echo "<tr><td>$no</td>
                      ...
                      if ($t[dikoreksi]=='B'){
                          ...
                          echo "<td>Jawaban soal essay <b>sudah di koreksi</b><br>Nilai Tugas/Tugas Essay: $n[nilai]</td>";
                          echo "
                          <td><a href=$aksi?module=tugas&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a> |
                          <a href=?module=tugas&act=editkoreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Edit Koreksi</a></td></tr>";
                      }
        ...
        while ($t=mysql_fetch_array($siswa_yangmengerjakan2)){
            ...
            echo "<tr><td>$no</td>
                      ...
                      <td>$k[nama]</td>";
                      if ($t[dikoreksi]=='B'){
                          echo "<td>Nilai Tugas/Tugas Pilihan Ganda : $n2[persentase]</td>";
                          echo "
                          <td><a href=$aksi?module=tugas&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a>
                          </td></tr>";
                      }else{
...
case "koreksi":
    if ($_SESSION[leveluser]=='admin'){
        $cek = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_tugas WHERE id_siswa='$_GET[id_siswa]'");
        ...
        if (!empty($pilganda) AND !empty($esay)){
            ...
            $s = mysql_fetch_array($siswa);
            $jawaban = mysql_query("SELECT * FROM jawaban_tugas WHERE id_tq='$_GET[id]' AND id_siswa='$_GET[id_siswa]'");
            $cek=mysql_num_rows($jawaban);
            if (!empty($cek)){
                echo "<h2>Jawaban Soal Essay Siswa <b>$s[nama_lengkap]</b></h2><hr>";
                $no=1;
                while ($j=mysql_fetch_array($jawaban)){
                    $soal_esay2 = mysql_query("SELECT * FROM tugas_esay WHERE id_tq='$j[id_tq]' AND id_tugas='$j[id_tugas]'");
                    $tugas = mysql_fetch_array($soal_esay2);
                    echo "<table id='table1' class='gtable sortable'>
                          <form method=POST action='?module=tugas&act=hasilkoreksi'>";
                            if (!empty($tugas[gambar])){
                            echo "<tr><td rowspan=7><b>$no.</b></td><td><b>Pertanyaan :</b></td></tr>
                                  <tr><td>$tugas[pertanyaan]</td></tr>
                                  <tr><td><img src='../foto_soal/medium_$tugas[gambar]'></td></tr>
                ...
                echo "<br>
                 ...
                 echo "<script>window.alert('Jawaban siswa kosong.');
                       window.location=(href='?module=tugas')</script>";
            }
        ...
        if (!empty($pilganda) AND !empty($esay)){
            ...
            if (!empty($cek)){
                ...
                while ($j=mysql_fetch_array($jawaban)){
                    ...
                    $tugas = mysql_fetch_array($soal_esay2);
                    echo "<table id='table1' class='gtable sortable'>
                          <form method=POST action='?module=tugas&act=hasileditkoreksi'>";
                            if (!empty($tugas[gambar])){
                            echo "<tr><td rowspan=7><b>$no.</b></td><td><b>Pertanyaan :</b></td></tr>
                                  <tr><td>$tugas[pertanyaan]</td></tr>
                                  <tr><td><img src='../foto_soal/medium_$tugas[gambar]'></td></tr>
...
case "hasilkoreksi":
    if ($_SESSION[leveluser]=='admin'){
        echo "<form method=POST action='$aksi?module=tugas&act=inputnilai'><fieldset>
...
case "hasileditkoreksi":
    if ($_SESSION[leveluser]=='admin'){
        echo "<form method=POST action='$aksi?module=tugas&act=inputeditnilai'><fieldset>
              <legend>Koreksi Nilai</legend>
              <dl class='inline'>";
        $jum_soal = $_POST['jumlah_soal'];
...
case "tambahtopiktugas":
    if ($_SESSION[leveluser]=='admin'){
    echo "
    <form name='form_topik' method=POST action='$aksi?module=tugas&act=input_topiktugas'>
    <fieldset>
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
    echo "<form name='form_topik' method=POST action='$aksi?module=tugas&act=input_topiktugas'>
    <fieldset>
    <legend>Tambah Topik</legend>
    <dl class='inline'>
    <dt><label>Judul</label></dt>               <dd> <input type=text name='judul' size='50'></dd>
...
case "edittopiktugas":
    ...
    $edit=mysql_query("SELECT * FROM topik_tugas WHERE id_tq = '$_GET[id]'");
    ...
    echo "<form name='form_topik' method=POST action='$aksi?module=tugas&act=edit_topiktugas'>
...
case "daftartopik":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        $topik = mysql_query("SELECT * FROM topik_tugas WHERE id_kelas = '$_GET[id_kelas]' AND id_matapelajaran = '$_GET[id]' AND terbit='Y'");
        $cek_topik = mysql_num_rows($topik);

        if (!empty($cek_topik)){
            echo"<br><b class='judul'>Daftar tugas Mata Pelajaran $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table>
              <tr><th>No</th><th>Deskripsi Tugas/Tugas </th><th></th></tr>";
              $no=1;
              while($t=mysql_fetch_array($topik)){
                  ...
                  echo"<tr><td rowspan=6>$no</td><td><b>Judul</b></td><td><b>: $t[judul]</b></td></tr>
                       ...
                       echo"<tr><td><b>Waktu Pengerjaan</b></td><td><b>: $waktu menit</b></td></tr>
                            <tr><td><b>Info Soal/Tugas</b></td><td><b>: $t[info]</b></td></tr>
                            <tr><td></td><td><input type=button class='tombol' value='Kerjakan Tugas/Tugas'
                       onclick=\"window.location.href='?module=tugas&act=infokerjakan&id=$t[id_tq]';\"></td></tr>";
              $no++;
              }
              echo"</table>
                    <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
        }else{
            echo "<script>window.alert('Belum ada Tugas atau Tugas di mata pelajaran ini.');
                    window.location=(href='media.php?module=tugas')</script>";
        }
    }
    break;
...
case "daftarnilai":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_topik)){
            echo"<br><b class='judul'>Daftar Nilai tugas Mata Pelajaran $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table>
              <tr><th>No</th><th>Deskripsi Tugas/Tugas </th><th></th></tr>";
              $no=1;
               while($t=mysql_fetch_array($topik)){
                  ...
                  echo"<tr><td rowspan=6>$no</td><td><b>Judul</b></td><td><b>: $t[judul]</b></td></tr>
                       ...
                       onclick=\"window.location.href='?module=tugas&act=nilaisiswa&id_topik=$t[id_tq]';\"></td></tr>";
            ...
            echo "<script>window.alert('Belum ada Tugas atau Tugas di mata pelajaran ini, jadi tidak ada nilai.');
                    window.location=(href='media.php?module=nilai_tugas')</script>";
        }
    }
    break;
...
case "nilaisiswa":
    if ($_SESSION[leveluser]=='siswa'){
        $tugas_pilganda = mysql_query("SELECT * FROM tugas_pilganda WHERE id_tq = '$_GET[id_topik]'");
        $tugas_esay = mysql_query("SELECT * FROM tugas_esay WHERE id_tq = '$_GET[id_topik]'");
        $c_pilganda = mysql_num_rows($tugas_pilganda);
        $c_esay = mysql_num_rows($tugas_esay);

        if (!empty($c_pilganda) AND !empty($c_esay)){
        $pilganda = mysql_query("SELECT * FROM nilai_tugas WHERE id_tq = '$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
        $cek_pilganda = mysql_num_rows($pilganda);
        $esay = mysql_query("SELECT * FROM nilai_soal_esay_tugas WHERE id_tq = '$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
        $cek_esay = mysql_num_rows($esay);
                ...
                if (!empty($cek_pilganda) AND !empty($cek_esay)){
                    echo"<br><b class='judul'>Nilai Anda</b><br><p class='garisbawah'></p>
                      <table>
                      <tr><th>Deskripsi Tugas/Tugas </th><th>Nilai</th></tr>";
        ...
        $cek_esay = mysql_num_rows($esay);
                ...
                elseif (empty($cek_esay)) {
                    $kerjakan = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_tugas WHERE id_tq='$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
        ...
        elseif (!empty($c_pilganda) AND !empty($c_esay)){
            echo "<script>window.alert('Belum ada Nilai di tugas/tugas ini.');
            window.location=(href='?module=nilai_tugas')</script>";
        }
    }
    break;
...
case "infokerjakan":
    if ($_SESSION[leveluser]=='siswa'){
        $cek = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_tugas WHERE id_tq='$_GET[id]' AND id_siswa = '$_SESSION[idsiswa]'");
        $data = mysql_fetch_array($cek);
        
        if ($data[hits]<=0){
        $topik = mysql_query("SELECT * FROM topik_tugas WHERE id_tq = '$_GET[id]'");
        $t = mysql_fetch_array($topik);

        echo"<br><b class='judul'>Informasi</b><br><p class='garisbawah'></p>
            <form method=POST action='soal_tugas.php?' target='_blank'>
            <input type=hidden name='waktu' value='$t[waktu_pengerjaan]'>
            <input type=hidden name='id' value='$_GET[id]'>
            <h3>Baca dengan seksama dan teliti sebelum mengerjakan tugas<p class='garisbawah'></p><b>
        ...
        echo"<p class='garisbawah'></p>
            <input type=submit class='tombol' value='Mulai Mengerjakan' onclick='aksi_tugas.php'>
            <input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
        }
        elseif ($data[hits] >= 1){
            echo"<br><b class='judul'>Informasi</b><br><p class='garisbawah'></p>";
            echo "<h3>Anda Sudah mengerjakan tugas ini</h3>";
            echo "<p class='garisbawah'></p>
...
case "buattugas":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<form><fieldset>
          ...
          <p align=center'>
          <input class='button white' type=button value='Buat Tugas Esay' onclick=\"window.location.href='?module=buattugasesay&act=buattugasesay&id=$t[id_tq]';\">
          <input class='button white' type=button value='Buat Tugas Pilihan Ganda' onclick=\"window.location.href='?module=buattugaspilganda&act=buattugaspilganda&id=$t[id_tq]';\">
          </p>
          <br><input class='button blue' type=button value=Kembali onclick=self.history.back()>
          </fieldset></form>";
    }
...
case "buattugasesay":
    if ($_SESSION[leveluser]=='admin'){
        $jum = mysql_query("SELECT COUNT(tugas_esay.id_tugas) as jml FROM tugas_esay WHERE id_tq = '$_GET[id]'");
        $j = mysql_fetch_array($jum);
        $jumlah = $j[jml] + 1;
        
        echo "<form method=POST action='$aksi?module=tugas&act=input_tugasesay' enctype='multipart/form-data'>        
        <input type=hidden name=id value='$_GET[id]'>
        <fieldset>
        <legend>Buat Tugas/Tugas Essay</legend>
        <dl class='inline'>
        ...
        <small>Jumlah soal esay di database :";
                    if ($j[jml] == 0){
                        echo "<a href='?module=tugas&act=daftartugasesay&id=$_GET[id]' target='_blank' title='Lihat Daftar Soal'><blink> 0</blink></a></small>";
                    }else{
                        echo "<a href='?module=tugas&act=daftartugasesay&id=$_GET[id]' target='_blank' title='Lihat Daftar Soal'><blink> $j[jml]</blink></a></small>";
                    }
        echo"</dd>
        </dl>
          <div class='buttons'>
...
case "buattugaspilganda":
    if ($_SESSION[leveluser]=='admin'){
        $jum = mysql_query("SELECT COUNT(tugas_pilganda.id_tugas) as jml FROM tugas_pilganda WHERE id_tq = '$_GET[id]'");
        $j = mysql_fetch_array($jum);
        $jumlah = $j[jml] + 1;
        echo"<form method=POST action='$aksi?module=tugas&act=input_tugaspilganda' enctype='multipart/form-data'>";
        echo"<fieldset>
             <legend>Buat Tugas/Tugas Pilihan Ganda</legend>
             <dl class='inline'>
             <dt><label>Pertanyaan ".$jumlah." </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'></textarea></dd>
             ...
             <small>Jumlah soal pilihan ganda di database :";
                    if ($j[jml] == 0){
                        echo "<a href='?module=tugas&act=daftartugaspilganda&id=$_GET[id]' target='_blank' title='Lihat Daftar Soal'><blink> 0</blink></a></small>";
                    }else{
                        echo "<a href='?module=tugas&act=daftartugaspilganda&id=$_GET[id]' target='_blank' title='Lihat Daftar Soal'><blink> $j[jml]</blink></a></small>";
                    }
...
case "daftartugas":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<form><fieldset>
          ...
          <p align=center'>
          <input type=button class='button white' value='Daftar Tugas Esay' onclick=\"window.location.href='?module=daftartugasesay&act=daftartugasesay&id=$t[id_tq]';\"> 
          <input type=button class='button white' value='Daftar Tugas Pilihan Ganda' onclick=\"window.location.href='?module=daftartugaspilganda&act=daftartugaspilganda&id=$t[id_tq]';\">
          </p>
        ...
        echo "<form><fieldset>
          ...
          <p align=center'>
          <input class='button white' type=button value='Daftar Tugas Esay' onclick=\"window.location.href='?module=daftartugasesay&act=daftartugasesay&id=$t[id_tq]';\">
          <input class='button white' type=button value='Daftar Tugas Pilihan Ganda' onclick=\"window.location.href='?module=daftartugaspilganda&act=daftartugaspilganda&id=$t[id_tq]';\">
          </p>
          <br><input type=button class='button blue' value=Kembali onclick=self.history.back()>
          </fieldset></form>";
    }
...
case "daftartugasesay":
    if ($_SESSION[leveluser]=='admin'){
        $cek = mysql_query("SELECT COUNT(tugas_esay.id_tugas) as jml FROM tugas_esay WHERE id_tq = '$_GET[id]'");
        $c = mysql_fetch_array($cek);
        if ($c[jml] != 0){
        $tugas=mysql_query("SELECT * FROM tugas_esay WHERE id_tq = '$_GET[id]'");
        $jtugas = mysql_query("SELECT * FROM tugas_esay WHERE id_tq = '$_GET[id]'");
        $jq = mysql_fetch_array($jtugas);
        $topik = mysql_query("SELECT * FROM topik_tugas WHERE id_tq = '$jq[id_tq]'");
        $t=mysql_fetch_array($topik);
        ...
        echo "<div class='information msg'><b>Daftar Soal Tugas Esay</b></div>
              <form><fieldset>
              <legend>Info Tugas/Tugas</legend>
              <dl class='inline'>
              <dt><label>Judul</label></dt>           <dd>: $t[judul]</dd>
              <dt><label>Kelas</label></dt>           <dd>: $k[nama]</dd>
              <dt><label>Mata Pelajaran</label></dt>  <dd>: $p[nama]</dd>
              </dl></fieldset></form>";
        echo "<input class='button blue' type=button value='Tambah Tugas Esay' onclick=\"window.location.href='?module=tugas&act=buattugasesay&id=$jq[id_tq]';\">
              <input class='button blue' type=button value=Kembali onclick=\"window.location.href='?module=tugas';\">";

        echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>Pertanyaan</th><th>Gambar</th><th>Tgl Buat</th><th>Aksi</th></tr></thead>";
    $no=1;
    while ($q=mysql_fetch_array($tugas)){
       $tgl_buat   = tgl_indo($q[tgl_buat]);
       echo "<tr><td>$no</td>
             <td>$q[pertanyaan]</td>
             <td>$q[gambar]</td>
             <td>$tgl_buat</td>
             <td><a href='?module=tugas&act=edittugasesay&id=$q[id_tugas]&id_topik=$q[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=tugas&act=hapustugasesay&id=$q[id_tugas]&id_topik=$q[id_tq]') title='Hapus' ><img src='images/icons/cross.png' alt='Delete' /></a>
                 </td></tr>";
      $no++;
    }
    echo "</table>";
        }else{
            echo "<script>window.alert('Tugas esay masih kosong');
            window.location=(href='?module=tugas')</script>";
        }
    }
    elseif ($_SESSION[leveluser]=='pengajar'){
        ...
        echo "<input class='button blue' type=button value='Tambah Tugas Esay' onclick=\"window.location.href='?module=buattugasesay&act=buattugasesay&id=$jq[id_tq]';\">
              <input class='button blue' type=button value=Kembali onclick=\"window.location.href='?module=tugas';\">";
...
case "daftartugaspilganda":
    if ($_SESSION[leveluser]=='admin'){
        $cek = mysql_query("SELECT COUNT(tugas_pilganda.id_tugas) as jml FROM tugas_pilganda WHERE id_tq = '$_GET[id]'");
        $c = mysql_fetch_array($cek);
        if ($c[jml] != 0){
        $tugas=mysql_query("SELECT * FROM tugas_pilganda WHERE id_tq = '$_GET[id]'");
        $jtugas = mysql_query("SELECT * FROM tugas_pilganda WHERE id_tq = '$_GET[id]'");
        $jq = mysql_fetch_array($jtugas);
        $topik = mysql_query("SELECT * FROM topik_tugas WHERE id_tq = '$jq[id_tq]'");
        $t=mysql_fetch_array($topik);
        $kelas = mysql_query("SELECT * FROM kelas WHERE id_kelas = '$t[id_kelas]'");
        ...
        echo "<div class='information msg'><b>Daftar Soal Tugas/Tugas Pilihan Ganda</b></div>
              <form><fieldset>
              <legend>Info Tugas/Tugas</legend>
              <dl class='inline'>
              <dt><label>Judul</label></dt>          <dd>: $t[judul]</dd>
        ...
        echo "<input type=button class='button blue' value='Tambah Tugas Pilihan ganda' onclick=\"window.location.href='?module=tugas&act=buattugaspilganda&id=$jq[id_tq]';\">
              <input type=button class='button blue' value=Kembali onclick=\"window.location.href='?module=tugas';\">";
    ...
    while ($q=mysql_fetch_array($tugas)){
       echo "<tr><td rowspan=8><b>$no.</b></td>
		    ...
		    <div>
             ...
             <tr><td>Aksi</td><td>: <a href='?module=tugas&act=edittugaspilganda&id=$q[id_tugas]&id_topik=$q[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=tugas&act=hapustugaspilganda&id=$q[id_tugas]&id_topik=$q[id_tq]') title='Hapus'><img src='images/icons/cross.png' alt='Delete' /></a></td></tr>
             ";
      $no++;
    }
    echo "</table>";
    echo "<br><input type=button class='button blue' value='Tambah Tugas Pilihan ganda' onclick=\"window.location.href='?module=tugas&act=buattugaspilganda&id=$jq[id_tq]';\">
              <input type=button class='button blue' value=Kembali onclick=\"window.location.href='?module=tugas';\">";
    }else{
            echo "<script>window.alert('Tugas pilihan ganda masih kosong');
            window.location=(href='?module=tugas')</script>";
        }
    }
    else{
...
case "edittugasesay":
    if ($_SESSION[leveluser]=='admin'){
        $tugas=mysql_query("SELECT * FROM tugas_esay WHERE id_tugas = '$_GET[id]'");
        $q = mysql_fetch_array($tugas);

        echo "<form method=POST action='$aksi?module=tugas&act=edit_tugasesay' enctype='multipart/form-data'>
        <input type=hidden name=id value='$q[id_tugas]'>
        <input type=hidden name=topik value='$_GET[id_topik]'>
        <fieldset>
         <legend>Edit Tugas/Tugas</legend>
         <dl class='inline'>
...
case "edittugaspilganda":
    if ($_SESSION[leveluser]=='admin'){
        $tugas=mysql_query("SELECT * FROM tugas_pilganda WHERE id_tugas = '$_GET[id]'");
        $q = mysql_fetch_array($tugas);
        echo "<form method=POST action='$aksi?module=tugas&act=edit_tugaspilganda' enctype='multipart/form-data'>
        <input type=hidden name=id value='$q[id_tugas]'>
        <input type=hidden name=topik value='$_GET[id_topik]'>
        <fieldset>
        <legend>Edit Tugas/Tugas Pilihan Ganda</legend>
        <dl class='inline'>
          <dt><label>Pertanyaan </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'>$q[pertanyaan]</textarea></dd>
             <dt><label>Gambar</label></dt>  <dd>";
                    if ($q[gambar]!=''){
