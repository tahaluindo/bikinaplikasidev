...
elseif($module=='quiz' AND $act=='inputnilai'){
    mysql_query("UPDATE siswa_sudah_mengerjakan_quiz SET dikoreksi = 'S'
                                                WHERE id_tq ='$_POST[id_tq]' AND id_siswa = '$_POST[id_siswa]'");
    mysql_query("INSERT INTO nilai_soal_esay_quiz (id_tq,id_siswa,nilai)
...
elseif($module=='quiz' AND $act=='inputeditnilai'){
    mysql_query("UPDATE nilai_soal_esay_quiz SET nilai = '$_POST[nilai]' WHERE id_tq ='$_POST[id_tq]' AND id_siswa = '$_POST[id_siswa]' ");
    header('location:../../media_admin.php?module=quiz&act=daftarsiswayangtelahmengerjakan&id='.$_POST[id_tq]);
}
...
elseif($module=='quiz' AND $act=='editsiswayangtelahmengerjakan'){
    mysql_query("DELETE FROM siswa_sudah_mengerjakan_quiz WHERE id_siswa='$_GET[id_siswa]' AND id = '$_GET[id]'");
    mysql_query("DELETE FROM nilai_soal_esay_quiz WHERE id_tq='$_GET[id_tq]' AND id_siswa='$_GET[id_siswa]'");
    mysql_query("DELETE FROM nilai_quiz WHERE id_tq='$_GET[id_tq]' AND id_siswa='$_GET[id_siswa]'");
    mysql_query("DELETE FROM jawaban_quiz WHERE id_tq='$_GET[id_tq]' AND id_siswa ='$_GET[id_siswa]'");
    header('location:../../media_admin.php?module='.$module);
