    ...
    switch ($_GET[act]) {
        ...
        default:
            ...
            if ($_SESSION[leveluser] == 'admin') {
                echo "<h2>Manajemen Quiz/Quiz</h2><hr>
          ...
          <tr><th>No</th><th>Judul</th><th>Kelas</th><th>Pelajaran</th><th>Tgl Buat</th><th>Lama Pengerjaan</th><th>Info</th><th>Terbit</th><th>Aksi</th></tr></thead>";
             ...
             <td><a href='?module=quiz&act=edittopikquiz&id=$r[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /> | 
                ...
                if (!empty($cek_mapel)) {
                    echo "<br><b class='judul'>quiz</b><br><p class='garisbawah'></p>
            <table>
            <tr><th>No</th><th>Mata Pelajaran</th><th>Aksi</th></tr>";
                    ...
                    while ($t = mysql_fetch_array($mapel)) {
                        ...
                        echo "<td><input type=button class='tombol' value='Lihat quiz'
        ...
        case "daftarsiswayangtelahmengerjakan":
            if ($_SESSION[leveluser] == 'admin') {
                $siswa_yangmengerjakan = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_quiz WHERE id_tq = '$_GET[id]'");
        ...
        Penilaian Soal Pilihan Ganda Sistem yang mengerjakan.</div>";
                    ...
                    $siswa_yangmengerjakan2 = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_quiz WHERE id_tq = '$_GET[id]'");
          ...
          <tr><th>No</th><th>Nama</th><th>Kelas</th><th>Status</th><th>aksi</th></tr></thead>";
                    ...
                    while ($t = mysql_fetch_array($siswa_yangmengerjakan2)) {
                        ...
                        $nilai = mysql_query("SELECT * FROM nilai_soal_esay_quiz WHERE id_tq='$_GET[id]' AND id_siswa ='$t[id_siswa]'");
                        $n = mysql_fetch_array($nilai);
                        $nilai2 = mysql_query("SELECT * FROM nilai_quiz WHERE id_tq='$_GET[id]' AND id_siswa = '$t[id_siswa]'");
                      ...
                      <td>$k[nama]</td>";
                        if ($t[dikoreksi] == 'B') {
                            echo "<td>Jawaban soal essay <b>belum di koreksi</b>
                                    <br>Nilai Quiz/Quiz Pilihan Ganda : $n2[persentase]</td>";
                            echo "
                          ...
                          <a href=?module=quiz&act=koreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Koreksi Jawaban Esay</a></td></tr>";
                            ...
                            echo "<td>Jawaban soal essay <b>sudah di koreksi</b><br>Nilai Quiz/Quiz Pilihan Ganda : $n2[persentase]<br>
                                                         Nilai Quiz/Quiz Essay: $n[nilai]</td>";
                            echo "
                          <td><a href=$aksi?module=quiz&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a> |
                ...
                $siswa_yangmengerjakan = mysql_query("SELECT id_siswa FROM siswa_sudah_mengerjakan_quiz WHERE id_tq = '$_GET[id]'");
                $cek_siswa = mysql_num_rows($siswa_yangmengerjakan);
          ...
          <tr><th>No</th><th>Nis</th><th>Nama</th><th>Kelas</th><th>Status</th><th>Aksi</th></tr></thead>";
                      ...
                      <td>$k[nama]</td>";
                          ...
                          <a href=?module=quiz&act=koreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Koreksi Jawaban Esay</a></td></tr>";
                                ...
                                echo "<td>Jawaban soal essay <b>sudah di koreksi</b><br>Nilai Quiz/Quiz Essay: $n[nilai]</td>";
                                echo "
                          <td><a href=$aksi?module=quiz&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a> |
                          <a href=?module=quiz&act=editkoreksi&id=$t[id_tq]&id_siswa=$s[id_siswa]>Edit Koreksi</a></td></tr>";
                            }
        ...
        Penilaian Soal Pilihan Ganda Sistem yang mengerjakan.</div>";
          ...
          <tr><th>No</th><th>Nis</th><th>Nama</th><th>Kelas</th><th>Status</th><th>Aksi</th></tr></thead>";
                      ...
                      <td>$k[nama]</td>";
                            if ($t[dikoreksi] == 'B') {
                                echo "<td>Nilai Quiz/Quiz Pilihan Ganda : $n2[persentase]</td>";
                                echo "
                          <td><a href=$aksi?module=quiz&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a>
                          </td></tr>";
                            } else {
        ...
        case "koreksi":
            if ($_SESSION[leveluser] == 'admin') {
                $cek = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_quiz WHERE id_siswa='$_GET[id_siswa]'");
                ...
                if ($c[dikoreksi] == 'B') {
                    ...
                    if (!empty($pilganda) and !empty($esay)) {
                        ...
                        $s = mysql_fetch_array($siswa);
                        $jawaban = mysql_query("SELECT * FROM _quiz WHERE id_tq='$_GET[id]' AND id_siswa='$_GET[id_siswa]'");
                       ...
                       window.location=(href='?module=quiz')</script>";
                        ...
                        $siswa = mysql_query("SELECT * FROM siswa WHERE id_siswa='$_GET[id_siswa]'");
                        $s = mysql_fetch_array($siswa);
                        $jawaban = mysql_query("SELECT * FROM jawaban_quiz WHERE id_tq='$_GET[id]' AND id_siswa='$_GET[id_siswa]'");
                        $cek = mysql_num_rows($jawaban);
                        if (!empty($cek)) {
    ...
    <dt><label>Info Quiz</label></dt>                <dd> <textarea name='info' id='wysiwyg' class='medium' rows='6'>$t[info]</textarea></dd>";
        ...
        case "daftartopik":
            if ($_SESSION[leveluser] == 'siswa') {
                ...
                if (!empty($cek_topik)) {
                    echo "<br><b class='judul'>Daftar quiz Mata Pelajaran $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table>
              <tr><th>No</th><th>Deskripsi Quiz/Quiz </th><th></th></tr>";
                    $no = 1;
                    while ($t = mysql_fetch_array($topik)) {
                       ...
                       <tr><td><b>Tanggal Posting</b></td><td><b>: $tgl_posting</b></td></tr>";
                        ...
                        echo "<tr><td><b>Waktu Pengerjaan</b></td><td><b>: $waktu menit</b></td></tr>
                            ...
                            <tr><td></td><td><input type=button class='tombol' value='Kerjakan Quiz/Quiz'
                    ...
                    echo "<script>window.alert('Belum ada Quiz atau Quiz di mata pelajaran ini.');
        ...
        case "daftarnilai":
            if ($_SESSION[leveluser] == 'siswa') {
                ...
                if (!empty($cek_topik)) {
                    echo "<br><b class='judul'>Daftar Nilai quiz Mata Pelajaran $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table>
              <tr><th>No</th><th>Deskripsi Quiz/Quiz </th><th></th></tr>";
                    $no = 1;
                    while ($t = mysql_fetch_array($topik)) {
                   ...
                   <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                    ...
                    echo "<script>window.alert('Belum ada Quiz atau Quiz di mata pelajaran ini, jadi tidak ada nilai.');
                    window.location=(href='media.php?module=nilai_quiz')</script>";
                }
            }
            break;
        ...
        case "nilaisiswa":
            if ($_SESSION[leveluser] == 'siswa') {
                ...
                if (!empty($c_pilganda) and !empty($c_esay)) {
                    $pilganda = mysql_query("SELECT * FROM nilai_quiz WHERE id_tq = '$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
                    $cek_pilganda = mysql_num_rows($pilganda);
                    $esay = mysql_query("SELECT * FROM nilai_soal_esay_quiz WHERE id_tq = '$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
                    ...
                    if (!empty($cek_pilganda) and !empty($cek_esay)) {
                      ...
                      <table>
                      <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                        $n_pilganda = mysql_fetch_array($pilganda);
                        $n_esay = mysql_fetch_array($esay);
                        echo "<tr><td>Quiz Pilihan Ganda</td><td>$n_pilganda[persentase]</td></tr>
                            <tr><td>Quiz Essay</td><td>$n_esay[nilai]</td></tr>
                            </table>
                            <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                      ...
                      <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                        $n_pilganda = mysql_fetch_array($pilganda);
                        $n_esay = mysql_fetch_array($esay);
                        echo "<tr><td>Quiz Pilihan Ganda</td><td>Anda belum mengerjakan</td></tr>
                            <tr><td>Quiz Essay</td><td>$n_esay[nilai]</td></tr>
                            </table>
                            <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                    } elseif (!empty($cek_pilganda) and empty($cek_esay)) {
                      ...
                      <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                        ...
                        $n_esay = mysql_fetch_array($esay);
                        echo "<tr><td>Quiz Pilihan Ganda</td><td>$n_pilganda[persentase]</td></tr>
                            <tr><td>Quiz Essay</td><td>Belum di koreksi</td></tr>
                            </table>
                            <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                    } elseif (empty($cek_pilganda) and empty($cek_esay)) {
                        echo "<br><b class='judul'>Nilai Anda</b><br><p class='garisbawah'></p>
                      ...
                      <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                        ...
                        $n_esay = mysql_fetch_array($esay);
                        echo "<tr><td>Quiz Pilihan Ganda</td><td>Anda Belum mengerjakan</td></tr>
                            <tr><td>Quiz Essay</td><td>Anda Belum mengerjakan</td></tr>
                            </table>
                            <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                    }
                    ...
                    if (!empty($cek_esay)) {
                        ...
                        echo "<br><b class='judul'>Nilai Anda</b><br><p class='garisbawah'></p>
                          ...
                          <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                        $n_esay = mysql_fetch_array($esay);
                        echo "<tr><td>Quiz Essay</td><td>$n_esay[nilai]</td></tr>
                          </table>
                                <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";

                    } elseif (empty($cek_esay)) {
                        $kerjakan = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_quiz WHERE id_tq='$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
                        ...
                        if (!empty($c_kerjakan)) {
                          ...
                          <table>
                          <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                                echo "<tr><td>Quiz Essay</td><td>Belum Dikoreksi</td></tr>
                          </table>
                                <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                              ...
                              <table>
                              <tr><th>Deskripsi Quiz/Quiz </th><th>Nilai</th></tr>";
                                echo "<tr><td>Quiz Essay</td><td>Anda belum mengerjakan</td></tr>
                              </table>
                                    <p class='garisbawah'></p><input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                    ...
                    echo "<script>window.alert('Belum ada Nilai di quiz/quiz ini.');
            window.location=(href='?module=nilai_quiz')</script>";
                }
            }
            break;
        ...
        case "infokerjakan":
            if ($_SESSION[leveluser] == 'siswa') {
                $cek = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_quiz WHERE id_tq='$_GET[id]' AND id_siswa = '$_SESSION[idsiswa]'");
            ...
            <form method=POST action='soal_quiz.php?' target='_blank'>
            <input type=hidden name='waktu' value='$t[waktu_pengerjaan]'>
            <input type=hidden name='id' value='$_GET[id]'>
            <h3>Baca dengan seksama dan teliti sebelum mengerjakan quiz<p class='garisbawah'></p><b>
            ...
            <input type=submit class='tombol' value='Mulai Mengerjakan' onclick='aksi_quiz.php'>
            <input type=button class='tombol' value='Kembali' onclick=self.history.back()>";
                } elseif ($data[hits] >= 1) {
                    echo "<br><b class='judul'>Informasi</b><br><p class='garisbawah'></p>";
                    echo "<h3>Anda Sudah mengerjakan quiz ini</h3>";
                    echo "<p class='garisbawah'></p>
        ...
        <input type=hidden name=id value='$_GET[id]'>
        <fieldset>
        <legend>Buat Quiz/Quiz Essay</legend>
        <dl class='inline'>
        ...
        case "buatquizpilganda":
            if ($_SESSION[leveluser] == 'admin') {
                ...
                echo "<fieldset>
             <legend>Buat Quiz/Quiz Pilihan Ganda</legend>
             <dl class='inline'>
             <dt><label>Pertanyaan " . $jumlah . " </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'></textarea></dd>
        ...
        case "daftarquizpilganda":
            if ($_SESSION[leveluser] == 'admin') {
                ...
                if ($c[jml] != 0) {
                    ...
                    echo "<div class='information msg'><b>Daftar Soal Quiz/Quiz Pilihan Ganda</b></div>
              <form><fieldset>
              <legend>Info Quiz/Quiz</legend>
              <dl class='inline'>
              <dt><label>Judul</label></dt>          <dd>: $t[judul]</dd>
        ...
        <input type=hidden name=topik value='$_GET[id_topik]'>
        <fieldset>
        <legend>Edit Quiz/Quiz Pilihan Ganda</legend>
        <dl class='inline'>
          <dt><label>Pertanyaan </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'>$q[pertanyaan]</textarea></dd>
             <dt><label>Gambar</label></dt>  <dd>";
                if ($q[gambar] != '') {
