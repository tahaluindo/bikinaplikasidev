    ...
    if (empty($_SESSION['username']) and empty($_SESSION['passuser']) and $_SESSION['login'] == 0) {
        ...
        if ($_SESSION['leveluser'] == 'siswa') {
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="css/skins/green.css" title="green">
                ...
                <link rel="shortcut icon" type="image/x-icon" href="images/tutwuri.png">
            </head>
            ...
            <header id="top">
                <div class="container_12 clearfix">
                    <div id="logo" class="grid_5">
                        ...
                        <a id="site-title" href="media_admin.php?module=home"><span>ADMINISTRATOR</span><br><span>E-Learning SMP N 5 KOTA JAMBI</span></a>
                    </div>
                        ...
                        <div class="box">
                            ...
                            <section>
                                ...
                                if ($_SESSION[leveluser] == 'admin') {
                                    ...
                                    echo "Anda masih dalam keadaan login sebagai : <b>Guru</b>. <br>";
                                    echo "Jangan lupa untuk <a href=logout.php><b>Logout</b></a> sebelum meninggalkan website ini.";
                                }
                                ?>
                            </section>
            ...
            <footer id="bottom">
                <section class="container_12 clearfix">
                    ...
                    <div class="grid_6 alignright">
                        Copyright &copy; 2022 <a href="#">SMP N 5 KOTA JAMBI</a>
                    </div>
                </section>
            </footer>
