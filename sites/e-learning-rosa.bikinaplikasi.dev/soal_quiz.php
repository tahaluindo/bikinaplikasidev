                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="95%">
                                ...
                                <form action=nilai_quiz.php method=post id=formulir>

                                    <?php

                                    include "configurasi/koneksi.php";
                                    $cek_siswa = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_quiz WHERE id_tq='$_POST[id]' AND id_siswa='$_SESSION[idsiswa]'");
                                    $info_siswa = mysql_fetch_array($cek_siswa);
                                    if ($info_siswa[hits] <= 0) {
                                        mysql_query("INSERT INTO siswa_sudah_mengerjakan_quiz (id_tq,id_siswa,hits)
