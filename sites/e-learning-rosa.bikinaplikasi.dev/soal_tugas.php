                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="95%">
                                ...
                                <form action=nilai_tugas.php method=post id=formulir>

                                    <?php
                                    include "configurasi/koneksi.php";
                                    $cek_siswa = mysql_query("SELECT * FROM siswa_sudah_mengerjakan_tugas WHERE id_tq='$_POST[id]' AND id_siswa='$_SESSION[idsiswa]'");
                                    $info_siswa = mysql_fetch_array($cek_siswa);
                                    if ($info_siswa[hits] <= 0) {
                                        mysql_query("INSERT INTO siswa_sudah_mengerjakan_tugas (id_tq,id_siswa,hits)
                                        VALUES ('$_POST[id]','$_SESSION[idsiswa]',hits+1)");
                                    } elseif ($info_siswa[hits] > 0) {
                                    }

                                    $soal = mysql_query("SELECT * FROM tugas_pilganda where id_tq='$_POST[id]' ORDER BY rand()");
                                    $pilganda = mysql_num_rows($soal);
                                    $soal_esay = mysql_query("SELECT * FROM tugas_esay WHERE id_tq='$_POST[id]'");
    ...
    <table><input type=hidden name=id_topik value='$_POST[id]'>";
                                        ...
                                        while ($s = mysql_fetch_array($soal)) {
                                            if ($s[gambar] != '') {
                                                ...
                                                echo "<tr><td><input type=radio name=soal_pilganda[" . $s['id_tugas'] . "] value='A'>A. " . $s['pil_a'] . "</td></tr>";
                                                echo "<tr><td><input type=radio name=soal_pilganda[" . $s['id_tugas'] . "] value='B'>B. " . $s['pil_b'] . "</td></tr>";
                                                echo "<tr><td><input type=radio name=soal_pilganda[" . $s['id_tugas'] . "] value='C'>C. " . $s['pil_c'] . "</td></tr>";
                                                echo "<tr><td><input type=radio name=soal_pilganda[" . $s['id_tugas'] . "] value='D'>D. " . $s['pil_d'] . "</td></tr>";
                                            } else {
    ...
    <table>";
                                        ...
                                        while ($e = mysql_fetch_array($soal_esay)) {
                                            if (!empty($e[gambar])) {
                                                ...
                                                echo "<tr><td><textarea name=soal_esay[" . $e['id_tugas'] . "] cols=95 rows=5></textarea></td></tr>";
                                            } else {
    ...
    <table><input type=hidden name=id_topik value='$_POST[id]'>";
                                        ...
                                        while ($e = mysql_fetch_array($soal_esay)) {
                                            if (!empty($e[gambar])) {
                                                ...
                                                echo "<tr><td><img src='foto_soal/medium_$e[gambar]'></td></tr>";
                                                echo "<tr><td>Jawaban : </td></tr>";
                                                echo "<tr><td><textarea name=soal_esay[" . $e['id_tugas'] . "] cols=95 rows=10></textarea></td></tr>";
                                            } else {
                                                echo "<tr><td rowspan=3><h3>$no2.</h3></td><td><h3>" . $e['pertanyaan'] . "</h3></td></tr>";
                                                echo "<tr><td>Jawaban : </td></tr>";
                                                echo "<tr><td><textarea name=soal_esay[" . $e['id_tugas'] . "] cols=95 rows=10></textarea></td></tr>";
            ...
            window.location=(href='media.php?module=home')</script>";
                                    ...
                                    <h3>Apakah anda sudah yakin dengan jawaban anda dan ingin menyimpannya?
                                        <button type=button onclick="tombol()">Ya</button>
                                    </h3>
                                    <h3 id="tombol"></h3>
                                </form>
                            </td>
