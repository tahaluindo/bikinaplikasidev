...
mysql_query("INSERT INTO nilai_quiz (id_tq, id_siswa, benar, salah, tidak_dikerjakan,persentase)
...
if(!empty($_POST['soal_esay'])){
    ...
    while($data = mysql_fetch_array($cek)){
        mysql_query("INSERT INTO jawaban_quiz(id_tq,id_quiz,id_siswa,jawaban)
