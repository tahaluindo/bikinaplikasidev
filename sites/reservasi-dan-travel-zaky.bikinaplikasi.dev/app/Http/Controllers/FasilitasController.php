...
class FasilitasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('fasilitas.index')->with('success', 'Berhasil menambah reservasi tiket');
    }
    ...
    public function update(Request $request, Fasilitas $fasilitas)
    {
        ...
        return redirect()->route('fasilitas.index')->with('success', 'Berhasil mengubah reservasi tiket');
    }
