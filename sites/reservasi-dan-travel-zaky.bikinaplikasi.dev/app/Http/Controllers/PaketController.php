...
class PaketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('paket.index')->with('success', 'Berhasil menambah reservasi tiket');
    }
    ...
    public function update(Request $request, Paket $paket)
    {
        ...
        return redirect()->route('paket.index')->with('success', 'Berhasil mengubah reservasi tiket');
    }
