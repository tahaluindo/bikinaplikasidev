        ...
        <div class="container-fluid plr_30 pb_30 pt_30 body_white_bg">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                            ...
                            <tr data-id='{{ $item->id }}'>
                                ...
                                <td class="text-center">
                                    <a class="badge badge-primary"
                                       href="{{ url('/lokasi/' . $item->id . '/edit') }}">Edit</a>
                                    <form action="{{ url('/lokasi' . '/' . $item->id) }}"
                    ...
                    <script>
                        const locationHrefHapusSemua = "{{ url('lokasi/hapus_semua') }}";
                        const locationHrefAktifkanSemua = "{{ url('lokasi/aktifkan_semua') }}";
                        const locationHrefCreate = "{{ url('lokasi/create') }}";

                        var columnOrders = [{{ $lokasi_count - 2 }}];
