        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('absensi.print')) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" 
                                    class="flatpickr form-control form-control-line" id="example-tanggal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='field'  required>
                                    @foreach(['id', 'tanggal', 'jam_masuk', 'jam_keluar'] as $field)
