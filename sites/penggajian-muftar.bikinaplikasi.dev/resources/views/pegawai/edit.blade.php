        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('pegawai.update', $pegawai->id)) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Nip"
                                    ...
                                    value='{{ old('nip') == "" ? $pegawai->nip : old('nip') }}' name='nip'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Nama"
                                    ...
                                    value='{{ old('nama') == "" ? $pegawai->nama : old('nama') }}' name='nama'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="25-02-1980"
                                    class="form-control form-control-line flatpickr" value='{{ old('tanggal_lahir') == "" ? $pegawai->tanggal_lahir : old('tanggal_lahir') }}'
                                    name='tanggal_lahir'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Tempat Lahir"
                                    ...
                                    value='{{ old('tempat_lahir') == "" ? $pegawai->tempat_lahir : old('tempat_lahir') }}' name='tempat_lahir'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='jenis_kelamin'>
                                    ...
                                    <option value="{{ $jenis_kelamin }}" @if(old('jenis_kelamin')==$jenis_kelamin || $pegawai->jenis_kelamin == $jenis_kelamin)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='agama'>
                                    ...
                                    <option value="{{ $agama }}" @if(old('agama')==$agama || $pegawai->agama == $agama)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Alamat"
                                    ...
                                    value='{{ old('alamat') == "" ? $pegawai->alamat : old('alamat') }}' name='alamat'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="25-Feb-2020"
                                    class="form-control form-control-line" id="example-no_telp"
                                    value='{{ old('no_telp') == "" ? $pegawai->no_telp : old('no_telp') }}' name='no_telp'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="25-02-1980"
                                    class="form-control form-control-line flatpickr" value='{{ old('tgl_mulai_kerja') == "" ? $pegawai->tgl_mulai_kerja : old('tgl_mulai_kerja') }}'
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='status'>
                                    ...
                                    <option value="{{ $status }}" @if(old('status')==$status || $pegawai->status == $status)
