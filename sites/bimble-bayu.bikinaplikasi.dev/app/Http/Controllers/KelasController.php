...
class KelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelas.index')->with('success', 'Berhasil menambah Kela');
    }
    ...
    public function update(Request $request, Kelas $kelas)
    {
        ...
        return redirect()->route('kelas.index')->with('success', 'Berhasil mengubah Kela');
    }
    ...
    public function destroy(Kelas $kelas)
    {
        ...
        return redirect()->route('kelas.index')->with('success', 'Kela berhasil dihapus!');
    }
    ...
    public function print(Request $request)
    {
        ...
        $data["kelass"] = $object->orderBy($request->field, $request->order)->limit($request->limit)->get();
