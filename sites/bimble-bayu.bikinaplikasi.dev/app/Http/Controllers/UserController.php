...
class UserController extends Controller
{
    ...
    public function profile(User $user)
    {
        ...
        if (auth()->user()->level == 'Siswa') {
            ...
            return view('user.profile_siswa', $data);
        }
    ...
    public function profileUpdate(Request $request, User $user)
    {
        ...
        if (auth()->user()->level == 'Siswa') {
            $this->validate($request, [
                ...
                // 'email' => "required|max:50|unique:user,email,{$user->email},email",
                'nama' => 'required|max:30',
                'tanggal_lahir' => 'required|max:30',
                'jenis_kelamin' => 'required|in:Laki - Laki,Perempuan',
                'agama' => 'required',
                'alamat' => 'required|max:255',
                'no_hp' => "required|max:15|unique:siswa,no_hp,{$user->siswa->no_hp},no_hp",
            ]);
            ...
            $requestData['user_id'] = User::findOrFail(auth()->id())->id;

            unset($requestData['email'], $requestData['password']);
            // dd($requestData);
            $user->siswa->update($requestData);
            ...
            return redirect('/pembayaran')->with('success', 'Berhasil mengupdate profile.');
