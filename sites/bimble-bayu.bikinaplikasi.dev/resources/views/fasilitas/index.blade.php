...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 breadcrumb-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">{{ ucwords("fasilitas") }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table" id='dataTable'>
                                    ...
                                    @foreach($fasilitas as $item)
                                        <tr data-id='{{ $item->id }}'>
                                            ...
                                            <td>
                                                @if($item->gambar)
                                                    <a class="btn btn-sm btn-primary-outline" href="{{ url($item->gambar) }}">
                                                        <img src="{{ url($item->gambar) }}" width="80" height="80" />
                                                    </a>
                                                @endif
                                            </td>
    ...
    <script>
        ...
        var columnOrders = [{{ $fasilitas_count }}];
