...
<body style="background-image: url('{{ url('image/background1.jpg') }}'); background-size: cover; background-repeat: no-repeat">
...
{{--                    <img src="{{ env('APP_OBJECT_LOGO') }}" alt="logo icon" style="width: 128px;">--}}
                ...
                <form method="POST" action="{{ route('login_manual') }}">
                    <div class="form-group">
                        <label for="exampleInputUsername" class="sr-only">Email / No Hp</label>
