                ...
                <div class="col-xl-6 xl-100 box-col-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form class="form-horizontal form-material" action="{{ url("/pengaturan/hero-section/{$hero_section->id}") }}"
                                ...
                                <div class="form-group {{ $errors->has('judul') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="judul"
                                               ...
                                               value="{{ isset($hero_section->judul) ? $hero_section->judul : old('judul') }}">
                                ...
                                <div class="form-group {{ $errors->has('gambar') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="gambar"
                                               ...
                                               value="{{ isset($hero_section->gambar) ? $hero_section->gambar : old('gambar') }}">
