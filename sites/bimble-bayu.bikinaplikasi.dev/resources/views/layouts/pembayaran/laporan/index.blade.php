            ...
            <div class="col-xl-6 xl-100 box-col-12">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <form class="form-horizontal form-material" action="{{ url(route('pembayaran.print')) }}"
                              method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label class="col-md-12">Tanggal Awal Pembayaran</label>
                                <div class="col-md-12">
                            ...
                            {{-- <div class="form-group">
                                <label class="col-md-12">Tanggal Akhir Pembayaran</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control form-control-line" name='field' required>
                                        @foreach(['id','jenjang_id','kelas_id','untuk_bulan','created_at','updated_at'] as $field)
...
<script>
    const locationHrefHapusSemua = "{{ url('mapel/hapus_semua') }}";
    const locationHrefAktifkanSemua = "{{ url('mapel/aktifkan_semua') }}";
    const locationHrefCreate = "{{ url('mapel/create') }}";
    var columnOrders = [0];
