...
<div class="container p-5">
    <form class="form-horizontal" role="form" method="POST" action="/admin/home/produk/ubah/{{$produk->id}}" enctype='multipart/form-data'>
    	{{ csrf_field() }}
        <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <select name='kategori_id'  class='form-control' >
                            ...
                            <option value='{{ $kategori->id }}' {{ $produk->kategori_id == $kategori->id ? 'selected':'' }}>{{ $kategori->jenis_kategori }}</option>
                    ...
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <select name='jenis_bahan_id' class='form-control'>
                            @foreach($jenis_bahans as $jenis_bahan)
                                <option value='{{ $jenis_bahan->id }}' {{ $produk->jenis_bahan_id == $jenis_bahan->id ? 'selected':'' }}>{{ $jenis_bahan->nama_bahan }}</option>
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="nama_produk" class="form-control" id="email"
                               placeholder="Baju Batik Keren" required autofocus value="{{ $produk->nama_produk }}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="row">
                                ...
                                <div class="col">
                                    <label>Small</label>
                                    <input class='form-control' type="number" name="smallStok" min="0" value="{{ $produk->ukuran_produks[0]->stok }}" required>
                                </div>
                                <div class="col">
                                    <label>Medium</label>
                                    <input class='form-control' type="number" name="mediumStok" min="0" value="{{ $produk->ukuran_produks[1]->stok }}" required>
                                </div>
                                <div class="col">
                                    <label>Large</label>
                                    <input class='form-control' type="number" name="largeStok" min="0" value="{{ $produk->ukuran_produks[2]->stok }}" required>
                                </div>
                                <div class="col">
                                    <label>Xtra Large</label>
                                    <input class='form-control' type="number" name="xtraLargeStok" min="0" value="{{ $produk->ukuran_produks[3]->stok }}" required>
                                </div>
                            </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <textarea name="deskripsi" class="form-control"
                               placeholder="Deskripsi Untuk Baju Batik Keren" required >{{ $produk->deskripsi }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="number" name="harga" class="form-control" id="email"
                               placeholder="100000" required value="{{ $produk->harga }}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="number" name="stok" class="form-control" id="email"
                               placeholder="100" required value="{{ $produk->stok }}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="number" name="berat" class="form-control" id="email"
                               placeholder="1" required value="{{ $produk->berat }}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-control-feedback">
                    <span class="text-danger align-middle">
                        @if($errors->has('gambar_belakang_nama'))
                            <i class="text-danger"> {{ $errors->first('gambar_belakang_nama') }}</i>
                        @endif
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="number" name="diskon" class="form-control" id="email"
                               placeholder="1" required value="{{ $produk->diskon }}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="datetime-local" name="tggl_masuk" class="form-control" id="email"
                               placeholder="1" required value='{{ date("Y-m-d\TH:i", strtotime($produk->tggl_masuk)) }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
