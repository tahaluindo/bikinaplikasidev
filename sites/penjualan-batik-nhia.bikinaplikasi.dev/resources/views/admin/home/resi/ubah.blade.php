...
<div class="container p-5">
    <form class="form-horizontal" role="form" method="POST" action="/admin/home/resi/ubah/{{ $resi->id }}">
    	@csrf
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <h2>Ubah resi ({{ $resi->order->kurir->nama_kurir }})</h2>
                <hr>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="resi" class="form-control" id="name"
                               placeholder="No resi" required autofocus value='{{ $resi->resi }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
