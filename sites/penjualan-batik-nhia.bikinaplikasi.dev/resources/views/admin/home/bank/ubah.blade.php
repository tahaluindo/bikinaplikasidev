...
<div class="container p-5">
    <form class="form-horizontal" role="form" method="POST" action="/admin/home/bank/ubahStore/{{ $bank->id }}">
    	{{ csrf_field() }}
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <h2>Ubah Bank {{ $bank->atas_nama }}</h2>
                <hr>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="no_rek" class="form-control" id="name"
                               placeholder="994201025587531" required autofocus value='{{ $bank->no_rek }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="nama_bank" class="form-control" id="name"
                               placeholder="BRI" required autofocus value='{{ $bank->nama_bank }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="atas_nama" class="form-control" id="name"
                               placeholder="Nhia Saridania" required autofocus value='{{ $bank->atas_nama }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
