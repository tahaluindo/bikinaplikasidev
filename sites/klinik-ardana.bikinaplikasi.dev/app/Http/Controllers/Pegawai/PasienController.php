...
class PasienController extends Controller
{
    ...
    public function simpan(Request $request)
    {
        ...
        \App\Pasien::create($request->only('nama', 'jenis_kelamin', 'tanggal_lahir', 'alamat', 'tlpn', 'alergi_obat', 'riwayat_penyakit'));
    ...
    public function periksa($id)
    {
        ...
        $periksa = \App\Periksa::where('pasien_id', $pasien['id'])->with('pegawai', 'bidan')->latest()->get()->toArray();
...
//        }
        ...
        $data = [
            'bidan_id' => $request->input('bidan_id'),
