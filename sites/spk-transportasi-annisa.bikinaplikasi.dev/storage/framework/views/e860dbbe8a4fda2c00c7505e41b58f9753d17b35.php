                                ...
                                <div class="product-sales-chart">
                                    <div style="padding: 20px !important;" class="table-responsive">
                                        ...
                                        <table class="table" id='dataTable'>
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <?php $__currentLoopData = $alternatif->sortBy('urutan_prioritas')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <th title="<?php echo e($item->nama); ?>"><?php echo e("SC" . ($key + 1)); ?></th>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <th>PRIORITY VECTOR</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php $__currentLoopData = $alternatif->sortBy('urutan_prioritas')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id='<?php echo e($item->id); ?>'>
                                                    <td title="<?php echo e($item->nama); ?>"><b><?php echo e("SC" . ($key1 + 1)); ?></b>
                                                    </td>
                                                    <?php $__currentLoopData = $alternatif->sortBy('urutan_prioritas')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <td>
                                                            <?php if($key1 == $key2): ?>
                                                                <input placeholder="nilai"
                                                                       class="form-control form-control-line <?php $__errorArgs = ['nilai'];
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <tr>
                                                <td colspan="<?php echo e($alternatif->count() + 1); ?>">Principle Eign Value</td>
                                                <td>
                                                    <input placeholder="nilai"
                                                           class="form-control form-control-line <?php $__errorArgs = ['nilai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <tr>
                                                <td colspan="<?php echo e($alternatif->count() + 1); ?>">Consistency Index</td>
                                                <td>
                                                    <input placeholder="nilai"
                                                           class="form-control form-control-line <?php $__errorArgs = ['nilai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <tr>
                                                <td colspan="<?php echo e($alternatif->count() + 1); ?>">Consistency Ratio</td>
                                                <td>
                                                    <input placeholder="nilai"
                                                           class="form-control form-control-line <?php $__errorArgs = ['nilai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                    ...
                    <div class="product-sales-chart">
                        <div style="padding: 20px !important;" class="table-responsive">
                            ...
                            <table class="table" id='dataTable'>
                                ...
                                <tbody>
                                <?php $__currentLoopData = $alternatif->sortBy('urutan_prioritas')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-id='<?php echo e($item->id); ?>'>
                                        <td>
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $item->nilai_kriteria ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemNilaiKriteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-transportasi-annisa.bikinaplikasi.dev\resources\views/perhitungan/show.blade.php ENDPATH**/ ?>