...
<head>
    ...
    <link rel="stylesheet" href="{{ url('') }}/assets/css/pe-icon-7-filled.css">
    <link href="{{ url('') }}/assets/weather/css/weather-icons.css" rel="stylesheet"/>
    <link href="{{ url('') }}/assets/calendar/fullcalendar.css" rel="stylesheet"/>
    <link rel="stylesheet" href="{{ url('') }}/assets/css/style.css">
    <link href="{{ url('') }}/assets/css/charts/chartist.min.css" rel="stylesheet">
    ...
    <header id="header" class="header">
        <div class="top-left">
            <div class="navbar-header">
                <a class="navbar-brand" href="index-2.html"><img src="{{ url("") }}/images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="index-2.html"><img src="{{ url("") }}/logo2.png" alt="Logo"></a>
            ...
            <div class="header-menu">
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                       aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="{{ url("") }}/avatar/png/004-girl.png"
                             alt="User Avatar">
                    </a>
                    <div class="user-menu dropdown-menu">
                        <a class="nav-link" href="{{ url(route('user.profile', auth()->id())) }}"><i
                                class="fa fa-user"></i>Profil Saya</a>
{{--                        <a class="nav-link" href="{{ url("pengaturan") }}"><i class="fa fa-cog"></i>Pengaturan</a>--}}
    ...
    <footer class="site-footer sticky-wrapper" style="position: fixed; bottom: 0; width: 100%;">
...
<script src="{{ url('') }}/assets/js/lib/chartist/chartist-plugin-legend.js"></script>
<script src="{{ url('') }}/assets/js/lib/flot-chart/jquery.flot.js"></script>
<script src="{{ url('') }}/assets/js/lib/flot-chart/jquery.flot.pie.js"></script>
<script src="{{ url('') }}/assets/js/lib/flot-chart/jquery.flot.spline.js"></script>
<script src="{{ url('') }}/assets/weather/js/jquery.simpleWeather.min.js"></script>
<script src="{{ url('') }}/assets/weather/js/weather-init.js"></script>
<script src="{{ url('') }}/assets/js/lib/moment/moment.js"></script>
<script src="{{ url('') }}/assets/calendar/fullcalendar.min.js"></script>
<script src="{{ url('') }}/assets/calendar/fullcalendar-init.js"></script>
