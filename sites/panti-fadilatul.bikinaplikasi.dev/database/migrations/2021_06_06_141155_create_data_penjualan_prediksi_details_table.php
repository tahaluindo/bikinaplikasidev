...
class CreateDataPenjualanPrediksiDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_penjualan_prediksi_details', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            $table->string('detail_penjualan_prediksi_id');
    ...
    {
        Schema::drop('data_penjualan_prediksi_details');
    }
}
