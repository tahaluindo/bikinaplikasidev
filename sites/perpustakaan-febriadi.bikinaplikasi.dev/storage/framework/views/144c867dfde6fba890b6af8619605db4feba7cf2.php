...
<div class="form-group <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
    <label for="status" class="control-label"><?php echo e('Level'); ?></label>
    ...
    <div class="col-md-12">
        <select name="level" class="form-control form-control-line" id="level" required>
            ...
            <option value="<?php echo e($optionKey); ?>"
                <?php echo e((isset($anggotum->user->level) && $anggotum->user->level == $optionKey) || $optionValue == old('level') ? 'selected' : ''); ?>><?php echo e($optionValue); ?>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/anggota/form.blade.php ENDPATH**/ ?>