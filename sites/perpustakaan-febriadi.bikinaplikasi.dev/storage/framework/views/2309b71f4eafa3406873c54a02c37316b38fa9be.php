                        ...
                        <table class="table" id='dataTable'>
                            ...
                            <?php $__currentLoopData = $peminjaman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr data-id='<?php echo e($item->id); ?>'>
                                    ...
                                    <td><?php echo e($item->diganti_pada); ?></td>

                                    <?php if(!in_array(auth()->user()->level, ['Siswa', 'Guru'])): ?>
                                        <td class="text-center">
                                            <?php if(now()->lte(\Carbon\Carbon::parse(date('Y-m-d', strtotime($item->tanggal_pengembalian)))) && (now()->diffInDays( Carbon\Carbon::parse(date('Y-m-d', strtotime($item->tanggal_pengembalian)))) <= env('APP_MIN_HARI_KIRIM_PEMBERITAHUAN')) && $item->status == 'Berlangsung'): ?>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/peminjaman/index.blade.php ENDPATH**/ ?>