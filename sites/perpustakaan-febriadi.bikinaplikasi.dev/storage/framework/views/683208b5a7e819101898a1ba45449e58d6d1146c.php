                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           ...
                           aria-expanded="false">
                            ...
                            <?php elseif(auth()->user()->level == 'Siswa'): ?>
                                <span class="badge"><?php echo e($peminjamans_notif->count()); ?></span>
                            <?php endif; ?>
                        </a>
                        <div class="dropdown-menu top-grid-scroll drop-1">
                            ...
                            <?php if($notifications->count()): ?>
                                ...
                                <?php $__currentLoopData = $peminjamans_notif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/layouts/app2.blade.php ENDPATH**/ ?>