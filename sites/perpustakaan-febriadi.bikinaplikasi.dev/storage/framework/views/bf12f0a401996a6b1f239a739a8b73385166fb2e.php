...
<?php $__env->startSection('dashboard-script'); ?>
    ...
    <script>
        ...
        var chartData = [{
            country: "Peminjaman",
            value: <?php echo e($peminjamans->count()); ?>

        },
            {
                country: "Pengembalian",
                value: <?php echo e($pengembalians->count()); ?>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/home.blade.php ENDPATH**/ ?>