        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                ...
                <div class="info-box p-3">
                    ...
                    <form class="form-horizontal form-material" action="<?php echo e(url('/anggota')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       name="no_identitas"
                                       type="text" id="no_identitas"
                                       value="<?php echo e(isset($anggotum->no_identitas) ? $anggotum->no_identitas : old('no_identitas')); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>"
                                       name="nama"
                                       type="text" id="nama"
                                       value="<?php echo e(isset($anggotum->nama) ? $anggotum->nama : old('nama')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('no_telepon') ? 'has-error' : ''); ?>">
                            ...
                            <div class="col-md-12">
                                <input placeholder="no_telepon"
                                       class="form-control form-control-line <?php $__errorArgs = ['no_telepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(isset($anggotum->no_telepon) ? $anggotum->no_telepon : old('no_telepon')); ?>"
                                       required>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/anggota/create.blade.php ENDPATH**/ ?>