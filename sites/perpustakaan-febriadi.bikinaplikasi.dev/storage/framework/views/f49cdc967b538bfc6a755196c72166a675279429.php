...
unset($__errorArgs, $__bag); ?>"
               name="kode_buku" type="text" id="kode_buku"
               value="<?php echo e(isset($buku->kode_buku) ? $buku->kode_buku : old('kode_buku')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
               name="judul" type="text" id="judul" value="<?php echo e(isset($buku->judul) ? $buku->judul : old('judul')); ?>"
               required>
...
unset($__errorArgs, $__bag); ?>"
               name="penulis" type="text" id="penulis"
               value="<?php echo e(isset($buku->penulis) ? $buku->penulis : old('penulis')); ?>"
               required>
...
<div class="form-group <?php echo e($errors->has('harga') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        <input placeholder="harga" class="form-control form-control-line <?php $__errorArgs = ['harga'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
               name="harga" type="number" id="harga" value="<?php echo e(isset($buku->harga) ? $buku->harga : old('harga')); ?>"
               required>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/buku/form.blade.php ENDPATH**/ ?>