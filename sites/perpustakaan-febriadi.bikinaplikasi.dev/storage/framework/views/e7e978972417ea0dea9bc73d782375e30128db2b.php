        ...
        <ul>
            <?php $__currentLoopData = $peminjaman->detail_peminjaman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail_peminjaman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><?php echo e($detail_peminjaman->buku->judul); ?> x <?php echo e($detail_peminjaman->jumlah); ?>
                    ...
                    (<?php echo e($detail_peminjaman->status); ?>)
                </li>
...
unset($__errorArgs, $__bag); ?>" name="tanggal"
               ...
               value="<?php echo e(isset($pengembalian->tanggal) ? $pengembalian->tanggal : now()->format('d-M-Y')); ?>"
               required>
...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e(isset($pengembalian->denda_terlambat) ? $pengembalian->denda_terlambat : (now() > Carbon\Carbon::parse($peminjaman->tanggal_pengembalian) ? now()->diffInDays(Carbon\Carbon::parse($peminjaman->tanggal_pengembalian)) * env('APP_DENDA_TERLAMBAT_PER_HARI') : 0)); ?>"
               required>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-febriadi.bikinaplikasi.dev\resources\views/pengembalian/form.blade.php ENDPATH**/ ?>