<div class="form-group <?php echo e($errors->has('anggota_id') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <input list="anggota_id" class="form-control form-control-line" required name="anggota_id" value="<?php echo e($peminjaman->anggota_id); ?>">
...
unset($__errorArgs, $__bag); ?>" name="tanggal"
               ...
               value="<?php echo e(isset($peminjaman->tanggal) ? $peminjaman->tanggal : (old('tanggal') == "" ? date('d-M-Y') : old('tanggal'))); ?>"
               required>
...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e(isset($peminjaman->tanggal_pengembalian) ? $peminjaman->tanggal_pengembalian : (old('tanggal_pengembalian') == "" ? now()->addday(env('APP_WAKTU_TERLAMBAT'))->format('d-M-Y') : old('tanggal_pengembalian'))); ?>"
               required>
...
<?php /**PATH /var/www/vhosts/perpustakaan-febriadi.bikinaplikasi.dev/resources/views/peminjaman/form.blade.php ENDPATH**/ ?>