...
<div class="form-group <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <select name="status" class="form-control form-control-line" id="status" required>
            <?php $__currentLoopData = ['Berlangsung', 'Selesai', 'Perpanjangan', 'Hilang','Diganti Buku']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
