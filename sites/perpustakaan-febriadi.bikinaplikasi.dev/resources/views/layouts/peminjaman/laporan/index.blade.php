    ...
    <div class='col-md-12'>
        <form class="form-horizontal form-material" action="{{ url(route('peminjaman.print')) }}" method="post"
            ...
            <div class="form-group {{ $errors->has('tanggal_awal') ? 'has-error' : ''}}">
                ...
                <div class="col-md-12">
                    <input placeholder="tanggal_awal"
                        ...
                        name="tanggal_awal" type="text" id="tanggal_awal" value="{{ old('tanggal_awal') == "" ? now()->format('y-M-D') : old('tanggal_awal')}}" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-line" name='status'>
                        @foreach(['', 'Selesai', 'Belum Selesai'] as $status)
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="number" placeholder="{{ $limit }}" class="form-control form-control-line" id="example-limit"
