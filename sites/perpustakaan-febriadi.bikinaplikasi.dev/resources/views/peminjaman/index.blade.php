                        ...
                        <table class="table" id='dataTable'>
                            ...
                            @foreach($peminjaman as $item)
                                <tr data-id='{{ $item->id }}'>
                                    ...
                                    <td>{{ $item->diganti_pada  }}</td>

                                    @if(!in_array(auth()->user()->level, ['Siswa', 'Guru']))
                                        <td class="text-center">
                                            @if(now()->lte(\Carbon\Carbon::parse(date('Y-m-d', strtotime($item->tanggal_pengembalian)))) && (now()->diffInDays( Carbon\Carbon::parse(date('Y-m-d', strtotime($item->tanggal_pengembalian)))) <= env('APP_MIN_HARI_KIRIM_PEMBERITAHUAN')) && $item->status == 'Berlangsung')
