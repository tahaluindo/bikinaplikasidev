                        ...
                        <div class="form-group {{ $errors->has('no_identitas') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-12">
                                <input placeholder="no_identitas"
                                       ...
                                       value="{{ isset($anggotum->no_identitas) ? $anggotum->no_identitas : old('no_identitas')}}"
                                       required>
                        ...
                        <div class="form-group {{ $errors->has('nama') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-12">
                                <input placeholder="nama"
                                       ...
                                       name="nama"
                                       type="text" id="nama"
                                       value="{{ isset($anggotum->nama) ? $anggotum->nama : old('nama')}}" required>
                        ...
                        <div class="form-group {{ $errors->has('no_telepon') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-12">
                                <input placeholder="no_telepon"
                                       class="form-control form-control-line @error('no_telepon') is-invalid @enderror"
                                       name="no_telepon" type="text" id="no_telepon"
                                       value="{{ isset($anggotum->no_telepon) ? $anggotum->no_telepon : old('no_telepon')}}"
                                       required>
