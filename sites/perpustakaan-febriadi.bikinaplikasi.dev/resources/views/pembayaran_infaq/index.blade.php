                            ...
                            <tbody>
                                ...
                                <tr data-id="{{ $pembayaran_infaq->id }}">
                                    ...
                                    <td class='text-center'>
                                        <a class="badge badge-primary" href="{{ route('pembayaran_infaq.edit', ['pembayaran_infaq' => $pembayaran_infaq->id]) }}">Edit</a>
                                        <form action="{{ route('pembayaran_infaq.destroy', ['pembayaran_infaq' => $pembayaran_infaq->id]) }}"
                                            method='post' style='display: inline;'
                                            onsubmit="return confirm('Yakin akan menghapus data ini?')">
                                            @method('DELETE')
                                            @csrf
                                            <label class="badge badge-danger" href="" for='btnSubmit-{{ $pembayaran_infaq->id }}'
