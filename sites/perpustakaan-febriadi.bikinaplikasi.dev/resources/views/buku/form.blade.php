<div class="form-group {{ $errors->has('judul') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="kode_buku" class="form-control form-control-line @error('kode_buku') is-invalid @enderror"
               ...
               value="{{ isset($buku->kode_buku) ? $buku->kode_buku : old('kode_buku')}}" required>
...
<div class="form-group {{ $errors->has('judul') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="judul" class="form-control form-control-line @error('judul') is-invalid @enderror"
               name="judul" type="text" id="judul" value="{{ isset($buku->judul) ? $buku->judul : old('judul')}}"
               required>
...
<div class="form-group {{ $errors->has('penulis') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="penulis" class="form-control form-control-line @error('penulis') is-invalid @enderror"
               ...
               value="{{ isset($buku->penulis) ? $buku->penulis : old('penulis')}}"
               required>
...
<div class="form-group {{ $errors->has('harga') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="harga" class="form-control form-control-line @error('harga') is-invalid @enderror"
               name="harga" type="number" id="harga" value="{{ isset($buku->harga) ? $buku->harga : old('harga')}}"
               required>
