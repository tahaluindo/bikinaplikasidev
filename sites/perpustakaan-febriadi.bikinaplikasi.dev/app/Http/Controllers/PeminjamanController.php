...
//            'tanggal' => 'required|max:12|before:tanggal_pengembalian',
//            'tanggal_pengembalian' => 'required|max:12|after:tanggal',
            'status' => 'required|in:Berlangsung,Selesai,Perpanjangan,Hilang,Diganti Buku,Diganti Uang,Rusak'
        ]);
    ...
    public function print(Request $request)
    {
        ...
        $tanggal_awal = $request->tanggal_awal ? $request->tanggal_awal : (Peminjaman::get()->first()->tanggal ?? date('y-M-D'));
        $tanggal_akhir = $request->tanggal_akhir ? $request->tanggal_akhir : (Peminjaman::get()->last()->tanggal ?? date('y-M-D'));
