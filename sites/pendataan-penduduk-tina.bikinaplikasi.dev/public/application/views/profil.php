                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card bg-secondary border-0 mb-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5 text-center">
                            <?php if(!$this->input->get('struktur_desa')): ?>
                            <h1>Profil Desa</h1>

                            <?php foreach($DataProfileDesa as $t): ?>
                            <h2>Visi</h2>
                            <div class='m-2'>
                                <?php echo $t['visi']; ?>
                            </div>
                            ...
                            <div class='m-2'>
                                <img src="<?php echo base_url("assets/uploads/$struktur_desa->struktur_desa"); ?>" alt="" style='width: 100%; height: auto;'>
                            </div>
                            <?php endif; ?>
