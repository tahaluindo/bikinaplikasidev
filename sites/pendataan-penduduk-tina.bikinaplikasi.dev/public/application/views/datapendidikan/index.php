                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="<?= base_url(); ?>#"
                                    class="breadcrumb-link">Pendidikan</a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header">
                    <a href='<?php echo site_url('DataPendidikan/add'); ?>' class="btn btn-primary btn-sm">Tambah</a>
                </div>
                ...
                <div class="card-body">
                    <table id="datatable" class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                                $no = 1;
                                foreach ($DataPendidikan as $t) {?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo $t['keterangan']; ?></td>
                                <td>
                                    <a href="<?php echo site_url('DataPendidikan/edit/' . $t['id']); ?>"
                                        class="badge badge-info badge-xs"><span
                                            class="fa fa-pencil"></span> Edit</a>
                                    <a onclick='return confirm("Yakin akan menghapus data ini?")'
                                        href="<?php echo site_url('DataPendidikan/remove/' . $t['id']); ?>"
