<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
            <div class="card">
                <div class="card-body">
                    <?php echo form_open("DataPendudukPindah/edit/" . $DataPendudukPindah['nik'], array("class"=>"form-horizontal" , "enctype" => 'multipart/form-data')); ?>
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control form-control-sm selectpicker" data-live-search="true"  name="nik" id='nik'>
                                                    ...
                                                    <option value="<?= $item->nik ?>" <?= $DataPendudukPindah['nik'] == $item->nik ? "selected" : "" ?>><?= "$item->nama_lengkap ({$item->nik})" ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="alasan_pindah"
                                                    value="<?php echo $this->input->post('alasan_pindah') == "" ? $DataPendudukPindah['alasan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="alamat_tujuan_pindah"
                                                    value="<?php echo $this->input->post('alamat_tujuan_pindah') == "" ? $DataPendudukPindah['alamat_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="rt_tujuan_pindah"
                                                    value="<?php echo $this->input->post('rt_tujuan_pindah') == "" ? $DataPendudukPindah['rt_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="rw_tujuan_pindah"
                                                    value="<?php echo $this->input->post('rw_tujuan_pindah') == "" ? $DataPendudukPindah['rw_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="desa_tujuan_pindah"
                                                    value="<?php echo $this->input->post('desa_tujuan_pindah') == "" ? $DataPendudukPindah['desa_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="kode_pos_tujuan_pindah"
                                                    value="<?php echo $this->input->post('kode_pos_tujuan_pindah') == "" ? $DataPendudukPindah['kode_pos_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="no_telepon_tujuan_pindah"
                                                    value="<?php echo $this->input->post('no_telepon_tujuan_pindah') == "" ? $DataPendudukPindah['no_telepon_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="kecamatan_tujuan_pindah"
                                                    value="<?php echo $this->input->post('kecamatan_tujuan_pindah') == "" ? $DataPendudukPindah['kecamatan_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="kabupaten_tujuan_pindah"
                                                    value="<?php echo $this->input->post('kabupaten_tujuan_pindah') == "" ? $DataPendudukPindah['kabupaten_tujuan_pindah'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="provinsi_tujuan_pindah"
                                                    value="<?php echo $this->input->post('provinsi_tujuan_pindah') == "" ? $DataPendudukPindah['provinsi_tujuan_pindah'] : ""; ?>"
