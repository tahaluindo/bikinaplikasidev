                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class='form-control' name='jenis_kelamin' required>
                                                <option value='Laki - Laki' <?php if($DataPenduduk['jenis_kelamin']=='Laki - Laki'){echo "selected";} ?>>Laki - Laki</option>
                                                <option value='Perempuan' <?php if($DataPenduduk['jenis_kelamin']=='Perempuan'){echo "selected";} ?>>Perempuan</option>
                                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <select class="form-control form-control-sm" name="pekerjaan" id='pekerjaan'>
                                    ...
                                    <?php endforeach;?>
                                    <option value="lain-lain" <?php echo $cekPekerjaanLainLain ? "selected" : ""; ?>>
                                        Lain - Lain</option>
                                </select>
                        ...
                        <div class="col-md-12 <?php echo $cekPekerjaanLainLain ? "":"d-none"; ?>"
                            id='pekerjaan_lain_lain'>
                        ...
                        <div class="col-md-12">
                            <label for="pekerjaan" class="control-label"><span class="text-danger">*</span>Lurah</label>
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <label for="negara" class="control-label"><span class="text-danger">*</span>Negara</label>
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <select class='form-control' name='status' required>
                                    <option value='Kawin' <?php if ($this->input->post('status') == 'Kawin' || $DataPenduduk['status'] == "Kawin") {echo "checked";}?> >Kawin</option>
                                    <option value='Belum Kawin' <?php if ($this->input->post('status') == 'Belum Kawin' || $DataPenduduk['status'] == "Belum Kawin") {echo "checked";}?>>Belum Kawin</option>
                                    <option value='Cerai Hidup' <?php if ($this->input->post('status') == 'Cerai Hidup' || $DataPenduduk['status'] == "Cerai Hidup") {echo "checked";}?>>Cerai Hidup</option>
                                    <option value='Cerai Mati' <?php if ($this->input->post('status') == 'Cerai Mati' || $DataPenduduk['status'] == "Cerai Mati") {echo "checked";}?>>Cerai Mati</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <label for="golongan_darah" class="control-label"><span class="text-danger">*</span>Golongan
                                Darah</label>
                            <div class="form-group">
