                ...
                <ul class="navbar-nav align-items-start  mr-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url(); ?>" data-action="search-show" data-target="#navbar-search-main">
                            <h1 class='text-white'>Data Kependudukan Kantor Desa Kota Raja</h1>
                        </a>
                    </li>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="row clearfix">
                                            <div class="col-md-12">
                                                <label for="data_penduduk" class="control-label"><span
                                                        class="text-danger">*</span>Data Penduduk</label>
                                                <div class="form-group">
                                                    <input type="text" disabled name="data_penduduk" required
                                                        value="<?php echo ($this->input->post('data_penduduk') ? $this->input->post('data_penduduk') : $laporan['data_penduduk']); ?>"
                                                        class="form-control" id="data_penduduk" />
                                                    <span
                                                        class="text-danger"><?php echo form_error('data_penduduk');?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="keterangan"
                                                        value="<?php echo ($this->input->post('keterangan') ? $this->input->post('keterangan') : $laporan['keterangan']); ?>"
                                                        class="form-control" id="keterangan" />
                                                    <span
                                                        class="text-danger"><?php echo form_error('keterangan');?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
