...
class DataLurah extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataLurah = $this->db->get_where('lurah', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataLurah']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataLurah = $this->db->get_where('lurah', array('id' => $this->input->post('id'), 'id!=' => $id));
