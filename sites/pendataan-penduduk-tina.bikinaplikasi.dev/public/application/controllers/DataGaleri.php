...
class DataGaleri extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataGaleri = $this->db->get_where('galeri', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataGaleri']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataGaleri = $this->db->get_where('galeri', array('id' => $this->input->post('id'), 'id!=' => $id));
