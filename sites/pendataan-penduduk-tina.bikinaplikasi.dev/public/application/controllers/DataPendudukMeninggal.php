...
class DataPendudukMeninggal extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataPendudukMeninggal = $this->db->get_where('pendudukmeninggal', array('nik' => $this->input->post('nik')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataPendudukMeninggal']['nik'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataPendudukMeninggal = $this->db->get_where('pendudukmeninggal', array('nik' => $this->input->post('nik'), 'nik!=' => $id));
                $cek_DataPenduduk = $this->db->get_where('penduduk', array('nik' => $this->input->post('nik')));
