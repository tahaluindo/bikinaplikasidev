...
class DataPendidikan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataPendidikan = $this->db->get_where('pekerjaan', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataPendidikan']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataPendidikan = $this->db->get_where('pekerjaan', array('id' => $this->input->post('id'), 'id!=' => $id));
