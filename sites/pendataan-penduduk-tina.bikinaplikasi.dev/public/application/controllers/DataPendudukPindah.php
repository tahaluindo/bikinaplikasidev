...
class DataPendudukPindah extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataPendudukPindah = $this->db->get_where('pendudukpindah', array('nik' => $this->input->post('nik')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataPendudukPindah']['nik'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataPendudukPindah = $this->db->get_where('pendudukpindah', array('id' => $this->input->post('id'), 'id!=' => $id));
                $cek_DataPenduduk = $this->db->get_where('penduduk', array('nik' => $this->input->post('nik')));
