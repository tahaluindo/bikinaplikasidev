...
class DataPekerjaan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataPekerjaan = $this->db->get_where('pekerjaan', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataPekerjaan']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataPekerjaan = $this->db->get_where('pekerjaan', array('id' => $this->input->post('id'), 'id!=' => $id));
