...
class Home extends CI_Controller {
	...
	{
		$data['penduduks'] = $this->db->get('pekerjaan');
		$data['penduduk_tetaps'] = $this->db->get('penduduktetap');
		$data['penduduk_meninggals'] = $this->db->get('pendudukmeninggal');
		$data['penduduk_pindahs'] = $this->db->get('pendudukpindah');
		$data['penduduk_lahirs'] = $this->db->get('penduduklahir');
		$data['penduduk_datangs'] = $this->db->get('pendudukdatang');
