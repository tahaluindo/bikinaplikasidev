...
class DataProfileDesa extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataProfileDesa = $this->db->get_where('profiledesa', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataProfileDesa']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataProfileDesa = $this->db->get_where('profiledesa', array('id' => $this->input->post('id'), 'id!=' => $id));
