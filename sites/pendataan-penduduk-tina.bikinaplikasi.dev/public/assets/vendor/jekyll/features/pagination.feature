Feature: Site pagination
  ...
  Scenario Outline: Paginate with N posts per page
    ...
    And I have the following posts:
      ...
      | Pendudukmes  | 2009-03-27 | default | The only winning move is not to play.  |
      | Pendudukmes2 | 2009-04-27 | default | The only winning move is not to play2. |
      | Pendudukmes3 | 2009-05-27 | default | The only winning move is not to play3. |
      | Pendudukmes4 | 2009-06-27 | default | The only winning move is not to play4. |
