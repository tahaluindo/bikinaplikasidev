...
Route::middleware('auth')->group(function () {
    ...
    // user
    Route::get('user/detail_siswa/{user}', 'UserController@detail_siswa')->name('user.detail_siswa');
    Route::get('user/detail_guru/{user}', 'UserController@detail_guru')->name('user.detail_guru');
    ...
    Route::get('raport/input/{raport}', 'RaportController@input')->name('raport.input');
    Route::post('raport/input/{raport}', 'RaportController@inputStore')->name('raport.inputStore');
    Route::resource('raport', 'RaportController');

    // absensi
    Route::get('absensi/laporan/print/{absensi}', 'AbsensiController@print')->name('absensi.laporan.print');
    Route::get('absensi/hadir/{absensi_detail}/{user}', 'AbsensiController@hadir')->name('absensi.hadir');
    Route::get('absensi/tidak-hadir/{absensi_detail}/{user}', 'AbsensiController@tidakHadir')->name('absensi.tidak-hadir');
    Route::get('absensi/izin/{absensi_detail}/{user}', 'AbsensiController@izin')->name('absensi.izin');;
    ...
    Route::get('laporan/kelas', 'LaporanController@kelas')->name('laporan.kelas');
