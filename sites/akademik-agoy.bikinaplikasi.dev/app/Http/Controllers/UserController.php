...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (auth()->user()->level == "tu" && $request->level == 'siswa'):
            $this->validate($request, [
                ...
                'status' => 'required|in:aktif,tidak aktif,pindah,keluar',
        ...
        return redirect()->route('user.index')->with("success", "Berhasil menambah akun");
    }
    ...
    public function show(User $user)
    {
        ...
        if($user->level != 'guru') {
            ...
            return view('user.edit_siswa', $data);
        } else {
            return view('user.edit_guru', $data);
    ...
    public function detail_siswa(User $user)
    {
        ...
        return view('user.detail_siswa', $data);
    }

    public function detail_guru(User $user)
    {
        //
        $data['user'] = $user;
        $data['kelass'] = Kelas::all();
        ...
        return view('user.detail_guru', $data);
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('user.index')->with("success", "Berhasil mengupdate akun");
    }
    ...
    public function importStore(Request $request)
    {
        ...
        return redirect()->route('user.index')->with('success', 'Berhasil mengimport akun');
    }
    ...
    public function aktifkan_semua(Request $request)
    {
        ...
        return back()->with('success', 'Berhasil mengaktifkan banyak data akun');
    }
    ...
    public function hapus_semua(Request $request)
    {
        ...
        return back()->with('success', 'Berhasil menghapus banyak data akun');
    }
...
// dd('kewo');
        ...
        return redirect()->to($to)->with('success', 'Berhasil mengupdate kelas akun');
    }
}
