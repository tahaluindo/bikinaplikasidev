...
@section('page') Edit Nilai Detail @endsection
        ...
        <div class="row">
            <div class="col-md-4">
                <form class="form-horizontal form-material"
                      action="{{ url(route('nilai_detail.update', $nilai_detail->id)) }}"
                            ...
                            <select class="form-control form-control-line" name='user_id'>
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}"
                                            @if(old('user_id')==$user->id || $nilai_detail->user_id == $user->id) selected
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" placeholder="1" class="form-control form-control-line"
                                   name='tugas' value='{{ old('tugas') == "" ? $nilai_detail->tugas : old('tugas') }}'
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" placeholder="1" class="form-control form-control-line"
                                   name='ulangan_harian'
                                   value='{{ old('ulangan_harian') == "" ? $nilai_detail->ulangan_harian : old('ulangan_harian') }}'
                                   min=1 max=100 step="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" placeholder="1" class="form-control form-control-line"
                                   name='mid_semester'
                                   value='{{ old('mid_semester') == "" ? $nilai_detail->mid_semester : old('mid_semester') }}'
                                   min=1 max=100 step="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" placeholder="1" class="form-control form-control-line"
                                   name='uas' value='{{ old('uas') == "" ? $nilai_detail->uas : old('uas') }}' min=1
                                   max=100 step="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="xxx" class="form-control form-control-line"
                                   name='deskripsi_pengetahuan' value='{{ old('deskripsi_pengetahuan') == "" ? $nilai_detail->deskripsi_pengetahuan : old('deskripsi_pengetahuan') }}' min=1 max=100
                                   step="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" placeholder="1" class="form-control form-control-line"
                                   name='keterampilan'
                                   value='{{ old('keterampilan') == "" ? $nilai_detail->keterampilan : old('keterampilan') }}'
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="xxxx" class="form-control form-control-line"
                                   name='deskripsi_keterampilan' value='{{ old('deskripsi_keterampilan') == "" ? $nilai_detail->deskripsi_keterampilan : old('deskripsi_keterampilan') }}' min=1
                                   max=100 step="1">
