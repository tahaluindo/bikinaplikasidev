...
<body class="bg-black" style='background-image: url({{ url(env('APP_BACKGROUND_IMAGE')) }}); background-repeat: no-repeat; background-size: cover; width: 100%; height: 100%'>
    ...
    <div class="form-box" id="login-box">
        ...
        <div class="header text-center" style='background-color: #1e3d59'>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="footer">
                <button type="submit" class="btn btn-block"  style='background-color: #1e3d59; color: white;'>Sign in</button>
                <p>
