                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" placeholder="xxxxxxx"
                            class="form-control form-control-line @error('nama_orang_tua') is-invalid @enderror"
                            value='{{ old('nama_orang_tua') == "" ? $alternatif->nama_orang_tua : old('nama_orang_tua') }}' name='nama_orang_tua'>
