...
@section('page') Tambah Inputan Raport @endsection
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="Deskripsi sikap spiritual"
                                   class="form-control form-control-line @error('deskripsi_sikap_spiritual') is-invalid @enderror"
                                   value='{{ old('deskripsi_sikap_spiritual') }}' name='deskripsi_sikap_spiritual' min=1
                                   max=100>

                            @error('deskripsi_sikap_spiritual')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="Deskripsi sikap sosial"
                                   class="form-control form-control-line @error('deskripsi_sikap_sosial') is-invalid @enderror"
                                   value='{{ old('deskripsi_sikap_sosial') }}' name='deskripsi_sikap_sosial' min=1
                                   max=100>

                            @error('deskripsi_sikap_sosial')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                            @enderror
