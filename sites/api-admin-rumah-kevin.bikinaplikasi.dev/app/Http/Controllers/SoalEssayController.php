...
class SoalEssayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('soal_essay.index')->with("success", "Berhasil menambah soal_essay");
    }
    ...
    public function update(Request $request, SoalEssay $soal_essay)
    {
        ...
        return redirect()->route('soal_essay.index')->with("success", "Berhasil mengupdate SoalEssay");
    }
    ...
    public function destroy(SoalEssay $soal_essay)
    {
        ...
        return redirect()->route('soal_essay.index')->with('success', 'Berhasil menghapus SoalEsay');
    }
    ...
    public function hapus_semua(Request $request)
    {
        ...
        return back()->with('success', 'Berhasil menghapus banyak data soal_essay');
    }
