...
class TestDetailController extends Controller
{
    ...
    { 
        ...
        return redirect()->route('test_detail.index')->with('success', 'Berhasil menambah test_detail');
    }
    ...
    {
        return redirect()->route('test_detail.index')->with('success', 'Berhasil mengupdate TestDetail');
    }
    ...
    public function destroy(TestDetail $test_detail)
    {
        ...
        return redirect()->route('test_detail.index')->with('success', 'Berhasil menghapus TestDetail');
    }
    ...
    public function batalkan(TestDetail $test_detail)
    {
        ...
        return back()->with('success', "Berhasil membatalkan test untuk user id " . auth()->user()->id);
    }
}
