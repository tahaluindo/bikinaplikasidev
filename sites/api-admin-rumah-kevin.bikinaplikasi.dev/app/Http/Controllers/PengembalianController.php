...
class PengembalianController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $tanggal_awal = $request->tanggal_awal ? $request->tanggal_awal : (Pengembalian::get()->first()->created_at ?? date('d-M-Y'));
        $tanggal_akhir = $request->tanggal_akhir ? $request->tanggal_akhir : (Pengembalian::get()->last()->created_at ?? date('d-M-Y'));
