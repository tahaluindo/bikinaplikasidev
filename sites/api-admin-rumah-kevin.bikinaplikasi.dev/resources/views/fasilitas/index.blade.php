...
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">{{ ucwords("fasilitas") }}</h4>
                    <ol class="breadcrumb">

                        <li class="breadcrumb-item"><a href="javaScript:void();">Halaman</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ ucwords("fasilitas") }}</li>
                    </ol>
                </div>
            </div>
            <!-- End Breadcrumb-->
    ...
    <script>
        ...
        var columnOrders = [{{ $fasilitas_count - 1}}];
