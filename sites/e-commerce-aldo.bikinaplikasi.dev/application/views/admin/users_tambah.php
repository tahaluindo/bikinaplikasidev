            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-title">
                                    <div class="title">TAMBAH DATA USER</div>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo site_url('administrator/simpanUser') ?>">
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" name="nama" class="form-control input-sm" placeholder="Nama" required <?php echo hanyaHuruf() ?>/>
                            </div>
                           
                            <div class="form-group">
                                <label>Username</label>
                                <input type="text" name="username" class="form-control input-sm" placeholder="Username" required <?php echo hanyaHuruf() ?>/>
                            </div>
                            <div class="form-group">
