                            ...
                            <div class="col-lg-6">
                                <table>
                                    ...
                                    <tr>
                                        <th>Harga</th>
                                        <th>:</th>
                                        <th><?php echo ribuan($barang->harga) ?></th>
                                    </tr>
                                    <tr>
                                        <th>Harga Promo</th>
                                        <th>:</th>
                                        <th><?php echo ribuan($barang->hargapromo) ?></th>
                                    </tr>
                                    <tr>
                                    ...
                                    <?php if(strtolower($barang->nmkategori) == 'jilbab' || strtolower($barang->nmkategori) == 'hijab') { ?>
                                    <tr>
                                        <th>Ukuran</th>
                                        <th>:</th>
                                        <th><?php echo $barang->ukuran ?></th>
                                    </tr>
                                    <tr>
                                        <th>Jumlah</th>
                                        <th>:</th>
                                        <th><?php echo $barang->jumlah ?></th>
                                    </tr>
                                    <?php } else { ?>
                                    <tr>
                                        <th colspan="3">
