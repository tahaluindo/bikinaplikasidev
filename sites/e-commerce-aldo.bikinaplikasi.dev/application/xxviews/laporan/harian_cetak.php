...
<body onload="window.print();" layout="potrait">
    ...
    <div class="container">
        ...
        <div class="col-xs-12" style="min-height:500px">
            ...
            <p class="text-center">LAPORAN TRANSAKSI TANGGAL : <?php echo $tanggal ?></p>
            <br>
            <div class="row">
                <?php foreach($harian->result() as $rsharian) { ?>
                <div class="col-xs-12">
                    <table>
                        <tr>
                            <td>Order</td>
                            <td>:</td>
                            <td>#<?php echo $rsharian->id_pesan ?></td>
                        </tr>
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                            <td><?php echo $rsharian->nama ?></td>
                        </tr>
                    </table>            
                </div>
                <div class="col-xs-12">
                    <?php 
                    $sql = "SELECT * FROM detail_pemesanan INNER JOIN barang ON detail_pemesanan.id_barang = barang.id INNER JOIN pemesanan ON detail_pemesanan.id_pesan = pemesanan.id_pesan WHERE pemesanan.id_pesan = '$rsharian->id_pesan'";
