...
<div class="col-md-12">
    <input placeholder="tanggal" class="form-control form-control-line @error('tanggal') is-invalid @enderror" name="tanggal" type="date" id="tanggal" value="{{ isset($pengeluaran->tanggal) ? $pengeluaran->tanggal : (old('tanggal') != "" ? old('tanggal') : date('Y-m-d')) }}" required>
