...
<div>
    <p>Total Bayar (Rp) : {{ toIdr($penjualan->penjualan_details->sum('total')) }}<br>
    <p>Total Ongkir (Rp) : {{ toIdr($penjualan->ongkos_kirim ?? 0) }}<br>
    <p style="font-weight:bold;">Total Keseluruhan (Rp) : {{ toIdr(($penjualan->ongkos_kirim ?? 0) + $penjualan->penjualan_details->sum('total')) }}<br>
</div>
