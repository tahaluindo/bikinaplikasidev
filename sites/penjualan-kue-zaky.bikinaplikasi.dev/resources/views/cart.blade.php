                    ...
                    <form action="{{ url('bayar-cart') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="cart__discount">
                            ...
                            <p>
                                ...
                                <strong>Est. Ongkos Kirim</strong><br>
                                <input type="text" placeholder="Ongkos Kirim" name="ongkos_kirim" required readonly
                                       id="distance" value="{{ request('total-ongkir') }}">

                            <p>
                            <p>
                                <label>Bukti Transfer (kirim ke rek: BCA 8537209945 A/N Ninda Satya) / Kosongkan bila
                                    COD</label>
                        ...
                        <div class="cart__total">
                            ...
                            <ul>
                                ...
                                <li>Total Ongkir: <span id="total-ongkir">{{ toIdr(request("total-ongkir") ?? 0) }}</span></li>
                                <li>Total Keseluruhan: <span id="total-keseluruhan">{{ toIdr((request('total-ongkir') ?? 0) + $cart->total) }}</span></li>
                            </ul>
    ...
    <script async defer>
        ...
        if (!navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition((currentPosition) => {
                ...
                var latTitudeRotiMila = -1.6419386636239086;
                var longitudeRotiMila = 103.62425866911005;

                var distance = google.maps.geometry.spherical.computeDistanceBetween(new google.maps.LatLng(latTitudeRotiMila, longitudeRotiMila), new google.maps.LatLng(latTitudeUser, longitudeUser));
