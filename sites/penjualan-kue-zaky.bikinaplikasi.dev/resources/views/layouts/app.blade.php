...
{{--            @endif--}}
            ...
            @if(in_array(auth()->user()->level, ['', 'Karyawan']))
                <li>
                    <a @if(Route::current()->action['as'] == 'penjualan.index') class='side-menu side-menu--active'
                       @else class='side-menu'
                       @endif href="{{ route('penjualan.index') }}">
                        <div class="side-menu__icon"><i data-feather="database"></i></div>
           ...
           @if(in_array(auth()->user()->level, ['', 'Karyawan']))
            ...
            @if(in_array(auth()->user()->level, ['Admin', 'Pemilik', 'Karyawan']))
                <li>
                    <a @if(Route::current()->action['as'] == 'penjualan.laporan.index') class='side-menu side-menu--active'
                       @else class='side-menu'
                       @endif href="{{ route('penjualan.laporan.index') }}">
                        <div class="side-menu__icon"><i data-feather="database"></i></div>
                            ...
                            <div class="cursor-pointer relative flex items-center ">
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="{{ url('penjualan') }}" class="font-medium truncate mr-5">{{ $item->alamat_pengiriman }}</a>
                                        <div
