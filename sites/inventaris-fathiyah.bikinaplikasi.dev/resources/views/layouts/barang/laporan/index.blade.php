        ...
        <div class="col-md-4">
            <div class="media">
                <div class="media-body">
                    <h4 class="page-header-title">Laporan Barang</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-6 col-md-6 js-grid">
            <div class="panel px-1">
                <div class="panel-body " style="display: inline-block; width: 100%;">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('barang.print')) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='field' required>
                                    @foreach(['id','jenis_id','kode','nama','jumlah','umur_manfaat','harga_per_unit','nilai_perolehan','penyusutan_per_tahun','kondisi'] as $field)
