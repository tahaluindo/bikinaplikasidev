...
@section('breadcrumb')
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"><a href="#" class="">Application</a> <i
            data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="#"
                                                                          class="breadcrumb--active">Meja</a>
    </div>
@endsection
            ...
            <div class="col-span-12 lg:col-span-12 mt-8">
                ...
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                    ...
                    <table class="table table-auto" id='dataTable'>
                        <thead>
                        <tr>
                            <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap" width=2>#</th>
                            <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">No Meja</th>
                            <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap">Qr Code</th>
                            <th class="border border-b-2 dark:border-dark-5 whitespace-nowrap text-center">Aksi</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($meja as $item)
                            <tr data-id='{{ $item->id }}'>
                                ...
                                <td class="border">{{ $item->no_meja }}</td>
                                <td class="border">
                                    <a href="{{ url('qrcode-meja') }}?no_meja={{ $item->no_meja }}">Lihat</a>
                                </td>
