...
class MejaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
			'no_meja' => 'required|max:15|unique:meja,no_meja',
		]);
    ...
    {
        $this->validate($request, [
			'no_meja' => "required|max:15|unique:meja,no_meja,$meja->no_meja,meja",
		]);
    ...
    {
        $data['limit'] = Meja::count();

        return view('meja.laporan.index', $data);
    }
