...
<div class="error-pagewrap">
    <div class="error-page-int">
        <div class="text-center m-b-md custom-login">
            <h3 style="color: white !important;">LOGIN</h3>
            <p  style="color: white !important;"><?php echo e(env('APP_OBJECT_NAME')); ?> - <?php echo e(env('APP_OBJECT_LOCATION')); ?></p>
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center login-footer">
            <p  style="color: white !important;">Copyright © <?php echo e(date("Y")); ?>. All rights reserved.</p>
        </div>
    </div>
</div>
<!-- jquery
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-guru-teladan-anggi.bikinaplikasi.dev\resources\views/auth/login.blade.php ENDPATH**/ ?>