...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <tr data-id='<?php echo e($item->id); ?>'>
                                        ...
                                        <td class="text-center">
                                            <a class="badge badge-primary"
                                               href="<?php echo e(url('/perhitungan/' . $item->id)); ?>">Lihat Perhitungan</a>

                                            <a class="badge badge-primary"
                                               href="<?php echo e(url('/perhitungan/' . $item->id . '/edit')); ?>">Edit</a>

                                            <form action="<?php echo e(url('/perhitungan' . '/' . $item->id)); ?>" method='post'
    ...
    <script>
        ...
        var columnOrders = [<?php echo e($perhitungan_count - 5); ?>];
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-blt-covid-muhammad-ridho.bikinaplikasi.dev\resources\views/perhitungan/index.blade.php ENDPATH**/ ?>