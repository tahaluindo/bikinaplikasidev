...
<div class="form-group <?php echo e($errors->has('kriteria_detail_id') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        <select name="kriteria_detail_id" class="form-control form-control-line" id="kriteria_detail_id">
            <?php $__currentLoopData = $kriteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKriteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <optgroup label="<?php echo e($itemKriteria->nama); ?>">
                    <?php $__currentLoopData = $itemKriteria->kriteria_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-blt-covid-muhammad-ridho.bikinaplikasi.dev\resources\views/alternatif-detail/form.blade.php ENDPATH**/ ?>