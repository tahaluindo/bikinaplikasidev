                                    ...
                                    <tr data-id='<?php echo e($item->id); ?>'>
                                        ...
                                        <td class="text-center">
                                            <a class="badge badge-primary"
                                               href="<?php echo e(url('/alternatif-detail?alternatif_id=' . $item->id)); ?>">Detail</a>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-blt-covid-muhammad-ridho.bikinaplikasi.dev\resources\views/alternatif/index.blade.php ENDPATH**/ ?>