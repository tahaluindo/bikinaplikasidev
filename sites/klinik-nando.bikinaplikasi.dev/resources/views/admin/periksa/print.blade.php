        ...
        <div class="col mt-3" style="max-width: 375px">
            <div class="media">
                <a class="d-flex mr-2" href="#">
                    <img src="{{ asset('image/logo.png') }}" alt="" width="50">
                </a>
                <div class="media-body">
                    <span class="d-block" style="font-weight: bold">{{ env('APP_NAME') }}</span>
                    <span class="d-block" style="font-size: 12px;"> Jl.Sudirman No.75 Kel.Tambak Sari. Kota
                            Jambi</span>
