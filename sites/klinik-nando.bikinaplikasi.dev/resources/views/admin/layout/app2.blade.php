...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('') }}/ndex.html"><strong><i class="icon fa fa-plane"></i>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="{{Request::is('admin/index') ? 'bg-light' : '' }}"
                       href="{{url('admin/index')}}"><i class="fa fa-dashboard"></i> Dashboard</a>
                </li>

                <li>
                    <a href="{{url('admin/dokter')}}" class="{{ Request::is('admin/dokter*') ? 'bg-light' : ''}}"><i class="fa fa-user-md"></i> Dokter</a>
                </li>

                <li>
                    <a href="{{url('admin/pegawai')}}" class="{{ Request::is('admin/pegawai*') ? 'bg-light' : ''}}"><i class="fa fa-user"></i>Pegawai</a>
                </li>

                <li>
                    <a href="{{url('admin/pasien')}}" class="{{ Request::is('admin/pasien*') ? 'bg-light' : ''}}"><i class="fa fa-users"></i> Pasien</a>
                </li>
                <li>
                    <a href="{{url('admin/pemeriksaan')}}" class="{{ Request::is('admin/pemeriksaan*') ? 'bg-light' : ''}}"><i class="fa fa-stethoscope"></i> Rekam Medic </a>
                </li>
                <li>
                    <a href="{{url('admin/spesialis')}}" class="{{ Request::is('admin/spesialis*') ? 'bg-light' : ''}}"><i class="fa fa-star"></i> Poli </a>
                </li>
            </ul>
