    ...
    <div class="nano">
        <div class="nano-content">
            <ul>
                ...
                <li>
                    <a class="{{Request::is('pegawai/pasien') ? 'active-menu' : '' }}"
                       href="{{url('pegawai/pasien')}}"><i class="fa fa-user"></i> Pasien</a>
                </li>

                <li>
                    <a class="{{Request::is('pegawai/periksa') ? 'active-menu' : '' }}"
                       href="{{url('pegawai/periksa')}}"><i class="fa fa-user"></i> Rekam Medic</a>
                </li>

                <li>
                    <a class="{{Request::is('pegawai/dokter/jadwal') ? 'active-menu' : '' }}"
                       href="{{url('pegawai/dokter/jadwal')}}"><i class="fa fa-user"></i> Jadwal Dokter</a>
                </li>
            </ul>
        </div>
    </div>
