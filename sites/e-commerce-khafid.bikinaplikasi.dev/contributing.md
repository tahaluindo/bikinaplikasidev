...
CodeIgniter is a community driven project and accepts contributions of code and documentation from the community. These contributions are made in the form of Issues or [Pull Requests](//help.github.com/send-pull-requests/) on the [CodeIgniter repository](//github.com/bcit-ci/CodeIgniter>) on GitHub.
...
All code must meet the [Style Guide](//codeigniter.com/user_guide/general/styleguide.html), which is
essentially the [Allman indent style](//en.wikipedia.org/wiki/Indent_style#Allman_style), underscores and readable operators. This makes certain that all code is the same format as the existing code and means it will be as readable as possible.
...
CodeIgniter uses the [Git-Flow](//nvie.com/posts/a-successful-git-branching-model/) branching model which requires all pull requests to be sent to the "develop" branch. This is
...
If you are using [Tower](//www.git-tower.com/) there is a "Sign-Off" checkbox in the commit window. You could even alias git commit to use the `-s` flag so you don’t have to think about it.
...
There are two ways to make changes, the easy way and the hard way. Either way you will need to [create a GitHub account](//github.com/signup/free).
...
9. Send a pull request [//help.github.com/send-pull-requests/](//help.github.com/send-pull-requests/)
