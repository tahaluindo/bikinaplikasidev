...
<//mathiasbynens.be/> and his noSelect plugin.
<//github.com/mathiasbynens/jquery-noselect>, which is embedded.
...
_.checkAgent = function() {
    if (($.agent.msie && !$.agent.opera && !$.agent.chromeframe && (parseInt($.agent.msie) < 9)) ||
        ...
        var html = '<div style="padding:10px">Your browser is not capable to display KCFinder. Please update your browser or install another one: <a href="//www.mozilla.com/firefox/" target="_blank">Mozilla Firefox</a>, <a href="//www.apple.com/safari" target="_blank">Apple Safari</a>, <a href="//www.google.com/chrome" target="_blank">Google Chrome</a>, <a href="//www.opera.com/browser" target="_blank">Opera</a>.';
        if ($.agent.msie && !$.agent.opera)
            html += ' You may also install <a href="//www.google.com/chromeframe" target="_blank">Google Chrome Frame ActiveX plugin</a> to get Internet Explorer 6, 7, 8 working.';
        html += '</div>';
        $('body').html(html);
        return false;
    }
...
_.initToolbar = function() {
    ...
    $('#toolbar a[href="kcact:about"]').click(function() {
        var html = '<div class="box about">' +
            '<div class="head"><a href="//kcfinder.sunhater.com" target="_blank">KCFinder</a> ' + _.version + '</div>';
        if (_.support.check4Update)
            html += '<div id="checkver"><span class="loading"><span>' + _.label("Checking for new version...") + '</span></span></div>';
        html +=
            '<div>' + _.label("Licenses:") + ' <a href="//opensource.org/licenses/GPL-3.0" target="_blank">GPLv3</a> & <a href="//opensource.org/licenses/LGPL-3.0" target="_blank">LGPLv3</a></div>' +
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (_.version < data.version)
                        span.html('<a href="//kcfinder.sunhater.com/download" target="_blank">' + _.label("Download version {version} now!", {version: data.version}) + '</a>');
                    else
