...
class Mylibrary{
	...
	function autolink($str){
	  ...
	  $str = eregi_replace("([[:space:]])(www\.[a-z0-9~#%@\&:=?+\/\.,_-]+[a-z0-9~#%@\&=?+\/_.;-]+)", "\\1<a href=\"//\\2\" target=\"_blank\">\\2</a>", $str); // www.
	  ...
	  $str = eregi_replace("^(www\.[a-z0-9~#%@\&:=?+\/\.,_-]+[a-z0-9~#%@\&=?+\/_.;-]+)", "<a href=\"//\\1\" target=\"_blank\">\\1</a>", $str); // www.
