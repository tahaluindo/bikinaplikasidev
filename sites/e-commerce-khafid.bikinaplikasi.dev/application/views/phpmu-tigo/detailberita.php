	...
	<div class="article-title">
		...
		<div class="author">
			...
			<?php $test = md5(strtolower(trim($rows['email']))); 
				echo "<img src='//www.gravatar.com/avatar/$test.jpg?s=100'/>";
			?>
			</span>
			<div class="a-content">
									...
									if ($rows['youtube']!=''){
										...
										if (preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $rows['youtube'], $match)) {
                                            echo "<iframe width='100%' height='350px' id='ytplayer' type='text/html'
                                                src='//www.youtube.com/embed/".$match[1]."?rel=0&showinfo=1&color=white&iv_load_policy=3'
												...
												<div class='user-avatar'>
													<a href='#' class='hover-effect'>";
														if ($kka['email'] == ''){
															...
															echo "<img class='setborder' src='//www.gravatar.com/avatar/$test.jpg?s=100'/>";
														}
													echo "</a>
												</div>
