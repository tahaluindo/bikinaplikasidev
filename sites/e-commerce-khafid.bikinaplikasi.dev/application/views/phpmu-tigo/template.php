...
<title><?php echo $title; ?></title>
	...
	<?php } ?>
	<script src="//members.phpmu.com/asset/js/bootstrap.min.js"></script>
	...
	<style type="text/css">
		.the-menu a.active{ color:#ccc !important; } .produk:hover{ background-color: #cecece; }
...
<body>
<div id='Back-to-top'>
  <img alt='Scroll to top' src='//members.phpmu.com/asset/css/img/top.png'/>
</div>
		<div class="boxed">	
			<div class="header">
			...
			<div class="content" style='background-image: url(<?php echo base_url("asset/images/background.jpg") ?>); background-size: cover;'>
				<div class="wrapper">	
				<?php 
	...
	<script type="text/javascript">
      ...
      function getWeather(){$.get("//api.openweathermap.org/data/2.5/forecast/daily?q="+settings.location+"&mode=xml&units=metric&cnt="+settings.daycount+"&lang="+settings.lang+"&appid=b318ee3082fcae85097e680e36b9c749", function(data) {
      var $XML = $(data);
      var sstr = "";
