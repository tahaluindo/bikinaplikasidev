	...
	<div class="article-title">
		<div class="share-block right">
			<div>
				...
				<div class="left">
					...
					document.write("<a href='//www.facebook.com/share.php?u=" + document.URL + " ' target='_blank' class='custom-soc icon-text'>&#62220;</a> <a href='//twitter.com/home/?status=" + document.URL + "' target='_blank' class='custom-soc icon-text'>&#62217;</a> <a href='//plus.google.com/share?url=" + document.URL + "' target='_blank' class='custom-soc icon-text'>&#62223;</a>");
					</script>
		...
		<div class="author">
			...
			<?php $gravatar = md5(strtolower(trim($rows['email']))); 
				echo "<img src='//www.gravatar.com/avatar/$gravatar.jpg?s=100'/>";
			?>
			</span>
			<div class="a-content">
				...
				<div class="block-content">
					...
					<?php
						if (preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $rows['youtube'], $match)) {
                            echo "<iframe width='855px' height='500px' src='//www.youtube.com/embed/".$match[1]."' frameborder='0' allowfullscreen></iframe>";
                        } 	
					?>
					</span></p>
												...
												<div class='user-avatar'>
													<a href='#' class='hover-effect'>";
														if ($kka['url'] == ''){
															...
															echo "<img class='setborder' src='//www.gravatar.com/avatar/$gravatar.jpg?s=100'/>";
														}
													echo "</a>
												</div>
