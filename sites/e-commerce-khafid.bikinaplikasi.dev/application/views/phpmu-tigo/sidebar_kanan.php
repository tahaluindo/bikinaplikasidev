...
echo "<div class='widget'>
	...
	foreach ($yahoo->result_array() as $ym) {	
		echo "<center>$ym[nama]<br>
				...
				<img src='//opi.yahoo.com/online?u=$ym[username]&amp;m=g&amp;t=$ym[ym_icon]&amp;l=us'/></a></center><hr>";
	}
echo "</div>";
}
?>
						...
						<div class='comment-photo'>
							<span class='hover-effect'>";
								if ($r['email'] == ''){
									...
									echo "<img style='width:50px; height:50px;' src='//www.gravatar.com/avatar/$avatar.jpg?s=100'/>";
								}
							echo "</span>
						</div>
