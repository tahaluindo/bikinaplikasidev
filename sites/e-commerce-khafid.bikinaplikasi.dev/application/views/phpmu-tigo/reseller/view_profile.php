        ...
        $base_url = base_url();
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td width='170px'><b>Username</b></td> <td><b style='color:red'>$row[username] <a href='{$base_url}asset/foto_user/$row[foto]'><img src='{$base_url}asset/foto_user/$row[foto]' width='200' height='200' style='border-radius: 50% !important; '></a></b></td></tr>
