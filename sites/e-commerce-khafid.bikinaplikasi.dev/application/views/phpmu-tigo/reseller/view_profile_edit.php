           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";                
                  ...
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td><b>Tanggal Lahir</b></td>  <td><input class='required form-control' type='date' name='e' value='$row[tanggal_lahir]'></td></tr>
                          ...
                          <tr><th scope='row'>Provinsi</th>                     <td><select class='form-control' name='ewrwe' id='state' required>
                                                                          ...
                                                                          echo "</select></td></tr>
                          <tr><th scope='row'>Kota</th>                         <td><select class='form-control' name='ga' id='city' required>
                                                                                <option value=''>- Pilih -</option>";
                          ...
                          <tr><td><b>Foto (Kosongkan jika tidak merubah)</b></td>                  <td><input style='width:40%' class='required form-control' type='file' name='foto'></td></tr>
