...
<div class="form-group">
    ...
    <div class="col-md-10">
        <?php       
        $kurir=array('jne' => 'Si exspress','pos' => 'saghara exspress','tiki' => 'antimes exspress');
        foreach($kurir as $key => $rkurir){
            ?>          
                <label class="radio-inline">
                <input type="radio" name="kurir" class="kurir" value="<?php echo $key; ?>"/> <?php echo strtoupper($rkurir); ?>
                </label>
            <?php
        }
        ?>
