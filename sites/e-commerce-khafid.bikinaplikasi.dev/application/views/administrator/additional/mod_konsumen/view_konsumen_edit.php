    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><td><b>Propinsi</b></td>         <td><select class='form-control' name='ewrwe' id='state' required>
                          ...
                          <tr><td><b>Kota</b></td>             <td><select class='form-control' name='ga' id='city' required>
                                                                      <option value=''>- Pilih -</option>";
                                                                      foreach ($kota as $row){
