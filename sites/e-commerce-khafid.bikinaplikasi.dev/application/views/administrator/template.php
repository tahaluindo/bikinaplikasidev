...
<html>
  <head>
    ...
    <style type="text/css">#example thead tr, #table1 thead tr, #example1 thead tr, #example2 thead tr{ background-color: #e3e3e3; } .checkbox-scroll { border:1px solid #ccc; width:100%; height: 114px; padding-left:8px; overflow-y: scroll; }</style>
      <!-- <link rel="stylesheet" href="//almsaeedstudio.com/themes/AdminLTE/plugins/pace/pace.min.css"> -->
...
<!--          </button>-->
<!--          <a href="//members.phpmu.com/" style="margin-right:10px; text-decoration:none;">Apa, Anda masih belum puas dengan versi free? Yuk mari beralih ke versi lebih keren dan lebih lengkap disini : </a>-->
<!--          <a target='_BLANK' class="btn btn-default btn-sm" href="//tajalapak.com/" style="color:red;">Marketplace PRO</a>-->
<!--        </div>-->
      <?php } ?>
    ...
    <!-- <script src="//almsaeedstudio.com/themes/AdminLTE/plugins/pace/pace.min.js"></script> -->
    <!-- DataTables -->
