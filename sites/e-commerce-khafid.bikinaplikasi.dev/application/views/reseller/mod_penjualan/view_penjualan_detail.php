...
$detail = $this->db->query("SELECT * FROM rb_penjualan where id_penjualan='".$this->uri->segment(3)."'")->row_array();
                      ...
                      $detail['service'] = preg_replace('/POS|JNE/i', '', $detail['service']);
                      if(preg_match('/jne/i', $detail['kurir'])) {

                        $kurir = 'SI EXSPRESS';
                      }

                      if(preg_match('/pos/i', $detail['kurir'])) {

                        $kurir = 'SAGHARA EXSPRESS';
                      }

                      if(preg_match('/tiki/i', $detail['kurir'])) {
            ...
            <div class="col-xs-12">  
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <tbody>
                    <tr><th width='140px' scope='row'>Kode Pembelian</th>  <td><?php echo "$rows[kode_transaksi] $bukti_transaksi->nama_pengirim"; ?></td></tr>
                    ...
                    <tr><th scope='row'>Kurir</th>               <td><?php echo "<span style='text-transform:uppercase'>$kurir</span> - $detail[service]"; ?></td></tr>
                    ...
                    <tr>
                    <th width='140px' scope='row'>Bukti Transfer</th>
                    <td>
                      <a href="<?= base_url("asset/files/$bukti_konfirmasi->bukti_transfer"); ?>">
                        <img src='<?= base_url("asset/files/$bukti_konfirmasi->bukti_transfer"); ?>' height=200>
                      </a>
                    </td>
                    </tr>
                  </tbody>
