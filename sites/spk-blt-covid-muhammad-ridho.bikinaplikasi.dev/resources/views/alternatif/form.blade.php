...
<div class="form-group {{ $errors->has('no_identitas') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="no_identitas"
            ...
            type="text" id="no_identitas" value="{{ isset($alternatif->no_identitas) ? $alternatif->no_identitas : old('no_identitas')}}"
            required>
...
<div class="form-group {{ $errors->has('no_hp') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="no_hp" class="form-control form-control-line @error('no_hp') is-invalid @enderror"
            ...
            value="{{ isset($alternatif->no_hp) ? $alternatif->no_hp : old('no_hp')}}" required>
