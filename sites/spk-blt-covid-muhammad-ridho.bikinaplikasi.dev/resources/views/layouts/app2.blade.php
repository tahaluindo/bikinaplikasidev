                ...
                <ul class="metismenu" id="menu1" style="padding-bottom: 20px !important;">
                    ...
                    <li class="active">
                        ...
                        <ul class="submenu-angle" aria-expanded="true">
                            ...
                            {{--                            @if(in_array(auth()->user()->level, ['Admin']))--}}
                            {{--                                <li>--}}
                            {{--                                    <a href="{{ route('kriteria-detail.index') }}"--}}
                            {{--                                       class="">--}}

                            {{--                                        <span class="mini-sub-pro">Kriteria Detail</span>--}}
                            {{--                                    </a>--}}
                            {{--                                </li>--}}
                            {{--                            @endif--}}
                            ...
                            {{--                            @if(in_array(auth()->user()->level, ['Admin']))--}}
                            {{--                                <li>--}}
                            {{--                                    <a href="{{ route('perhitungan-detail.index') }}"--}}
                            {{--                                       class="">--}}

                            {{--                                        <span class="mini-sub-pro">Perhitungan Detail</span>--}}
                            {{--                                    </a>--}}
                            {{--                                </li>--}}
                            {{--                            @endif--}}
                            ...
                            {{--                                        <span class="mini-sub-pro">Alternatif Detail</span>--}}
                            {{--                                    </a>--}}
                            {{--                                </li>--}}
                            {{--                            @endif--}}
                    ...
                    {{--                                class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Laporan</span></a>--}}
                    {{--                        <ul class="submenu-angle" aria-expanded="false">--}}

                    {{--                            @if(in_array(auth()->user()->level, ['Admin']))--}}
                    {{--                                <li>--}}
                    {{--                                    <a href="{{ route('alternatif.laporan.index') }}"--}}
                    {{--                                       class="">--}}
                    ...
                    {{--                            @if(in_array(auth()->user()->level, ['Admin']))--}}
                    {{--                                <li>--}}
                    {{--                                    <a href="{{ route('kriteria.laporan.index') }}"--}}
                    {{--                                       class="">--}}
                    ...
                    {{--                            @if(in_array(auth()->user()->level, ['Admin']))--}}
                    {{--                                <li>--}}
                    {{--                                    <a href="{{ route('perhitungan.laporan.index') }}"--}}
                    {{--                                       class="">--}}
                        ...
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                <ul class="mobile-menu-nav">
                                    <li><a data-toggle="collapse" data-target="#Charts" href="{{ url('') }}/#">Home
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/index.html">Dashboard v.1</a></li>
                                            <li><a href="{{ url('') }}/index-1.html">Dashboard v.2</a></li>
                                            <li><a href="{{ url('') }}/index-3.html">Dashboard v.3</a></li>
                                            <li><a href="{{ url('') }}/analytics.html">Analytics</a></li>
                                            <li><a href="{{ url('') }}/widgets.html">Widgets</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="{{ url('') }}/events.html">Event</a></li>
                                    <li><a data-toggle="collapse" data-target="#demoevent" href="{{ url('') }}/#">Professors
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demoevent" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/all-professors.html">All Professors</a>
                                            </li>
                                            <li><a href="{{ url('') }}/add-professor.html">Add Professor</a>
                                            </li>
                                            <li><a href="{{ url('') }}/edit-professor.html">Edit Professor</a>
                                            </li>
                                            <li><a href="{{ url('') }}/professor-profile.html">Professor Profile</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#demopro" href="{{ url('') }}/#">Students
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demopro" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/all-students.html">All Students</a>
                                            </li>
                                            <li><a href="{{ url('') }}/add-student.html">Add Student</a>
                                            </li>
                                            <li><a href="{{ url('') }}/edit-student.html">Edit Student</a>
                                            </li>
                                            <li><a href="{{ url('') }}/student-profile.html">Student Profile</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#democrou" href="{{ url('') }}/#">Courses
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="democrou" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/all-courses.html">All Courses</a>
                                            </li>
                                            <li><a href="{{ url('') }}/add-course.html">Add Course</a>
                                            </li>
                                            <li><a href="{{ url('') }}/edit-course.html">Edit Course</a>
                                            </li>
                                            <li><a href="{{ url('') }}/course-profile.html">Courses Info</a>
                                            </li>
                                            <li><a href="{{ url('') }}/course-payment.html">Courses Payment</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#demolibra" href="{{ url('') }}/#">Library
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demolibra" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/library-assets.html">Library Assets</a>
                                            </li>
                                            <li><a href="{{ url('') }}/add-library-assets.html">Add Library Asset</a>
                                            </li>
                                            <li><a href="{{ url('') }}/edit-library-assets.html">Edit Library Asset</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#demodepart" href="{{ url('') }}/#">Departments
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demodepart" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/departments.html">Departments List</a>
                                            </li>
                                            <li><a href="{{ url('') }}/add-department.html">Add Departments</a>
                                            </li>
                                            <li><a href="{{ url('') }}/edit-department.html">Edit Departments</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#demo" href="{{ url('') }}/#">Mailbox
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="demo" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/mailbox.html">Inbox</a>
                                            </li>
                                            <li><a href="{{ url('') }}/mailbox-view.html">View Mail</a>
                                            </li>
                                            <li><a href="{{ url('') }}/mailbox-compose.html">Compose Mail</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a data-toggle="collapse" data-target="#Miscellaneousmob"
                                           href="{{ url('') }}/#">Interface <span
                                    ...
                                    <li><a data-toggle="collapse" data-target="#Chartsmob" href="{{ url('') }}/#">Charts
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#Tablesmob" href="{{ url('') }}/#">Tables
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#formsmob" href="{{ url('') }}/#">Forms
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="formsmob" class="collapse dropdown-header-top">
                                            <li><a href="{{ url('') }}/basic-form-element.html">Basic Form Elements</a>
                                            </li>
                                            <li><a href="{{ url('') }}/advance-form-element.html">Advanced Form
                                                    Elements</a>
                                            </li>
                                    ...
                                    <li><a data-toggle="collapse" data-target="#Appviewsmob" href="{{ url('') }}/#">App
                                    ...
                                    <li><a data-toggle="collapse" data-target="#Pagemob" href="{{ url('') }}/#">Pages
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        <ul id="Pagemob" class="collapse dropdown-header-top">
                                            ...
                                            <li><a href="{{ url('') }}/lock.html">Lock</a>
                                            </li>
                                            <li><a href="{{ url('') }}/password-recovery.html">Password Recovery</a>
                                            </li>
                                            <li><a href="{{ url('') }}/404.html">404 Page</a></li>
                                            <li><a href="{{ url('') }}/500.html">500 Page</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
