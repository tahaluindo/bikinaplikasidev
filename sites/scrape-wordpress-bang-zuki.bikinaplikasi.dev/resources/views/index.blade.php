                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                <h2>Roti super enak tiada duanya!</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6" id="tentang">
                    <div class="about__text">
                        <div class="section-title">
                            <span>Tentang Toko Roti Mila</span>
                            <h2>Roti enak yang tak terlupakan!</h2>
                        </div>
                        <p>Menjual Aneka Roti dan Bolu : Roti Kering, Roti Basah, dan Snack. Area terjangkau bisa
                            Delivery
                            Order!</p>
                    </div>
                </div>
    ...
    <section class="product spad">
        <div class="container">
            <div class="row" id="list-roti">
                ...
                @empty
                    <strong>Barang Belum Ada</strong>
                @endforelse
                ...
                <div class="testimonial__slider owl-carousel">
                    <div class="col-lg-6">
                        <div class="testimonial__item">
                            ...
                            <p>"Wah rotinya enak banget yah, rasanya nagih pengen beli lagi. Jadi betah langganan ni di
                                sini.."</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="testimonial__item">
                            ...
                            <p>"Sekali? mana cukupp, enak banget loh rotinyaa. Jadi pengen order terus nih"</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="testimonial__item">
                            ...
                            <p>"Pas gigitan terakhir yang menyedihkan, yah ternyata rotinya udah habiss, enaknya gak
                                nanggung sih"</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="testimonial__item">
                            ...
                            <p>"Jangan coba coba ya! nanti kalian gak bakalan berhenti mencoba roti seenak ini,
                                hehe.."</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-lg-4 p-0">
                    <div class="instagram__text">
                        <div class="section-title">
                            ...
                            <h2>Kue manis dalam genggaman anda.</h2>
                        </div>
                        <h5><i class="fa fa-instagram"></i> @rotimila</h5>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="row">
