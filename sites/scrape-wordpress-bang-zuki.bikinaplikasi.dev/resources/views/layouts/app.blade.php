...
<!-- Mirrored from seantheme.com/asp-studio/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Dec 2020 03:56:28 GMT -->
<head>
    <meta charset="utf-8"/>
    ...
    <div id="header" class="app-header">
        ...
        <div class="brand">
            ...
            <a href="index.html" class="brand-logo">
                <h4 style="margin-top: 4px;">{{ auth()->user()->level }}</h4>
            </a>
        </div>
        ...
        <div class="menu">
            ...
            <div class="menu-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-notification">
                    ...
                    @forelse($notifs as $item)
                        <a href="#" class="dropdown-notification-item">
                            ...
                            <div class="dropdown-notification-info">
                                <div class="title">{{ $item->alamat_pengiriman }}</div>
                    ...
                    @empty
                        <strong style="padding-left: 20px; display: inline-block;">Belum Ada Notifikasi</strong>
                    @endforelse
                </div>
            </div>
            <div class="menu-item dropdown">
                <a href="#" data-toggle="dropdown" data-display="static" class="menu-link">
                    <div class="menu-img online">
                        <img src="{{ url('') }}/assets/img/user/user.jpg" alt="" class="mw-100 mh-100 rounded-circle"/>
                    </div>
                    <div class="menu-text">
                        {{ auth()->user()->email }}
                    </div>
                ...
                <div class="dropdown-menu dropdown-menu-right mr-lg-3">
                    ...
                    <a class="dropdown-item d-flex align-items-center"
                       href="{{ route('user.profile', auth()->user()->id) }}">Setting <i
        ...
        <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
            <div class="menu">
                ...
                <div class="menu-item has-sub expand">
                    ...
                    <div class="menu-submenu" style="display: block;">
                        <div class="menu-item">
                            <a href="{{ route('pelanggan.laporan.index') }}" class="menu-link">
                                <span class="menu-text">Pelanggan</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a href="{{ route('pemasok.laporan.index') }}" class="menu-link">
                                <span class="menu-text">Pemasok</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a href="{{ route('pembelian.laporan.index') }}" class="menu-link">
                                <span class="menu-text">Pembelian</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a href="{{ route('penjualan.laporan.index') }}" class="menu-link">
                                <span class="menu-text">Penjualan</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a href="{{ route('barang.laporan.index') }}" class="menu-link">
                                <span class="menu-text">Barang</span>
                            </a>
                        </div>
                    </div>
...
@if(request()->segment(1) == "dashboard")
    ...
    <script src="{{ url('') }}/assets/js/app.min.js" type="1d8490ea9cbf3e79fa30d3fc-text/javascript"></script>


    <script src="{{ url('') }}/assets/plugins/apexcharts/dist/apexcharts.min.js"
            type="1d8490ea9cbf3e79fa30d3fc-text/javascript"></script>
    <script src="{{ url('') }}/assets/js/demo/dashboard.demo.js"
            type="1d8490ea9cbf3e79fa30d3fc-text/javascript"></script>

    <script src="{{ url('') }}/ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
            data-cf-settings="1d8490ea9cbf3e79fa30d3fc-|49" defer=""></script>
@endif
