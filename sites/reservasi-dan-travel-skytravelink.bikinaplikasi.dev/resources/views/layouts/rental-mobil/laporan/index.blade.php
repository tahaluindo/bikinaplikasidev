<div class='row'>
    <div class='col-md-12'>
        <form class="form-horizontal form-material" action="{{ url(route('rental-mobil.print')) }}" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-line" name='field' required>
                        @foreach(['id', 'dari_tanggal','sampai_tanggal','biaya_supir','total_bayar','diskon'] as $field)
