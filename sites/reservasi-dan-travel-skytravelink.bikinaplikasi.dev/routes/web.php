...
Route::middleware('auth')->group(function () {
    Route::get('/home', function () {
        ...
        $data['backgroundColor1'] = ["#7d3865", "#c1a7b0", "#f8b703", "#949217", "#0fa2a9", "#3B76EF", "#00B382", "#79A9F7", "#FF7B36", "#E8205E",];
        $data['backgroundColor2'] = ["#3B76EF", "#00B382", "#79A9F7", "#FF7B36", "#E8205E", "#7d3865", "#c1a7b0", "#f8b703", "#949217", "#0fa2a9"];
