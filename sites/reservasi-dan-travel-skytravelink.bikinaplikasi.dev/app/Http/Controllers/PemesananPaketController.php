...
class PemesananPaketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pemesanan-paket.index')->with('success', 'Berhasil menambah reservasi tiket');
    }
    ...
    public function update(Request $request, PemesananPaket $pemesananPaket)
    {
        ...
        return redirect()->route('pemesanan-paket.index')->with('success', 'Berhasil mengubah reservasi tiket');
    }
