<div class="form-group <?php echo e($errors->has('user_id') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <input list="user_id" class="form-control form-control-line" name="user_id" value="<?php echo e(isset($reservasi_tiket->user_id) ? $reservasi_tiket->user_id : old('user_id')); ?>">
    ...
    <div class="col-md-12">
        ...
        <datalist id="tiket_id">
            <?php $__currentLoopData = $tikets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tiket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option
                    value="<?php echo e($tiket->id); ?>" <?php echo e((isset($reservasi_tiket->tiket_id) && $reservasi_tiket->tiket_id == $tiket->id) || old('tiket_id') == $tiket->id ? 'selected' : ''); ?>><?php echo e($tiket->nama); ?> - <?php echo e(toIdr($tiket->rute->biaya)); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </datalist>
    ...
    <div class="col-md-12">
        ...
        <select name="status" class="form-control form-control-line status" id="status" required>
            <?php $__currentLoopData = ['Baru','Dikonfirmasi','Dibatalkan','Refund']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option
                    value="<?php echo e($status); ?>" <?php echo e((isset($reservasi_tiket->status) && $reservasi_tiket->status == $status) || old('status') == $status  ? 'selected' : ''); ?>><?php echo e($status); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-skytravelink.bikinaplikasi.dev\resources\views/reservasi-tiket/form.blade.php ENDPATH**/ ?>