...
<section id="pack" class="packages">
    <div class="container">
        ...
        <div class="packages-content">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="single-package-item">
                            ...
                            <div class="single-package-item-txt">
                                <h3><?php echo e($tiket->mobil->nama); ?> <span class="pull-right"><?php echo e(toIdr($tiket->rute->biaya)); ?></span></h3>
            ...
            <form method="post" action="<?php echo e(url("pembayaran-tiket/$tiket->id")); ?>" id="form-pembayaran-tiket" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(isset($user->name) ? $user->name : old('name')); ?>" required disabled>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-zaky.bikinaplikasi.dev\resources\views/pembayaran-tiket.blade.php ENDPATH**/ ?>