                ...
                <div class="overview-item overview-item--c1">
                    <div class="overview__inner">
                        <div class="overview-box clearfix">
                            <div class="icon">
                                <img src="{{ url('image/peminjaman.png') }}" width="60"/>
                            </div>
                            <div class="text">
                                <h2>{{ $peminjamans->count() }}</h2>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="overview-item overview-item--c2">
                    <div class="overview__inner">
                        <div class="overview-box clearfix">
                            <div class="icon">
                                <img src="{{ url('image/pengembalian.png') }}" width="60"/>
                            </div>
                            <div class="text">
                                <h2>{{ $pengembalians->count() }}</h2>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="overview-item overview-item--c3">
                    <div class="overview__inner">
                        <div class="overview-box clearfix">
                            <div class="icon">
                                 <img src="{{ url('image/user.png') }}" width="60"/>
                            </div>
                            <div class="text">
                                <h2>{{ $users->count() }}</h2>
                                <span>User</span>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="overview-item overview-item--c4">
                    <div class="overview__inner">
                        <div class="overview-box clearfix">
                            <div class="icon">
                                 <img src="{{ url('image/member.png') }}" width="60"/>
                            </div>
                            <div class="text">
                                <h2>{{ $anggotas->count() }}</h2>
                                <span>Anggota</span>
                            </div>
                        </div>
                        <div class="overview-chart">
                    ...
                    <div class="au-card-inner">
                        <div class="table-responsive">
                            <table class="table table-top-countries">
                                ...
                                @foreach($terbanyak_dpinjam as $item)
                                    <tr>
                                        <td>{{ $item->judul }}</td>
