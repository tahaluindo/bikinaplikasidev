                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="110x30000"
                                       ...
                                       value='{{ old('tonase_panen') }}' name='tonase_panen'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="Bpjs"
                                    class="form-control form-control-line" value='{{ old('bpjs') == "" ? 0 : old('bpjs') }}'
                                    name='bpjs' min="0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="Bonus"
                                    class="form-control form-control-line" value='{{ old('bonus') == "" ? 0 : old('bonus') }}'
                                    name='bonus'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Hutang"
                                    class="form-control form-control-line" value='{{ old('hutang') == "" ? 0 : old('hutang') }}'
                                    name='hutang'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="25-02-1980"
                                    class="form-control form-control-line flatpickr" value='{{ old('tanggal') == "" ? date("Y-M-d") : old('tanggal') }}'
                                    name='tanggal'>
