                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='karyawan_id'>
                                    ...
                                    <option value="{{ $karyawan->id }}" @if(old('karyawan_id')==$karyawan->id || $cuti->karyawan_id == $karyawan->id) selected
                                        @endif>{{ $karyawan->nama }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="100000"
                                    ...
                                    value='{{ old('potongan') }}' name='potongan' value="{{ $cuti->potongan ? $cuti->potongan : old('potongan') }}">
