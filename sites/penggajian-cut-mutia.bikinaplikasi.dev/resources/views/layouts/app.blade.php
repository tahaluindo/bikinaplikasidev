...
<body>
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><span>{{ env('APP_NAME') }}</span> {{ env('OBJECT_NAME') }}</a>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar collapse in" aria-expanded="true" style="">
        ...
        <ul class="nav menu">
            ...
            @if(in_array(auth()->user()->email, ['admin@gmail.com', 'personalia@gmail.com']))
            ...
            @if(in_array(auth()->user()->email, ['admin@gmail.com', 'personalia@gmail.com']))
            <li @if(Request::segment(1) == 'karyawan' && Request::segment(2) != 'laporan') class="active" @endif><a href="{{ route('karyawan.index') }}"><em class="fa fa-table">&nbsp;</em> Karyawan</a></li>
            @endif
            ...
            @if(in_array(auth()->user()->email, ['admin@gmail.com', 'pemimpin@gmail.com']))
            <li @if(Request::segment(1) == 'rancangan-upah-harian' && Request::segment(2) != 'laporan') class="active" @endif><a href="{{ route('rancangan-upah-harian.index') }}"><em class="fa fa-table">&nbsp;</em> Upah Harian</a></li>
            @endif
            ...
            @if(in_array(auth()->user()->email, ['admin@gmail.com', 'pemimpin@gmail.com']) || preg_match('/guru/', auth()->user()->email))
            <li class="parent ">
                ...
                <ul class="children @if(Request::segment(2) == 'laporan') collapsed @else collapse @endif" id="sub-item-1" aria-expanded="false" style="height: 0px;">
                    ...
                    @if(in_array(auth()->user()->email, ['admin@gmail.com', 'pemimpin@gmail.com']))
                    <li><a @if(request()->path() == 'rancangan-upah-harian/laporan') class="active" @endif href="{{ route('rancangan-upah-harian.laporan') }}"><em class="fa fa-table">&nbsp;</em> Upah Harian</a></li>
                    @endif
