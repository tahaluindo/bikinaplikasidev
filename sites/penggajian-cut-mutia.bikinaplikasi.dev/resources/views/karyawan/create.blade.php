        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('karyawan.store')) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='lokasi'>
                                    ...
                                    <option value="{{ $lokasi }}" @if(old('lokasi')==$lokasi)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="1571070901980002"
                                    class="form-control form-control-line" value='{{ old('nik') }}'
                                    name='nik'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Tempat / Tanggal Lahir"
                                    ...
                                    value='{{ old('tempat_tanggal_lahir') }}' name='tempat_tanggal_lahir'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='pendidikan'>
                                    ...
                                    <option value="{{ $pendidikan }}" @if(old('pendidikan')==$pendidikan)
                                        selected @endif>{{ $pendidikan }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" min="0" max="4" placeholder="Tanggungan"
                                    ...
                                    value='{{ old('tanggungan') }}' name='tanggungan'>
