        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('rancangan-upah-harian.update', $rancangan_upah_harian->id)) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='jenis_pekerjaan'>
                                    ...
                                    <option value="{{ $jenis_pekerjaan }}" @if(old('jenis_pekerjaan')==$jenis_pekerjaan || $rancangan_upah_harian->jenis_pekerjaan == $jenis_pekerjaan) selected
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='blok'>
                                    ...
                                    <option value="{{ $blok }}" @if(old('blok')==$blok  || $rancangan_upah_harian->blok == $blok) selected
                                        @endif>{{ $blok }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='satuan'>
                                    ...
                                    <option value="{{ $satuan }}" @if(old('satuan')==$satuan || $rancangan_upah_harian->satuan == $satuan) selected
                                        @endif>{{ $satuan }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="2500"
                                    class="form-control form-control-line" value='{{ old('harga_satuan') == "" ? $rancangan_upah_harian->harga_satuan : old('harga_satuan') }}'
                                    name='harga_satuan'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="6"
                                    class="form-control form-control-line" value='{{ old('jam_kerja') == "" ? $rancangan_upah_harian->jam_kerja : old('jam_kerja') }}'
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="date" placeholder="25-02-1980"
                                    class="form-control form-control-line flatpickr" value='{{ old('periode') == "" ? $rancangan_upah_harian->periode : old('periode') }}'
                                    name='periode'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Catatan"
                                    class="form-control form-control-line" value='{{ old('catatan') == "" ? $rancangan_upah_harian->catatan : old('catatan') }}'
                                    name='catatan'>
