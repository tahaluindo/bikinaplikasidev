        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('rancangan-upah-harian.print')) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='periode'>
                                    ...
                                    <option value="{{ $key }}" @if(old('periode')==$periode)
                                        selected @endif>{{ ucwords($periode) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control form-control-line" name='field'  required>
                                    @foreach(['id', 'gaji', 'bpjs', 'bonus', 'periode', 'tahun', 'tanggal', 'catatan'] as $field)
