...
//         new PerfectScrollbar(".prelayout-color", {
//             wheelSpeed: .5,
//             swipeEasing: 0,
//             suppressScrollX: !0,
//             wheelPropagation: 1,
...
//         var a = $(this).attr("data-value");
//         $(".navbar-color > a").removeClass("active"), $(".pcoded-navbar").removeClassPrefix("menu-"), $(".pcoded-navbar").addClass("brand-dark"), $(this).addClass("active"), "navbar-default" == a ? ($(".pcoded-navbar").removeClassPrefix("navbar-"), $(".pcoded-navbar").removeClassPrefix("brand-dark")) : ($(".pcoded-navbar").removeClassPrefix("navbar-"), $(".pcoded-navbar").addClass(a))
//     }), $(".navbar-gradient-color > a").on("click", function () {
//         var a = $(this).attr("data-value");
//         $(".navbar-gradient-color > a").removeClass("active"), $(".pcoded-navbar").removeClassPrefix("menu-"), $(".pcoded-navbar").addClass("brand-dark"), $(this).addClass("active"), "navbar-default" == a ? ($(".pcoded-navbar").removeClassPrefix("navbar-"), $(".pcoded-navbar").removeClassPrefix("brand-dark")) : ($(".pcoded-navbar").removeClassPrefix("navbar-"), $(".pcoded-navbar").addClass(a))
...
//         $(this).is(":checked") ? ($(".pcoded-navbar").addClass("menupos-fixed"), setTimeout(function () {
//         }, 400)) : $(".pcoded-navbar").removeClass("menupos-fixed")
//     }), $("#header-fixed").change(function () {
//         $(this).is(":checked") ? $(".pcoded-header").addClass("headerpos-fixed") : $(".pcoded-header").removeClass("headerpos-fixed")
...
//         $(this).is(":checked") ? $(".pcoded-navbar").addClass("header-hide") : $(".pcoded-navbar").removeClass("header-hide")
...
//         var a = $(this).attr("data-value");
//         $(".pcoded-navbar").removeClassPrefix("menu-"), $(".pcoded-navbar").removeClassPrefix("brand-"), $(".navbar-pattern > a").removeClass("active"), $(this).addClass("active"), $(".pcoded-navbar").removeClassPrefix("navbar-pattern-"), $(".pcoded-navbar").removeClassPrefix("navbar-image-"), $(".pcoded-navbar").addClass(a)
...
//         var a = $(this).attr("data-value");
//         $(".brand-color > a").removeClass("active"), $(this).addClass("active"), "brand-default" == a ? $(".pcoded-navbar").removeClassPrefix("brand-") : ($(".pcoded-navbar").removeClassPrefix("brand-"), $(".pcoded-navbar").addClass(a))
