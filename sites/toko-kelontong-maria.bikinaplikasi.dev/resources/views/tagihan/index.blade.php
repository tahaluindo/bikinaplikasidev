                                                            ...
                                                            <td class="text-center">
                                                                @if($item->tagihans->sum('total'))
                                                                    <a class="label label-success"
                                                                       onclick="return confirm('Yakin akan melunaskan semua tagihan?');"
                                                                       href="{{ url('/tagihan/' . $item->id . '/lunaskan-semua') }}">Lunaskan
                                                                        Semua</a>
                                                                @endif

                                                                <a class="label label-secondary"
                                                                   href="{{ url('/tagihan/' . $item->id . '/tambah') }}">Detail
                                                                    Tagihan
                                                                    ({{ isset($item->tagihans) ? $item->tagihans->count() : 0 }}
                                                                    )</a>
                                        ...
                                        <div class="card-body px-3 py-3">
                                            ...
                                            <form class="form-horizontal form-material"
                                                ...
                                                <div class="form-group {{ $errors->has('nama') ? 'has-error' : ''}}">
                                                    <label for="nama"
                                                           class="control-label">{{ ucwords('Nama') }}</label>
                                                ...
                                                <div
                                                    class="form-group {{ $errors->has('keterangan') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group">
                                                    <button class="btn btn-success" type="submit" name="button"
                                                            value="buat-tagihan">Buat Tagihan
                                                    </button>
