...
<body>
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><span>APLIKASI KEPEGAWAIAN </span> KEMENTERIAN AGAMA Batang Hari</a>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar collapse in" aria-expanded="true" style="">
        ...
        <ul class="nav menu">
            ...
            @if(in_array(auth()->user()->email, ['admin@gmail.com', 'staf@gmail.com', 'kepala@gmail.com']))
            <li @if(Request::segment(1) == 'tugas' && Request::segment(2) != 'laporan') class="active" @endif><a href="{{ route('tugas.index') }}"><em class="fa fa-table">&nbsp;</em> Tugas</a></li>
            @endif
            ...
            @if(in_array(auth()->user()->email, ['admin@gmail.com', 'staf@gmail.com', 'kepala@gmail.com']) || preg_match('/guru/', auth()->user()->email))
            <li class="parent ">
                ...
                <ul class="children @if(Request::segment(2) == 'laporan') collapsed @else collapse @endif" id="sub-item-1" aria-expanded="false" style="height: 0px;">
                    ...
                    @if(in_array(auth()->user()->email, ['admin@gmail.com', 'staf@gmail.com', 'kepala@gmail.com']))
                    <li><a @if(request()->path() == 'tugas/laporan') class="active" @endif href="{{ route('tugas.laporan') }}"><em class="fa fa-table">&nbsp;</em> Tugas</a></li>
                    @endif
