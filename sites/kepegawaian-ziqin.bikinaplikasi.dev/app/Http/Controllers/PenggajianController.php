...
class PenggajianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $requestData['gaji'] = Pegawai::findOrFail($request->pegawai_id)->riwayat_jabatan->gaji_jabatan;
    ...
    {
        $this->validate($request, [
            'field' => 'required|in:id,gaji,tunjangan,potongan,periode,tahun,tanggal,catatan',
