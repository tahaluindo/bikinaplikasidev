...
Route::get('user/hapus_semua', [userController::class, 'hapus_semua'])->name('user.hapus_semua');
    ...
    Route::post('tugas/laporan/print', [TugasController::class, 'print'])->name('tugas.print');
    Route::get('tugas/hapus_semua', [TugasController::class, 'hapus_semua'])->name('tugas.hapus_semua');
