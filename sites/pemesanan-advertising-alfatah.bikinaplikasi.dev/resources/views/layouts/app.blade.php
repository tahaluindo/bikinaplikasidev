...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation"
         style="margin-bottom: 0; background-color: #243A73;">
        ...
        <div style="display: inline-block; color: white; margin-left: 37px;">
            <h2>{{ env('APP_OBJECT_NAME') }} - {{ env('APP_OBJECT_DESCRIPTION') }}</h2>
        </div>
...
<script>
    $(document).ready(function () {
        function getTotalProduk() {
            $.ajax({
                ...
                success: (response) => {
                    ...
                    $('#total').val(responseJson.harga_jual * $('#jumlah').val())
                }
            })
        }
        ...
        function getTotalBahan() {
            $.ajax({
                ...
                success: (response) => {
                    ...
                    $('#total').val(responseJson.harga_beli * $('#jumlah').val())
                }
            })
        }
        ...
        $('#harga, #jumlah').keyup(function () {
            let harga = parseInt($('#harga_beli').val()) ? parseInt($('#harga_beli').val()) : 0;
            let jumlah = parseInt($('#jumlah').val());
            let total = harga * jumlah;
