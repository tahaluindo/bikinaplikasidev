            ...
            if (localImage || (!delayBool && !video.paused)) {
                ...
                setTimeout(function() {
                    if (options.codeRepetition || lastCode != a) {
						...
						/*  $.ajax({ url: 'proses_simpan.php', 
							type: 'POST', 
							dataType: 'json', 
							data: {'id_kategori_barang': a,'foto':lastImageSrc}, success: function (proses) 
							{
								alert ("asd");
							} }); 
					 */
						 ...
						 $.post("proses_simpan.php",
							{
								id_kategori_barang: a,
								foto: lastImageSrc,
							...
							{
								alert("Mendeteksi Kategori Barang Tidak Dikenal");
							}
