...
class TeganganWindTurbine extends BaseController
{
	...
	{
		return view('tegangan-wind-turbine/index');
	}
	...
	public function chart()
    {
        ...
        foreach ($sensor as $key => $item) {
            ...
            $datasetsData[] = $item->tegangan_wind_turbine;
        }
        ...
        $json = [
            ...
            "labels" => $labels,
            "datasets" => $datasets,
            "tegangan_wind_turbine" => $sensor[count($sensor) - 1]->tegangan_wind_turbine
        ];
