...
class DayaWindTurbine extends BaseController
{
	...
	{
		return view('daya-wind-turbine/index');
	}
	...
	public function chart()
    {
        ...
        foreach ($sensor as $key => $item) {
            ...
            $datasetsData[] = $item->daya_wind_turbine;
        }
        ...
        $json = [
            ...
            "labels" => $labels,
            "datasets" => $datasets,
            "daya_wind_turbine" => $sensor[count($sensor) - 1]->daya_wind_turbine
        ];
