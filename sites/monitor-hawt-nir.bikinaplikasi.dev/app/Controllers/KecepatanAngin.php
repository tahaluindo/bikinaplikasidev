...
class KecepatAnangin extends BaseController
{
	...
	{
		return view('kecepatan-angin/index');
	}
    ...
    public function chart()
    {
        ...
        foreach ($sensor as $key => $item) {
            ...
            $datasetsData[] = $item->kecepatan_angin;
        }
        ...
        $json = [
            ...
            "labels" => $labels,
            "datasets" => $datasets,
            "kecepatan_angin" => $sensor[count($sensor) - 1]->kecepatan_angin
        ];
