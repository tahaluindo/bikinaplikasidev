...
class ArusWindTurbine extends BaseController
{
	...
	{
		return view('arus-wind-turbine/index');
	}
	...
	public function chart()
    {
        ...
        foreach ($sensor as $key => $item) {
            ...
            $datasetsData[] = $item->arus_wind_turbine;
        }
        ...
        $json = [
            ...
            "labels" => $labels,
            "datasets" => $datasets,
            "arus_wind_turbine" => $sensor[count($sensor) - 1]->arus_wind_turbine
        ];
