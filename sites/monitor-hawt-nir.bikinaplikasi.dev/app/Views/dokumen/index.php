            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="dokumen/create" class="btn btn-primary btn-sm float-left">
                                    Tambah
                                </a>
                                <a href="dokumen/scan" class="ml-2 btn btn-success btn-sm float-left">
                                    Scan
                                </a>
                            </div>
                                    ...
                                    <select name="berdasarkan" style="padding: 3px !important;" required>
                                        ...
                                        <?php
                                            foreach ($columns as $key => $value) {
                                                if(!in_array($value->Field, ['user_id']) && user_id() != 1) {
