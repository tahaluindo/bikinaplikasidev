...
<div id="page-wrapper">
    <div class="header">
        <h1 class="page-header">Daya Wind Turbine
        </h1>
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li><a href="#">Daya Wind Turbine</a></li>
...
<?= $this->section('chart') ?>
<script type="application/javascript" src="<?= base_url() ?>/assets/js/demo/chart-daya-wind-turbine.php"></script>
<?= $this->endSection() ?>