...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2"><span class="fa fa-plus-square fa-fw"></span> Perhitungan Fisik</h1>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-3">
                <form method="POST" action="{{route('soStore')}}" autocomplete="off">
                <input type="hidden" name="supplier_id" class="form-control" value="1" maxlength="20" required>
