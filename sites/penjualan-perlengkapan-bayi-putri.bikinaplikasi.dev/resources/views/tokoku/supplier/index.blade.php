...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2"><span class="fa fa-map-marker-alt fa-fw"></span> List Supplier</h1>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 mb-4">
                <a href="{{route('whCreate')}}" class="btn btn-primary">Buat Baru</a>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Grup">
                                @if(auth()->user()->role == "U")
                                <a href="{{route('whEdit',[$item->id])}}" type="button" class="btn btn-info btn-sm">Ubah</a>
...
<div class="modal fade" id="deleteConfirm" role="dialog">
    <div class="modal-dialog modal-sm">
        <!-- Modal content-->
        <form method="POST" action="{{route('whDelete')}}">
        {{method_field('delete')}}
