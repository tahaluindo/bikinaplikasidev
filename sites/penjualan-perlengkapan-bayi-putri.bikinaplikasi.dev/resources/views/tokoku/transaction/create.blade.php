        ...
        <div class="container wrap mb-5">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label>Tanggal</label>
                    <input id="datepicker" type="text" name="date" class="form-control" value="{{$data['now']}}"
                        width="276" required>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select name="type" class="form-control" style="width:276px" required>
                        ...
                        {{--  <option value="return_penjualan">Retur Penjualan</option>  --}}
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-3">
                    <label class="h4"><u>HARGA</u></label>
                </div>
                <div class="col-md-2 mb-3">
                    <label class="h4"><u>JUMLAH</u></label>
                </div>
            </div>
            <div class="clone">
            ...
            <div class="row mb-3">
                <div class="col md-12">
                    ...
                    <textarea class="form-control" name="catatan" id="catatan" cols="15" rows="5" placeholder="Catatan">-</textarea>
                </div>
            </div>
