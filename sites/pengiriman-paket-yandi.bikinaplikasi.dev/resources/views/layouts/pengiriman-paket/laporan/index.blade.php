<div class='row'>
    <div class='col-md-12'>
        <form class="form-horizontal form-material" action="{{ url(route('pengiriman-paket.print')) }}" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-line" name='field' required>
                        @foreach(['id','jumlah','diantar_pada','pulang_pergi','diskon','total_bayar'] as $field)
