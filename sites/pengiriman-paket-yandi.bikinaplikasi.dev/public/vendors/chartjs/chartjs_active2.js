...
(function ($) {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                data: [45, 25],
                backgroundColor: ["#63C7FF", "#6DD4B1"],
                hoverBackgroundColor: ["rgba(242, 23, 128, .5)", "rgba(242, 23, 128, .4)"]
            }],
        },
...
(function ($) {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                data: [45, 25, 20, 15, 5],
                backgroundColor: ["#AFECFF", "#63C7FF", "#AFFFB7", "#DBAFFF", "#FFAFAF"],
                hoverBackgroundColor: ["#FF7B36", "#FF7B36", "#FF7B36", "#FF7B36",]
            }],
        },
        options: {responsive: true}
    });
