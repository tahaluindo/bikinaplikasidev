<div class='row'>
    <div class='col-md-12'>
        <form class="form-horizontal form-material" action="<?php echo e(url(route('pengiriman-paket.print'))); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>"
                           ...
                           value="<?php echo e(old('tanggal_awal') == "" ? now()->format('d-M-Y') : old('tanggal_awal')); ?>"
                           required>
...
unset($__errorArgs, $__bag); ?>"
                           name="tanggal_akhir" type="text" id="tanggal_akhir" value="<?php echo e(old('tanggal_akhir')); ?>"
                           required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-line" name='field' required>
                        <?php $__currentLoopData = ['id','jumlah','diantar_pada','pulang_pergi','diskon','total_bayar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-skytravelink.bikinaplikasi.dev\resources\views/layouts/pengiriman-paket/laporan/index.blade.php ENDPATH**/ ?>
