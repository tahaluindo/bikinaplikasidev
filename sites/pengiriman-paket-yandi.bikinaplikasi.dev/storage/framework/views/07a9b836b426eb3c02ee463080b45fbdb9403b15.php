...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e(isset($fasilitas->nama) ? $fasilitas->nama : (old('nama') == "" ? "" : old('nama'))); ?>"
               required>
...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e(isset($fasilitas->deskripsi) ? $fasilitas->deskripsi : (old('deskripsi') == "" ? "" : old('deskripsi'))); ?>"
               required>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-zaky.bikinaplikasi.dev\resources\views/fasilitas/form.blade.php ENDPATH**/ ?>