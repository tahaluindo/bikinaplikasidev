...
<div class="form-group <?php echo e($errors->has('kenaikan_harga') ? 'has-error' : ''); ?>">
    <label for="kenaikan_harga" class="control-label"><?php echo e('Kenaikan Harga'); ?></label>

    <div class="col-md-12">
        <input placeholder="kenaikan_harga" class="kenaikan_harga form-control form-control-line <?php $__errorArgs = ['kenaikan_harga'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e(isset($paket->kenaikan_harga) ? $paket->kenaikan_harga : (old('kenaikan_harga') == "" ? "" : old('kenaikan_harga'))); ?>"
               required>

        <?php $__errorArgs = ['kenaikan_harga'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\pengiriman-paket-yandi.bikinaplikasi.dev\resources\views/paket/form.blade.php ENDPATH**/ ?>