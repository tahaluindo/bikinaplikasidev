    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(url(route('pengiriman-paket.laporan.index'))); ?>">Rental Mobil</a></li>
            </ul>
        </li>
    </ul>
</nav>
                    ...
                    <div class="header_right d-flex justify-content-between align-items-center">
                        <div class="header_notification_warp d-flex align-items-center">
                            ...
                            <div class="profile_info">
                                ...
                                <div
                                    style="margin-right: 16px !important; background-size: cover">
...
<script>
    $(document).ready(function () {
        ...
        socket.addEventListener('message', function (event) {
            console.log('Content from server ', event.data);
        });
