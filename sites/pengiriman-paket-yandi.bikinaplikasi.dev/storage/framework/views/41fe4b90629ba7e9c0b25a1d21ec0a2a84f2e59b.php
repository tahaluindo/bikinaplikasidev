    ...
    <div class="col-md-12">
        ...
        <datalist id="tiket_id">
            <?php $__currentLoopData = $tikets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tiket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option
                    value="<?php echo e($tiket->id); ?>" <?php echo e((isset($pengiriman_paket->tiket_id) && $pengiriman_paket->tiket_id == $tiket->id) || old('tiket_id') == $tiket->id ? 'selected' : ''); ?>><?php echo e($tiket->nama); ?> - <?php echo e(toIdr($tiket->rute->biaya)); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </datalist>
...
<div class="form-group <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <select name="status" class="form-control form-control-line status" id="status" required>
            <?php $__currentLoopData = ['Baru','Dikirim','Dibatalkan','Refund']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-skytravelink.bikinaplikasi.dev\resources\views/pengiriman-paket/form.blade.php ENDPATH**/ ?>
