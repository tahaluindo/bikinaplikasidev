...
<div class="form-group <?php echo e($errors->has('diantar_pada') ? 'has-error' : ''); ?>">
    <label for="diantar_pada" class="diantar_pada control-label"><?php echo e('Diantar pada'); ?></label>

    <div class="col-md-12">
        <input placeholder="diantar_pada"
               class="diantar_pada flatpickr form-control form-control-line <?php $__errorArgs = ['diantar_pada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e(isset($tiket->diantar_pada) ? $tiket->diantar_pada : (old('diantar_pada') == "" ? now()->addDays(env('APP_WAKTU_PERPANJANGAN'))->format('d-M-Y') : old('diantar_pada'))); ?>"
               required>
