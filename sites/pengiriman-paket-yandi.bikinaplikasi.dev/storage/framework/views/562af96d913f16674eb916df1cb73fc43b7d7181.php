    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(url('pengiriman-paket')); ?>">Pengiriman paket</a></li>
                <li><a href="<?php echo e(url('rental-mobil')); ?>">Rental Mobil</a></li>
                <li><a href="<?php echo e(url('pemesanan-paket')); ?>">Pemesanan Paket</a></li>
                ...
                <li><a href="<?php echo e(url('rute')); ?>">Rute</a></li>
                <li><a href="<?php echo e(url('lokasi-tujuan')); ?>">Lokasi Tujuan</a></li>
                <li><a href="<?php echo e(url('paket')); ?>">Paket</a></li>
                <li><a href="<?php echo e(url('mobil')); ?>">Mobil</a></li>
                <li><a href="<?php echo e(url('fasilitas')); ?>">Fasilitas</a></li>
            </ul>
        </li>
        <li class="mm-active">
            ...
            <ul>
                <li><a href="<?php echo e(url(route('pengiriman-paket.laporan.index'))); ?>">Pengiriman paket</a></li>
                <li><a href="<?php echo e(url(route('rental-mobil.laporan.index'))); ?>">Rental Mobil</a></li>
                <li><a href="<?php echo e(url(route('pemesanan-paket.laporan.index'))); ?>">Pemesanan Paket</a></li>
            </ul>
        </li>
    </ul>
</nav>
                            ...
                            <div class="profile_info">
                                ...
                                <div class="profile_info_iner custom-list-menu-dropdown">
                                    <div class="profile_info_details">
                                        ...
                                        <ul class="list-group">
                                            <?php if($notifications->whereNotNull('pengiriman_paket_id')->where('dibaca', 0)->where('type', 'Transaksi Baru')->count()): ?>
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    Pengiriman paket Baru
                                                    <span
                                                        class="badge bg-danger rounded-pill"><?php echo e($notifications->whereNotNull('pengiriman_paket_id')->where('dibaca', 0)->where('type', 'Transaksi Baru')->count()); ?></span>
                                                </li>
                                            <?php endif; ?>

                                            <?php if($notifications->whereNotNull('pengiriman_paket_id')->where('dibaca', 0)->where('type', 'Refund')->count()): ?>
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    Refund Pengiriman paket Baru
                                                    <span
                                                        class="badge bg-danger rounded-pill"><?php echo e($notifications->whereNotNull('pengiriman_paket_id')->where('dibaca', 0)->where('type', 'Refund')->count()); ?></span>
                                                </li>
                                            <?php endif; ?>
...
<script>
    $(document).ready(function () {
        ...
        <?php if(Request::segment(1) == 'pengiriman-paket'): ?>
        function getTotalBayar() {
            $.ajax({
                url: "<?php echo e(route('pengiriman-paket.hitung_total_bayar')); ?>" + "?" + $('#form-submit').serialize(),
        ...
        <?php if(Request::segment(1) == 'pemesanan-paket'): ?>
        function getTotalBayar() {
            $.ajax({
                url: "<?php echo e(route('pemesanan-paket.hitung_total_bayar')); ?>" + "?" + $('#form-submit').serialize(),
                success: function (response) {
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-skytravelink.bikinaplikasi.dev\resources\views/layouts/app3.blade.php ENDPATH**/ ?>
