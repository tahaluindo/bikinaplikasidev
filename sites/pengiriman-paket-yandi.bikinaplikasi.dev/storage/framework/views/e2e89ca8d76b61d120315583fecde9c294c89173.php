<?php $__env->startSection('content'); ?>
                                ...
                                <div class="col-12">
                                    <div class="quick_activity_wrap">
                                        <div class="single_quick_activity">
                                            ...
                                            <p><?php echo e(toIdr($pengiriman_paket->count(), ",", "")); ?> Reservasi</p>
                                        </div>
                                        <div class="single_quick_activity">
                        ...
                        <div class="radial_footer">
                            <div class="radial_footer_inner d-flex justify-content-between">
                                <div class="left_footer">
                                    ...
                                    <p><?php echo e(toIdr($pengiriman_paket->whereBetween('created_at', [now()->addMonths(-1)->format("Y-m-01"), now()->addMonths(-1)->format("Y-m-31")])->sum('jumlah'), '.', "")); ?></p>
                                </div>
                                <div class="left_footer">
                                    <h5><span style="background-color: #A4A1FB;"></span> Bulan Ini</h5>
                                    <p><?php echo e(toIdr($pengiriman_paket->whereBetween('created_at', [now()->format("Y-m-01"), now()->format("Y-m-31")])->sum('jumlah'), '.', "")); ?></p>
                                </div>
                            </div>
                            <div class="radial_bottom">
                                <p><a href="<?php echo e(url(route('pengiriman-paket.laporan.index'))); ?>">Lihat Laporan</a></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        var penjualan_tiket_persen = <?php echo e(toIdr($pengiriman_paket->whereBetween('created_at', [now()->format("Y-m-01"), now()->format("Y-m-31")])->sum('jumlah') / ($tiket->sum('jumlah') / 100), '.', "")); ?>


        var rekapan_per_kuartal = [{
            name: 'Pengiriman paket',
            data: [<?php echo e($pengiriman_paket->whereBetween('created_at', [now()->addDays(-12)->format("Y-m-01"), now()->addDays(-6)->format("Y-m-01")])->sum('jumlah')); ?>, <?php echo e($pengiriman_paket->whereBetween('created_at', [now()->addDays(-6)->format("Y-m-01"), now()->format("Y-m-01")])->sum('jumlah')); ?>]
        }, {
            name: 'Rental Mobil',
            data: [<?php echo e($rental_mobil->whereBetween('created_at', [now()->addDays(-12)->format("Y-m-01"), now()->addDays(-6)->format("Y-m-01")])->count()); ?>, <?php echo e($pengiriman_paket->whereBetween('created_at', [now()->addDays(-6)->format("Y-m-01"), now()->format("Y-m-01")])->count()); ?>]
        }]
        ...
        <?php $__currentLoopData = $pengiriman_paket->groupBy('year_month'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <?php
            $grafik_pengembalian_pengiriman_paket = [];
        ?>
        ...
        <?php
            $grafik_pengembalian_pengiriman_paket[] = $pengiriman_paket->whereBetween('created_at', [date("$item-01-01"), date("$item-12-31")])->where('refund', '>', 0)->sum('jumlah');
        ...
        var grafik_pengembalian_pengiriman_paket = [<?php echo e(implode(",", $grafik_pengembalian_pengiriman_paket)); ?>]
        var grafik_pengembalian_rental_mobil = [<?php echo e(implode(",", $grafik_pengembalian_rental_mobil)); ?>]
        var jenis_tiket_terjual_count = [<?php echo e(implode(",", $tiket->pluck('pengiriman_pakets_count')->toArray())); ?>]
        ...
        var grafikLabaBersihBulan = <?php echo $pengiriman_paket->groupBy('year_month')->keys()->toJson(); ?>

    </script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-skytravelink.bikinaplikasi.dev\resources\views/home.blade.php ENDPATH**/ ?>
