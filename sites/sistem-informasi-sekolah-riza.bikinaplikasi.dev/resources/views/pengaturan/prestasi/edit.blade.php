                ...
                <div class="col-xl-6 xl-100 box-col-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form class="form-horizontal form-material" action="{{ url("/pengaturan/prestasi/{$prestasi->id}") }}"
                                ...
                                <div class="form-group {{ $errors->has('judul') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="judul"
                                               ...
                                               value="{{ isset($prestasi->judul) ? $prestasi->judul : old('judul') }}">
                                ...
                                <div class="form-group {{ $errors->has('gambar') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="gambar"
                                               ...
                                               value="{{ isset($prestasi->gambar) ? $prestasi->gambar : old('gambar') }}">
