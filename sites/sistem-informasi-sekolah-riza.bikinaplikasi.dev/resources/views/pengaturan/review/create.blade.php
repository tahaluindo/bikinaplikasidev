                ...
                <div class="col-xl-6 xl-100 box-col-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form class="form-horizontal form-material" action="{{ url('/pengaturan/review') }}"
                                ...
                                <div class="form-group {{ $errors->has('siswa_id') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="siswa_id" class="form-control form-control-line" id="siswa_id"
                                                required>
                                ...
                                <div class="form-group {{ $errors->has('judul') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="isi"
                                               ...
                                               name="isi" type="text" id="isi"
                                               value="{{ isset($review->isi) ? $review->isi : old('isi') }}">
                                ...
                                <div class="form-group {{ $errors->has('gambar') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12">
                                        <input placeholder="gambar"
                                               ...
                                               value="{{ isset($review->gambar) ? $review->gambar : old('gambar') }}">
