...
<head>
    ...
    <link rel="icon" href="{{ url('') }}/assets2/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ url('') }}/assets2/images/favicon.png" type="image/x-icon">
                ...
                <ul class="nav-menus pull-right ">
                    ...
                    <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning"
                        ...
                        <ul class="onhover-show-div notification-dropdown">
                            ...
                            <li class="bg-light txt-dark"><a href="{{ route('siswa.index') }}">Semua </a> notifikasi</li>
                        </ul>
                    </li>
                ...
                <ul class="iconMenu-bar custom-scrollbar">
                    ...
                    <li>
                        ...
                        <ul class="iconbar-mainmenu custom-scrollbar">
                            ...
                            <li><a href="{{ route('pengaturan.batas-akhir-registrasi.index') }}">Batas Akhir Registrasi</a></li>
                            ...
                            <li><a href="{{ route('pengaturan.angkatan-registrasi.index') }}">Angkatan Registrasi</a></li>
                        ...
                        <div class="people-list friend-list">
                            <ul class="list">
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/1.jpg" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/2.jpg" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/8.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/4.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/5.jpg" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/6.jpg" alt="">
                                    <div class="status-circle away"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-small user-image"
                                                          src="{{ url('') }}/assets2/images/user/7.jpg" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
