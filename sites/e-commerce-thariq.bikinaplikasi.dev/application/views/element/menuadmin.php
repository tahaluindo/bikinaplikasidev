...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="<?php echo site_url('users') ?>"><i class="fa fa-users fa-fw"></i> Pelanggan</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-shopping-cart fa-fw"></i> Pemesanan<span class="fa arrow"></span></a>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="<?php echo site_url('laporan/pelanggan') ?>">Pelanggan</a>
                    </li>
