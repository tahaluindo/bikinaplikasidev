                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo site_url('barang/editBarang/'.$barang->id) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="ukuranm" value="<?php echo $barang->ukuranm ?>" class="form-control input-sm" placeholder="Ukuran M" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Ukuran L</label>
                                        <input type="number" name="ukuranl" value="<?php echo $barang->ukuranl ?>" class="form-control input-sm" placeholder="Ukuran L" required />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Ukuran XL</label>
                                        <input type="number" name="ukuranxl" value="<?php echo $barang->ukuranxl ?>" class="form-control input-sm" placeholder="Ukuran XL" required />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Bahan</label>
                                <input type="text" name="bahan" value="<?php echo $barang->bahan ?>" class="form-control input-sm" placeholder="Bahan" required <?php echo hanyaHuruf() ?>/>
                            </div>
                            <div class="form-group">
