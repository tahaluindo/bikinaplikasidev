...
class Dashboard extends Controller
{
    ...
    public static function produk(Produk $produk)
    {
        self::cssjs();
        ...
        $produk->harga = $produk->nama == 'Program Custom' ? "Min: " . toIdr(4000000) : $produk->harga;
        
        $data['produk'] = $produk;
        
        return view('admin::dashboard.produk', $data);
    }
