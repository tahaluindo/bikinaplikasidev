    ...
    if (checkUserPosition.success == undefined) {
        if (checkUserPosition.order_type == 0) {
            ...
            await fetch("https://api-app.qq-os.com/api/v2/contract/order/open", {
                ...
                "body": `{\"fundType\":1,\"largeSpreadRate\":0,\"leverTimes\":20,\"margin\":\"50\",\"marginCoinName\":\"USDT\",\"marketFactor\":1,\"orderType\":\"0\",\"price\":${checkUserPosition.price},\"profitLossRateDto\":{\"stopProfitRate\":\"120\",\"stopLossRate\":\"30\"},\"quotationCoinId\":22,\"spreadRate\":0.001,\"stopLossPrice\":-1,\"stopProfitPrice\":-1,\"upRatio\":0.5}`,
                "method": "POST",
                "mode": "cors",
                "credentials": "include"
            });
            ...
            await fetch("https://api-app.qq-os.com/api/v2/contract/order/open", {
                ...
                "referrerPolicy": "no-referrer",
                "body": `{\"fundType\":1,\"largeSpreadRate\":0,\"leverTimes\":20,\"margin\":\"50\",\"marginCoinName\":\"USDT\",\"marketFactor\":1,\"orderType\":\"1\",\"price\":${checkUserPosition.price},\"profitLossRateDto\":{\"stopProfitRate\":\"120\",\"stopLossRate\":\"30\"},\"quotationCoinId\":22,\"spreadRate\":0.001,\"stopLossPrice\":-1,\"stopProfitPrice\":-1,\"upRatio\":0.5}`,
                "method": "POST",
                "mode": "cors",
                "credentials": "include"
            });
