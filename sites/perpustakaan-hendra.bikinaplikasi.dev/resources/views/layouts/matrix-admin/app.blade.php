            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ url('') }}">
                        <div class="text-center p-t-5 p-b-5" style='line-height: 30px; text-align: center !important; width: 100%; margin-top: 20px;'>
                            {!! wordwrap(env('APP_OBJECT_NAME'), 12, "<br>") !!}
                        </div>
                    </a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30 in">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            aria-expanded="false"><i class="fa fa-balance-scale" aria-hidden="true"></i></i><span class="hide-menu">Laporan </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">

                                <li class="sidebar-item @if(Route::current()->action['as'] == 'anggota.laporan.index') selected @endif">
                                    <a href="{{ route('anggota.laporan.index') }}" class="sidebar-link">
                                        <i class="fa fa-table"></i>
                                        <span class="hide-menu"> Anggota </span>
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-item @if(Route::current()->action['as'] == 'buku.laporan.index') selected @endif">
                                    <a href="{{ route('buku.laporan.index') }}" class="sidebar-link">
                                        <i class="fa fa-table"></i>
                                        <span class="hide-menu"> Buku </span>
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-item @if(Route::current()->action['as'] == 'peminjaman.laporan.index') selected @endif">
                                    <a href="{{ route('peminjaman.laporan.index') }}" class="sidebar-link">
                                        <i class="fa fa-table"></i>
                                        <span class="hide-menu"> Peminjaman </span>
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-item @if(Route::current()->action['as'] == 'pengembalian.laporan.index') selected @endif">
                                    <a href="{{ route('pengembalian.laporan.index') }}" class="sidebar-link">
                                        <i class="fa fa-table"></i>
                                        <span class="hide-menu"> Pengembalian </span>
                                    </a>
                                </li>
