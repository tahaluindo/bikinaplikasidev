                                ...
                                <li>
                                    <a href="{{ route('anggota.index') }}"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Anggota</span>
                                    </a>
                                </li>
                            @endif
                                ...
                                <li>
                                    <a href="{{ route('buku.index') }}"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Buku</span>
                                    </a>
                                </li>
                            @endif
                                ...
                                <li>
                                    <a href="{{ route('peminjaman.index') }}"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Peminjaman</span>
                                    </a>
                                </li>
                            @endif
                                ...
                                <li>
                                    <a href="{{ route('pengembalian.index') }}"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Pengembalian</span>
                                    </a>
                                </li>
                            @endif
                                ...
                                <li>
                                    <a href="{{ route('kode-buku.index') }}"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Kode Buku</span>
                                    </a>
                                </li>
                            @endif
                        </ul>
                    ...
                    @if(in_array(auth()->user()->level, ['Admin', 'Petugas']))
                        <li>
                            <a class="has-arrow" aria-expanded="false"><span
                                    ...
                                    class="mini-click-non">Laporan</span></a>
                            <ul class="submenu-angle" aria-expanded="false">

                                @if(in_array(auth()->user()->level, ['Admin', 'Petugas', 'Siswa', 'Guru']))
                                    <li>
                                        <a href="{{ route('anggota.laporan.index') }}"
                                           class="">
                                ...
                                @if(in_array(auth()->user()->level, ['Admin', 'Petugas', 'Siswa', 'Guru']))
                                    <li>
                                        <a href="{{ route('buku.laporan.index') }}"
                                           class="">
                                ...
                                @if(in_array(auth()->user()->level, ['Admin', 'Petugas', 'Siswa', 'Guru']))
                                    <li>
                                        <a href="{{ route('peminjaman.laporan.index') }}"
                                           class="">
                                ...
                                @if(in_array(auth()->user()->level, ['Admin', 'Petugas', 'Siswa', 'Guru']))
                                    <li>
                                        <a href="{{ route('pengembalian.laporan.index') }}"
                                           class="">
