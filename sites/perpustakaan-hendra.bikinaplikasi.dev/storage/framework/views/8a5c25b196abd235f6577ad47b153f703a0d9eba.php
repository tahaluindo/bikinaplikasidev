<div class="form-group <?php echo e($errors->has('anggota_id') ? 'has-error' : ''); ?>">
    <label for="anggota_id" class="control-label"><?php echo e('Nama anggota'); ?></label>
    ...
    <div class="col-md-12">
        ...
        <datalist id="anggota_id">
            <?php $__currentLoopData = $anggotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anggota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option
                    value="<?php echo e($anggota->id); ?>" <?php echo e((isset($peminjaman->anggota_id) && $peminjaman->anggota_id == $anggota->id) || old('anggota_id') == $anggota->id ? 'selected' : ''); ?>><?php echo e("$anggota->nama (id anggota: $anggota->no_identitas)"); ?></option>
...
<div class="form-group <?php echo e($errors->has('user_petugas_id') ? 'has-error' : ''); ?>">
    <label for="user_petugas_id" class="control-label"><?php echo e('Nama petugas'); ?></label>
...
<div class="form-group <?php echo e($errors->has('tanggal') ? 'has-error' : ''); ?>">
    <label for="tanggal" class="control-label"><?php echo e('Tanggal Peminjaman'); ?></label>

    <div class="col-md-12">
        <input placeholder="tanggal"
               class="form-control form-control-line <?php $__errorArgs = ['tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-hendra.bikinaplikasi.dev\resources\views/peminjaman/form.blade.php ENDPATH**/ ?>