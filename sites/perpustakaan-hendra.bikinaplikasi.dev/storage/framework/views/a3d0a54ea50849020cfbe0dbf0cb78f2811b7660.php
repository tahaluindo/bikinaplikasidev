                                    ...
                                    <tr data-id='<?php echo e($item->id); ?>'>
                                        ...
                                        <?php if(!in_array(auth()->user()->level, ['Siswa', 'Guru'])): ?>
                                            <td class="text-center">
                                                ...
                                                <form action="<?php echo e(url('/kode-buku' . '/' . $item->id)); ?>"
                                                      method='post'
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-hendra.bikinaplikasi.dev\resources\views/kode-buku/index.blade.php ENDPATH**/ ?>