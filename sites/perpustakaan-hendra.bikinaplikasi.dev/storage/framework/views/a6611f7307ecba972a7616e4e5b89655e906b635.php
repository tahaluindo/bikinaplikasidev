...
<table width="100%" border="1" style='margin-bottom: 250px;'>
    ...
    <tbody>
        ...
        <tr data-id='<?php echo e($item->id); ?>'>
            ...
            <td><?php echo e(Carbon\Carbon::parse($item->peminjaman->tanggal)->format('d-m-Y')); ?></td>
            <td><?php echo e(Carbon\Carbon::parse($item->peminjaman->tanggal_pengembalian)->format('d-m-Y')); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
...
<?php echo $__env->make('layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-hendra.bikinaplikasi.dev\resources\views/pengembalian/laporan/print.blade.php ENDPATH**/ ?>