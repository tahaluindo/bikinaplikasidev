...
<div class="form-group <?php echo e($errors->has('buku_id') ? 'has-error' : ''); ?>">
    <label for="buku_id" class="control-label"><?php echo e('nama buku'); ?></label>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-hendra.bikinaplikasi.dev\resources\views/detail_peminjaman/form.blade.php ENDPATH**/ ?>