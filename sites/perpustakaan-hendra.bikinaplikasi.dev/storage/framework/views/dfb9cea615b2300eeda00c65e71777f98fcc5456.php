<div class="form-group <?php echo e($errors->has('peminjaman_id') ? 'has-error' : ''); ?>">
    <label for="peminjaman_id" class="control-label"><?php echo e('nama peminjam'); ?></label>

    <div class="col-md-12">

        ID: <?php echo e($peminjaman->id); ?> (<?php echo e($peminjaman->anggota->nama); ?> | <?php echo e($peminjaman->user_petugas->name); ?> |
        <?php echo e(\Carbon\Carbon::parse($peminjaman->tanggal)->format('d-m-Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($peminjaman->tanggal_pengembalian)->format("d-m-Y")); ?>)
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-hendra.bikinaplikasi.dev\resources\views/pengembalian/form.blade.php ENDPATH**/ ?>