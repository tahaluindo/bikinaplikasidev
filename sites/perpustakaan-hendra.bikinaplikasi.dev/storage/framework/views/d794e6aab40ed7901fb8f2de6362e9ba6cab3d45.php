...
<div class="" style="width: 360px; border-radius: 16px; border: 1px solid grey; height: 265px; padding: 10px;">
    <div style="border-bottom: 1px solid grey; height: 50px;">
        <img src="<?php echo e(url('image/logo.png')); ?>" height="40" style="float: left;">
        <h3 style="text-align: center; margin-bottom: 0px; margin-top: 0px;">Kartu Anggota Perpustakaan</h3>
        <h4 style="text-align: center; margin-top: 10px;"><?php echo e(env('APP_OBJECT_NAME')); ?></h4>
    </div>
    ...
    <div>
        <div style="width: 40%; float: right; margin-top: 10px;">
            <strong><?php echo e(env('APP_OBJECT_LOCATION')); ?>, <?php echo e(date("d-m-Y")); ?></strong>
            <div style="margin-top: 4px;">Kepala Perpustakaan</div>
            <div style="margin-top: 50px;"></div>
            <strong><?php echo e(env('APP_OBJECT_SIGNATURE')); ?></strong>
        </div>
    </div>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\perpustakaan-hendra.bikinaplikasi.dev\resources\views/anggota/cetak.blade.php ENDPATH**/ ?>