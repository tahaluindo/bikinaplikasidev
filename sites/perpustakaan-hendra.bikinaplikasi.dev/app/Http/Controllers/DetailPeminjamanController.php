...
class DetailPeminjamanController extends Controller
{
    ...
    {
        $peminjaman_count = Peminjaman::find(request()->peminjaman_id)->detail_peminjaman->count();

        if($peminjaman_count == 3) {
            return redirect()->back()->with('error', 'Buku yang dipinjam telah mencapai batas maksimum');
        }
...
//        ]);
        ...
        $data["detail_peminjamans"] = $object
