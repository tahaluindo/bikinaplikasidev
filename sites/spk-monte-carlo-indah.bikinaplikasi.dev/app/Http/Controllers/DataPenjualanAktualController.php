        ...
        \DB::transaction(function() use($request, $data_penjualan_aktual, $data_penjualan_aktual_detail) {
            ...
            if($request->volume_januari) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_januari * $request->volume_januari,
                ]);
            }
            ...
            if($request->volume_februari) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_februari * $request->volume_februari,
                ]);
            }
            ...
            if($request->volume_maret) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_maret * $request->volume_maret
                ]);
            }
            ...
            if($request->volume_april) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_april * $request->volume_april,
                ]);
            }
            ...
            if($request->volume_mei) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_mei * $request->volume_mei,
                ]);
            }
            ...
            if($request->volume_juni) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_juni * $request->volume_juni,
                ]);
            }
            ...
            if($request->volume_juli) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_juli * $request->volume_juli,
                ]);
            }
            ...
            if($request->volume_agustus) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_agustus * $request->volume_agustus,
                ]);
            }
            ...
            if($request->volume_september) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_september * $request->volume_september,
                ]);
            }
            ...
            if($request->volume_oktober) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_oktober * $request->volume_oktober,
                ]);
            }
            ...
            if($request->volume_november) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_november * $request->volume_november,
                ]);
            }
            ...
            if($request->volume_desember) {
                $data_penjualan_aktual_detail::create([
                    ...
                    'nilai' => $request->harga_per_kg_desember * $request->volume_desember,
                ]);
            }
        });
