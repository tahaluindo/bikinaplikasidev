...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    Route::get('/dashboard', function () {
        $data['data_penjualan_aktuals']    = DataPenjualanAktual::all();
        $data['data_penjualan_prediksis']    = DataPenjualanPrediksi::all();
...
Route::resource('data-penjualan-prediksi', 'App\Http\Controllers\DataPenjualanPrediksiController');
