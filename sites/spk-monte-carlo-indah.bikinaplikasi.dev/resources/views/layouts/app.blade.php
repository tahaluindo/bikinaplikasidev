                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-head-line">
                            @if(Request::segment(2) == "create") Tambah
                            @elseif(Request::segment(3) == "edit") Edit
                            @elseif(Request::segment(2) == "laporan") Laporan
                            @endif {{ preg_replace("/_|-/", " ", Request::segment(1)) }}

                            @if(Request::segment(1) == 'hitung-prediksi-harga' || Request::segment(1) == 'hitung-prediksi-penjualan' || Request::segment(1) == 'hitung-prediksi-keseluruhan')
                            <form class="form-inline" style='margin-top: 10px;'>
                                <div class="form-group mx-sm-3 mb-2">
                                    ...
                                    <select class='form-control' name='produk_id'>
                                        ...
                                        <option value='{{ $item->id }}' @if(\request()->produk_id == $item->id) selected @endif>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class='form-control' name='tahun_id'>
                                        ...
                                        @foreach ($tahuns as $item)
                                            <option value='{{ $item->id }}' @if(\request()->tahun_id == $item->id) selected @endif>{{ $item->tahun }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <button type="submit" class="btn btn-primary mb-2" name='hitung' value='hitung'>Hitung</button>
                                <button type="submit" class="btn btn-primary mb-2" name='simpan' value='simpan'>Simpan</button>
                                <button type="submit" class="btn btn-primary mb-2" name='download' value='download'>Download</button>
                            </form>
                            @endif
                            
                            @if(Request::segment(1) == 'data-prediksi' || Request::segment(1) == 'grafik')
                            <form class="form-inline" style='margin-top: 10px;'>
                                <div class="form-group mx-sm-3 mb-2">
                                    <label for="inputPassword2" class="sr-only">Produk</label>
