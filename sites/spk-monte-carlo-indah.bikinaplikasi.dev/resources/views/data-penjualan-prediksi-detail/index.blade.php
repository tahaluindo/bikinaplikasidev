...
<script>
    const locationHrefHapusSemua = "{{ url('datapenjualanprediksidetail/hapus_semua') }}";
    const locationHrefAktifkanSemua = "{{ url('datapenjualanprediksidetail/aktifkan_semua') }}";
    const locationHrefCreate = "{{ url('datapenjualanprediksidetail/create') }}";
    var columnOrders = [{{ $datapenjualanprediksidetail_count }}];
    var urlSearch = "{{ url('datapenjualanprediksidetail') }}";
    var q = "{{ $_GET['q'] ?? '' }}";
