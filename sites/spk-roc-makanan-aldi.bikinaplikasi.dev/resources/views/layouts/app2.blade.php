            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1" style="padding-bottom: 20px !important;">
                    ...
                    @if(in_array(auth()->user()->level, ['Admin', 'Pengguna']))
                            ...
                            @if(in_array(auth()->user()->level, ['Admin', 'Pengguna']))
                                <li>
                                    <a href="{{ route('perhitungan.index') }}?action=hasil_akhir"
                                       class="">
                            ...
                            @if(in_array(auth()->user()->level, ['Admin', 'Pengguna']))
                                <li>
                                    <a href="{{ route('perhitungan.index') }}?action=hasil_akhir_comunale"
                                       class="">
                                ...
                                <li>
                                    <a href="{{ route('comunale.index') }}"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Comunale</span>
                                    </a>
                                </li>
                            @endif
