...
<div class="error-pagewrap">
    <div class="error-page-int">
        <div class="text-center m-b-md custom-login">
            <h3>LOGIN</h3>
            <p><?php echo e(env('APP_OBJECT_NAME')); ?></p>
        </div>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-roc-makanan-aldi.bikinaplikasi.dev\resources\views/auth/login.blade.php ENDPATH**/ ?>