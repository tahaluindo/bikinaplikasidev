        ...
        <div class="content-error">
            <div class="hpanel">
                <div class="panel-body">
                    <form id="loginForm" method="POST" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label class="control-label" for="nama">Nama</label>
                            <input type="text" placeholder="Nama" title="nama" required="" value=""
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a onclick="window.location.href = '/login'" class="btn btn-outline-success px-3"
                           style="padding-left: 10px; padding-right: 10px;"><<< Kembali</a>
                    </form>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-transportasi-annisa.bikinaplikasi.dev\resources\views/auth/register.blade.php ENDPATH**/ ?>