                        ...
                        <a class="" href="<?php echo e(url('')); ?>">
                            ...
                            <span class="mini-click-non">Dashboard</span>
                                                ...
                                                <?php if(in_array(auth()->user()->level, ['Admin'])): ?>
                                                    <li>
                                                        <a href="<?php echo e(route('comunale.index')); ?>"
                                                           class="">
                    
                                                            <span class="mini-sub-pro">Master Comunale</span>
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
                                ...
                                <li>
                                    <a href="<?php echo e(route('alternatif.index')); ?>"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Master Brand</span>
                                    </a>
                                </li>
                            <?php endif; ?>
                                ...
                                <li>
                                    <a href="<?php echo e(route('kriteria.index')); ?>"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Master Variable</span>
                                    </a>
                                </li>
                    ...
                    <?php if(in_array(auth()->user()->level, ['Admin',])): ?>
                        <li>
                            <a href="<?php echo e(route('genre.index')); ?>"
                                ...
                                <span class="mini-sub-pro">Genre</span>
                            </a>
                        </li>
                    <?php endif; ?>

                    <?php if(in_array(auth()->user()->level, ['Admin', 'Pengguna'])): ?>
                                <li>
                            ...
                            <?php if(in_array(auth()->user()->level, ['Admin', 'Pengguna'])): ?>
                                <li>
                                    <a href="<?php echo e(route('perhitungan.index')); ?>?action=hasil_akhir"
                                       class="">

                                        <span class="mini-sub-pro">Hasil Akhir</span>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(in_array(auth()->user()->level, ['Admin', 'Pengguna'])): ?>
                                <li>
                                    <a href="<?php echo e(route('perhitungan.index')); ?>?action=hasil_akhir_comunale"
                                       class="">

                                        <span class="mini-sub-pro">Hasil Akhir Comunale</span>
                                    </a>
                                </li>
                            <?php endif; ?>
                                ...
                                <li>
                                    <a href="<?php echo e(route('user.index')); ?>"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Data User</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('user.profile', auth()->user()->id)); ?>"
                                       class="">
                                        ...
                                        <span class="mini-sub-pro">Data Profile</span>
                                    </a>
                                </li>
                            <?php endif; ?>
                        </ul>
...
<script>
    <?php if(request()->segment(1) != "alternatif"): ?>
    $(document).ready(function() {
        $(document).on('change', '#comunale_id', () => {
            console.log($(this).val());
            window.location.href = "/perhitungan?action=hasil_akhir_comunale&comunale_id=" + $("#comunale_id option:selected").val()
        });
    });
    <?php endif; ?>
</script>
...
<script>
    $(document).ready(function () {
        ...
        $('#dataTable, #dataTable1, #dataTable2, #dataTable3, #dataTable4').DataTable({
            paging: true,
            pageLength: 25,
            dom: 'Blfrtip',
            "columnDefs": [{
            ...
            buttons: tampilkan_buttons === false ? (button_manual === false ? [] : button_manual) :
                [
                        <?php if(Route::current()->action['as'] != 'survey.index'): ?>
                    {
                        extend: 'selectAll',
                        text: 'Pilih Semua',
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-roc-makanan-aldi.bikinaplikasi.dev\resources\views/layouts/app2.blade.php ENDPATH**/ ?>