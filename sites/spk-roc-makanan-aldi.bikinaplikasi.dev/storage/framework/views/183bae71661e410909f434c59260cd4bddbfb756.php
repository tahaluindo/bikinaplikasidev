...
unset($__errorArgs, $__bag); ?>" name="nama" type="text" id="nama" value="<?php echo e(isset($user->nama) ? $user->nama : old('nama')); ?>" >
...
<div class="form-group <?php echo e($errors->has('level') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        <select name="level" class="form-control form-control-line" id="level">
            <?php $__currentLoopData = ['Admin' => 'Admin', 'Pengguna' => 'Pengguna']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>"
                    <?php echo e((isset($user->genre) && $user->level == $key) || old('level') == $key ? 'selected' : ''); ?>>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\spk-roc-makanan-aldi.bikinaplikasi.dev\resources\views/user/form.blade.php ENDPATH**/ ?>