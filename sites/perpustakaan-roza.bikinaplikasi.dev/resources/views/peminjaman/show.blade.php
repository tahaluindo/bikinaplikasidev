                    ...
                    <h1 class="page-head-line">
                        ...
                        @if($peminjaman->detail_peminjaman->count() && in_array($peminjaman->status, ['Berlangsung', 'Perpanjangan']))
                            ...
                            <a class='btn btn-success text-white'
                               onclick='var waktu_perpanjangan = window.prompt("Masukkan jumlah perpanjangan, default {{ env("APP_WAKTU_PERPANJANGAN") }} hari?", {{ env("APP_WAKTU_PERPANJANGAN") }}); setTimeout(() => {}, 1000); if (waktu_perpanjangan != null) location.href = "{{ route("peminjaman.perpanjangan", $peminjaman->id) }}?waktu_perpanjangan=" + waktu_perpanjangan'>Perpanjangan</a>
                        @else
                            @if(in_array($peminjaman->status, ['Berlangsung', 'Perpanjangan']))
