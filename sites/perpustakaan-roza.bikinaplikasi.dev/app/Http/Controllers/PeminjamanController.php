...
class PeminjamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('peminjaman?anggota_id=' . $request->anggota_id)->with('success', 'Berhasil menambah Peminjaman');
    }
    ...
    public function update(Request $request, Peminjaman $peminjaman)
    {
        $this->validate($request, [
			...
			'tanggal' => 'required|max:12|before:tanggal_pengembalian',
			'tanggal_pengembalian' => 'required|max:12|after:tanggal',
			'status' => 'required|in:Berlangsung,Selesai,Perpanjangan'
        ]);
    ...
    public function perpanjangan(Peminjaman $peminjaman)
    {
        ...
        return redirect("peminjaman/" . $peminjaman->id)->with('success', 'Berhasil melakukan perpanjangan');
    }
}
