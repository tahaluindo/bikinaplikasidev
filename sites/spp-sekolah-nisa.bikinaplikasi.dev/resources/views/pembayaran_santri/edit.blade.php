                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material"
                            action="{{ route('pembayaran_santri.update', ['pembayaran_santri' => $pembayaranSantri->id]) }}" method="post"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                      <label class="form-check-label">
                                        ...
                                        @if(in_array($pembayaran_santri_bulan, old('pembayaran_santri_bulans') ?? []) || in_array($pembayaran_santri_bulan, $pembayaran_santri_bulan_selecteds ??  [])) checked @endif name="pembayaran_santri_bulans[]">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="number" placeholder="2020"
                                        ...
                                        value='{{ old('tahun') == "" ? $pembayaranSantri->tahun : old('tahun') }}' name='tahun'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="number" placeholder="100000"
                                        ...
                                        value='{{ old('nominal_spp_default') == "" ? $pembayaranSantri->nominal_spp_default : old('nominal_spp_default') }}' name='nominal_spp_default' @if(auth()->user()->level != 'superadmin') readonly @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="number" placeholder="100000"
                                        ...
                                        value='{{ old('nominal_uang_makan_default') == "" ? $pembayaranSantri->nominal_uang_makan_default : old('nominal_uang_makan_default') }}' name='nominal_uang_makan_default' @if(auth()->user()->level != 'superadmin') readonly @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea id='editor-1' style="height: 130px !important;"
                                        ...
                                        name='keterangan'>{{ old('keterangan') == "" ? $pembayaranSantri->keterangan : old('keterangan') }}</textarea>
