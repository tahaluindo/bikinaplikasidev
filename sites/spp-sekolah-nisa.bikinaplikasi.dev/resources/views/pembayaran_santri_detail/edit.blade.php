                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material"
                            action="{{ url(route('pembayaran_santri_detail.update', ['pembayaran_santri' => $pembayaranSantri->id, 'pembayaran_santri_detail' => $pembayaranSantriDetail->id])) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text"
                                        ...
                                        name='tags' id='tags' required placeholder="cari user...">

                                    <input id="user_id" name='user_id' type='hidden' value="{{ old('user_id') == "" ? $pembayaranSantriDetail->user->id : old('user_id')}}">
                                    @error('user_id')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            ...
                                            old("pembayaran_santri_bulan") ?? []) ||
                                            in_array($pembayaran_santri_bulan->id,
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id='nominal_spp_dibayar' type="number" placeholder="100000"
                                        ...
                                        value='{{ old('nominal_spp_dibayar') == "" ? $pembayaranSantriDetail->nominal_spp_dibayar : old('nominal_spp_dibayar') }}'
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input  id='nominal_uang_makan_dibayar' type="number" placeholder="100000"
                                        ...
                                        value='{{ old('nominal_uang_makan_dibayar') == "" ? $pembayaranSantriDetail->nominal_uang_makan_dibayar : old('nominal_uang_makan_dibayar') }}'
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control form-control-line" name='potongan' id='potongan' id='potongan'>
                                        <option value="0" @if(old('potongan')==0 || 0 == $pembayaranSantriDetail->potongan) selected @endif>
                                            0%</option>
                                        <option value="25" @if(old('potongan')==25 || 25 == $pembayaranSantriDetail->potongan) selected @endif>
                                            25%</option>
                                        <option value="50" @if(old('potongan')==50 || 50 == $pembayaranSantriDetail->potongan) selected @endif>
                                            50%</option>
                                        {{--  <option value="75" @if(old('potongan')==75 || 75 == $pembayaranSantriDetail->potongan) selected @endif>
                                            75%</option>  --}}
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control form-control-line" name='status' id='status'>
                                        ...
                                        <option value="{{ $status }}" @if(old('status')==$status || $status == $pembayaranSantriDetail->status) selected @endif>
                                            {{ $status }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea id='editor-1' style="height: 130px !important;"
                                        ...
                                        name='catatan'>{{ old('catatan') == "" ? $pembayaranSantriDetail->catatan : old('catatan') }}</textarea>
