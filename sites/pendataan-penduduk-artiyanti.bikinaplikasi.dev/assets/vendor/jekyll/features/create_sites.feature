Feature: Create sites
  ...
  Scenario: Basic site with layout and a post
    ...
    When I run jekyll build
    Then the _site directory should exist
    And I should see "Post Layout: <p>The only winning move is not to play.</p>" in "_site/2009/03/27/pendudukmes.html"
  ...
  Scenario: Basic site with layout inside a subfolder and a post
    ...
    And I have the following posts:
      | title    | date       | layout      | content                               |
      | Pendudukmes | 2009-03-27 | post/simple | The only winning move is not to play. |
