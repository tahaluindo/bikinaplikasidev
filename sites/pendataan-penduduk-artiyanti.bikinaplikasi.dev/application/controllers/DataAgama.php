...
class DataAgama extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataAgama = $this->db->get_where('dataagama', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataAgama']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataAgama = $this->db->get_where('dataagama', array('id' => $this->input->post('id'), 'id!=' => $id));
