...
class DataRt extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataRt = $this->db->get_where('datart', array('nama_rt' => $this->input->post('nama_rt')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataRt']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataRt = $this->db->get_where('datart', array('nama_rt' => $this->input->post('nama_rt'), 'nama_rt!=' => $id));
    ...
    {
        $data['title']          = "Data KK";
        $penduduk = $this->db->select('nik')->where('rt', $this->input->get('nama_rt'))->get('datapenduduk')->result();
        $dataPenduduk = [];
        ...
        $data['DataKK'] = $this->db->where_in('nik_kepala_keluarga', $dataPenduduk)->get('datakk')->result_array();
