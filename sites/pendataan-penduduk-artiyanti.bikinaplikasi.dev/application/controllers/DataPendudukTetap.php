...
class DataPendudukTetap extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataPendudukTetap = $this->db->get_where('datapenduduktetap', array('nik' => $this->input->post('nik')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataPendudukTetap']['nik'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataPendudukTetap = $this->db->get_where('datapenduduktetap', array('id' => $this->input->post('id'), 'id!=' => $id));
                $cek_DataPenduduk = $this->db->get_where('datapenduduk', array('nik' => $this->input->post('nik')));
