...
class DataBerita extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataBerita = $this->db->get_where('databerita', array('judul' => $this->input->post('judul')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataBerita']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataBerita = $this->db->get_where('databerita', array('id' => $this->input->post('id'), 'id!=' => $id));
