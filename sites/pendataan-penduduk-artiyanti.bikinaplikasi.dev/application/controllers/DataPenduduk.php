...
class DataPenduduk extends CI_Controller
{
    ...
    public function edit($id)
    {
        ...
        $penduduk = $this->db->where('nik', $id)->get('datapenduduk')->row();
        $cekPekerjaanPenduduk = $this->db->where('keterangan', $penduduk->pekerjaan)->get('datapekerjaan')->row();
        $cekPekerjaanLainLain = $this->db->where('pekerjaan', $cekPekerjaanPenduduk->keterangan ?? "zzz")->get('datapenduduk')->num_rows(); #zzz gak ada
        ...
        // die($pekerjaan);
            ...
            if ($this->form_validation->run()) {
                ...
                $cek_DataPenduduk = $this->db->get_where('datapenduduk', array('nik' => $this->input->post('nik'), 'nik!=' => $id));
