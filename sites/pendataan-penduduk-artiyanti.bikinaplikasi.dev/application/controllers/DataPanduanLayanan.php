...
class DataPanduanLayanan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $cek_DataPanduanLayanan = $this->db->get_where('datapanduanlayanan', array('keterangan' => $this->input->post('keterangan')));
    ...
    public function edit($id)
    {
        ...
        if (isset($data['DataPanduanLayanan']['id'])) {
            ...
            if ($this->form_validation->run()) {
                $cek_DataPanduanLayanan = $this->db->get_where('datapanduanlayanan', array('id' => $this->input->post('id'), 'id!=' => $id));
