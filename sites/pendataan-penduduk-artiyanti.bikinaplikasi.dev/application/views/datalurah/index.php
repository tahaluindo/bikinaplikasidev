                    ...
                    <div class="col-lg-6 col-6">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Data Lurah</li>
                            </ol>
                        </nav>
                    </div>
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class='card-body'>
                        <?php echo form_open('DataLurah/add', array("class" => "form-horizontal", "enctype" => 'multipart/form-data')); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-info">
                                    <div class="box-header with-border">
                                        ...
                                        <h1 style='display: inline; margin-right: 10px;'>Data Lurah</h1>
                                        <?php if ($this->session->userdata('role') == 'Bagian Pelayanan' or $this->session->userdata('role') == 'Admin'): ?>
                                        <a href='<?php echo site_url('DataLurah/add'); ?>'
