                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tambah Data Penduduk Datang</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" name="tanggal"
                                                    value="<?php echo $this->input->post('tanggal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="desa_asal"
                                                    value="<?php echo $this->input->post('desa_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="kecamatan_asal"
                                                    value="<?php echo $this->input->post('kecamatan_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="alamat_asal"
                                                    value="<?php echo $this->input->post('alamat_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="alasan"
                                                    value="<?php echo $this->input->post('alasan'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="rt_asal"
                                                    value="<?php echo $this->input->post('rt_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="rw_asal"
                                                    value="<?php echo $this->input->post('rw_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="kode_pos_asal"
                                                    value="<?php echo $this->input->post('kode_pos_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="no_telepon_asal"
                                                    value="<?php echo $this->input->post('no_telepon_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="kabupaten_asal"
                                                    value="<?php echo $this->input->post('kabupaten_asal'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="provinsi_asal"
                                                    value="<?php echo $this->input->post('provinsi_asal'); ?>"
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="radio" name="jenis_kelamin" value="Laki - Laki" <?php if($this->input->post('jenis_kelamin')=='Laki - Laki'){echo "checked";} ?>/> Laki-laki<br/>
