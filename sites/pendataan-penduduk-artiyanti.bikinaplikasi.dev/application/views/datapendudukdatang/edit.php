                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Data Penduduk Datang</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="nik"
                                                    value="<?php echo $this->input->post('nik') == "" ? $DataPendudukDatang['nik'] : $this->input->post('nik'); ?>"
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-10">
												<input type="radio" name="jenis_kelamin" value="Laki - Laki" <?php if($this->input->post('jenis_kelamin')=='Laki - Laki' ||  $DataPendudukDatang['jenis_kelamin'] == "Laki - Laki"){echo "checked";} ?>/> Laki-laki<br/>
												<input type="radio" name="jenis_kelamin" value="Perempuan" <?php if($this->input->post('jenis_kelamin')=='Perempuan' ||  $DataPendudukDatang['jenis_kelamin'] == "Perempuan"){echo "checked";} ?>/> Perempuan<br/>
