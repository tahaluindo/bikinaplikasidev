    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class='card-body'>
                        <?php echo form_open('DataBerita/edit/'.$DataBerita['id'], array("enctype" => 'multipart/form-data')); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="judul" class="form-control form-control-sm" value='<?php echo $this->input->post('judul') == "" ? $DataBerita['judul'] : $this->input->post('judul'); ?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <textarea name="keterangan" class="form-control form-control-sm"
                                                    id="keterangan"><?php echo $this->input->post('keterangan') == "" ? $DataBerita['keterangan'] : $this->input->post('keterangan'); ?></textarea>
