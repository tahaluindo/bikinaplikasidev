                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit Data Penduduk Meninggal</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class='card-body'>
                        <?php echo form_open("DataPendudukMeninggal/edit/$DataPendudukMeninggal[nik]", array("class"=>"form-horizontal" , "enctype" => 'multipart/form-data')); ?>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="nik"
                                                    value="<?php echo $this->input->post('nik') == "" ? $DataPendudukMeninggal['nik'] : ""; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" name="tanggal_meninggal"
                                                    value="<?php echo $this->input->post('tanggal_meninggal') == "" ? $DataPendudukMeninggal['tanggal_meninggal'] : ""; ?>"
                                                    class="form-control form-control-sm" id="tanggal_meninggal" />
                                                <span class="text-danger"><?php echo form_error('tanggal_meninggal');?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="tempat_meninggal"
                                                    value="<?php echo $this->input->post('tempat_meninggal') == "" ? $DataPendudukMeninggal['tempat_meninggal'] : ""; ?>"
                                                    class="form-control form-control-sm" id="tempat_meninggal" />
                                                <span class="text-danger"><?php echo form_error('tempat_meninggal');?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="penyebab_meninggal"
                                                    value="<?php echo $this->input->post('penyebab_meninggal') == "" ? $DataPendudukMeninggal['penyebab_meninggal'] : ""; ?>"
                                                    class="form-control form-control-sm" id="penyebab_meninggal" />
                                                <span class="text-danger"><?php echo form_error('penyebab_meninggal');?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="jam_meninggal_dunia"
                                                    value="<?php echo $this->input->post('jam_meninggal_dunia') == "" ? $DataPendudukMeninggal['jam_meninggal_dunia'] : $this->input->post('jam_meninggal_dunia'); ?>"
                                        ...
                                        <div class="form-group">
                                            <label for="surat_keterangan_meninggal" class="control-label"><span
                                                    class="text-danger"></span>Surat Keterangan Meninggal (Tidak Wajib)</label>
                                            <div class="col-md-10">
