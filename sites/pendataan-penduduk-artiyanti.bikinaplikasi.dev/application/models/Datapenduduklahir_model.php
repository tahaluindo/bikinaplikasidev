...
class datapenduduklahir_model extends CI_Model
{
    ...
    {
        return $this->db->get_where('datapenduduklahir',array('id'=>$id))->row_array();
    }
    ...
    function get_all_DataPendudukLahir()
    {
        ...
        if($this->input->get('q')) {
            return $this->db->query("Select * from datapenduduklahir where datapenduduklahir.nama_lengkap like '%{$this->input->get('q')}%'
            ")->result_array();
        ...
        return $this->db->query('Select * from datapenduduklahir')->result_array();
    ...
    function add_DataPendudukLahir($params)
    {
        // echo "<pre>";
        // print_r($params); die();
        $this->db->insert('datapenduduklahir',$params);
    ...
    {
        $this->db->where('id',$id);
        return $this->db->update('datapenduduklahir',$params);
    }
    ...
    {
        return $this->db->delete('datapenduduklahir',array('id'=>$id));
    }
