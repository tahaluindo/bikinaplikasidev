...
<head>
    ...
    <title>E Kantint - Universitas Dinamika Bangsa</title>
...
<body>
    <div class="header">
        <div class="container">
            <a href="#" class="navbar-brand scroll-top" style="line-height: 35px;">E Kantint - Universitas Dinamika Bangsa</a>
                                ...
                                <div class="owl-breakfast owl-carousel owl-theme">
                                    ...
                                    <div class="item col-md-12">
                                        <div class="food-item">
                                            ...
                                            <div class="price">{{ toIdr($menu_item->harga) }}</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="right-info">
                                    ...
                                    <fieldset>
                                        <select required name='menus[]'  class="pilih-menu">
                                            ...
                                            @foreach ($penjuals as $item)
                                                ...
                                                @foreach ($item->menus as $menu_item)
                                                <option value="{{ $menu_item->id }}">{{ $menu_item->nama }} ({{ $menu_item->stok }})</option>
                                                @endforeach
                                                </optgroup>
                                            @endforeach
                                        </select>
                        ...
                        <form id="form-submit" action="{{ route('pesanan.store') }}" method="post" onsubmit="return confirm('Yakin akan melakukan pesanan?')">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <p>Copyright &copy; 2020 E Kantint</p>
                </div>
                <div class="col-md-4">
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.pilih-menu', function() {
            ...
            if($(this).val() == "Batalkan") {
                $.ajax({
                    url: "{{ route('pesanan.hitung_pesanan') }}" + "?" + $('#form-submit').serialize(),
        ...
        $(document).on('change', '.pilih-menu-jumlah', function() {
            $.ajax({
                url: "{{ route('pesanan.hitung_pesanan') }}" + "?" + $('#form-submit').serialize(),
                success: function(response) {
