    ...
    <div class="page">
        <div class="page-header h-300 mb-30">
            <div class="text-center blue-grey-800 mt-50 m-xs-0">
                <div class="font-size-50 mb-30 blue-grey-800 text-white" style="color: white !important;">{{ env('APP_OBJECT_NAME') }}</div>
                <ul class="list-inline font-size-14">
                    <li class="list-inline-item"  style="color: white !important;">
                        <i class="icon wb-map mr-5  text-white" aria-hidden="true"></i> {{ env('APP_OBJECT_DESCRIPTION') }}
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="card-block p-30" style="min-width:480px;">
                            <div class="row pb-20" style="height:calc(100% - 322px);">
                                <div class="col-md-8 col-sm-6">
                                    <div class="blue-grey-700">TRAFFIC PENJUALAN</div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="counter counter-md">
                                                ...
                                                <div class="counter-label blue-grey-400">Penjualan</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="counter counter-md">
                                                ...
                                                <div class="counter-label blue-grey-400">Pembelian</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="list-inline text-center mb-0">
                                <li class="list-inline-item">
                                    <i class="icon wb-large-point blue-200 mr-10" aria-hidden="true"></i> Penjualan
                                </li>
                                <li class="list-inline-item ml-35">
                                    <i class="icon wb-large-point teal-200 mr-10" aria-hidden="true"></i> Pembelian
                                </li>
                            </ul>
                        </div>
                    </div>
