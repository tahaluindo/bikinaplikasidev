...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-indigo-600"
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center">
            <span class="navbar-brand-text hidden-xs-down"> {{ env('APP_OBJECT_NAME') }}</span>
        </div>
              ...
              <span class="avatar avatar-online">
                ...
                <i></i>
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="{{ route('user.profile', auth()->user()->id) }}" role="menuitem"><i
                    ...
                    @if(in_array(auth()->user()->level, ['Admin']))
                        <li class="site-menu-item">
                            <a @if(Route::current()->action['as'] == 'pelanggan.index') class='active-menu'
                               @endif href="{{ route('pelanggan.index') }}"><span
                    ...
                    @if(in_array(auth()->user()->level, ['Admin']))
                        <li class="site-menu-item">
                            <a @if(Route::current()->action['as'] == 'pemasok.index') class='active-menu'
                               @endif href="{{ route('pemasok.index') }}"><span
                                    class="site-menu-title">Pemasok</span></a>
                        </li>
                    @endif
                    ...
                    @if(in_array(auth()->user()->level, ['Admin']))
                        <li class="site-menu-item">
                            <a @if(Route::current()->action['as'] == 'pembelian.index') class='active-menu'
                               @endif href="{{ route('pembelian.index') }}"><span
                    ...
                    @if(in_array(auth()->user()->level, ['Admin', 'Karyawan']))
                        <li class="site-menu-item">
                            <a @if(Route::current()->action['as'] == 'penjualan.index') class='active-menu'
                               @endif href="{{ route('penjualan.index') }}"><span
                    ...
                    @if(in_array(auth()->user()->level, ['Admin', 'Karyawan']))
                        <li class="site-menu-item">
                            <a @if(Route::current()->action['as'] == 'pemasok.laporan.index') class='active-menu'
                               @endif href="{{ route('pemasok.laporan.index') }}"><span
                                    class="site-menu-title">Pemasok</span></a>
                        </li>
                    @endif
                    ...
                    @if(in_array(auth()->user()->level, ['Admin', 'Karyawan']))
                        <li class="site-menu-item">
                            <a @if(Route::current()->action['as'] == 'barang.laporan.index') class='active-menu'
                               @endif href="{{ route('barang.laporan.index') }}"><span
                                    class="site-menu-title">Barang</span></a>
                        </li>
                    @endif
                </ul>
            </li>
...
<footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a
            href="https://themeforest.net/item/remark-responsive-bootstrap-admin-template/11989202">{{ env('APP_OBJECT_NAME') }}</a>
    </div>
</footer>
<!-- Core  -->
