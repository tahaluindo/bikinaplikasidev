                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{url('dokter/periksa/today')}}"
                                    class="nav-link {{ Request::is('dokter/periksa/today') ? 'active ' : ''}}">
                                    <i class="fa fa-user-md nav-icon"></i>
                                    Hari Ini
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('dokter/periksa/all')}}"
                                    class="nav-link {{ Request::is('dokter/periksa/all') ? 'active ' : ''}}">
