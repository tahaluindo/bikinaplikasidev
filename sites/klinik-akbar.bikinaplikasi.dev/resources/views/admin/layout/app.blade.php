    ...
    <div class="dashboard-main-wrapper">
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                ...
                <span class="brand-text font-weight-normal">PUSKESMAS KEBUN KOPI JAMBI</span>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin/dokter')}}"
                                    class="nav-link text-white {{ Request::is('admin/dokter*') ? 'active text-dark' : ''}}">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin/pegawai')}}"
                                    class="nav-link text-white {{ Request::is('admin/pegawai*') ? 'active text-dark' : ''}}">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin/pasien')}}"
                                    class="nav-link text-white {{ Request::is('admin/pasien*') ? 'active text-dark' : ''}}">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin/periksa')}}"
                                    class="nav-link text-white {{ Request::is('admin/periksa*') ? 'active text-dark' : ''}}">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin/spesialis')}}"
                                    class="nav-link text-white {{ Request::is('admin/spesialis*') ? 'active text-dark' : ''}}">
