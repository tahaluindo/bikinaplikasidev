                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-between">
                                <div class="col-6"><button type="button" class="btn btn-success mb-3"
                                    ...
                                    <form method="POST" action="{{ url('admin/pegawai/cari') }}">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                @if(isset($cari))
                                                <a href="{{ url('admin/pegawai') }}" class="btn btn-danger" href="#"
                                                    role="button">
                                        ...
                                        <div class="card-footer">
                                            <div class="text-right">
                                                ...
                                                <a class="btn btn-success btn-sm"
                                                    href="{{ url('admin/pegawai/'. $item['id']) }}" role="button"> <i
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <form class="d-inline" method="POST" action="{{url('admin/pegawai')}}">
                    @method('delete')
                    @csrf
