                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a href="{{url('pegawai/pasien')}}"
                                    class="nav-link {{Request::is('pegawai/pasien*') ? 'active' : 'text-white' }}">
                                    <i class="nav-icon fa fa-user"></i>
                                        Pasien
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{url('pegawai/periksa')}}"
                                    class="nav-link {{Request::is('pegawai/periksa*') ? 'active' : 'text-white' }}">
                                    <i class="nav-icon fa fa-book"></i>
                                        Rekam Medic
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{url('pegawai/dokter/jadwal')}}"
                                    class="nav-link {{Request::is('pegawai/dokter/jadwal') ? 'active' : 'text-white' }}">
                                    <i class="nav-icon fa fa-book"></i>
                                        Jadwal Dokter
                                </a>
                            </li>
