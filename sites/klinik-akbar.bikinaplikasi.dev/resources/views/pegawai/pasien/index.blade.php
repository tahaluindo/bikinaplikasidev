...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark font-weight-bold">DATA PASIEN</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                ...
                                <table id="example1" class="table border table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a class="btn btn-danger btn-sm" href="{{ url('pegawai/pasien/'. $item['id'] .'/periksa') }}" role="button"> <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                    Periksa</a>
                                                <a class="btn btn-success btn-sm" href="{{ url('pegawai/pasien/'. $item['id']) .'/ubah'}}" role="button"> <i class="fa fa-pencil-alt" aria-hidden="true"></i>
                                                    Ubah</a>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input name="tanggal_lahir" type="date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask placeholder="Tanggal Lahir" value="{{ old('tanggal_lahir') }}">
                    </div>
                    <!-- /.input group -->
                </div>
                <div class="form-group">
