        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview"
                    ...
                    <li
                            class="nav-item has-treeview {{ (Request::is('admin/dokter*') ? 'menu-open' : Request::is('admin/pegawai*')) ? 'menu-open' : (Request::is('admin/admin*') ? 'menu-open' : '') }}">

                        {{-- <li class="nav-item has-treeview menu-open"> --}}
                        <a href="#"
                           class="nav-link {{ (Request::is('admin/dokter*') ? 'active' : Request::is('admin/pegawai*')) ? 'active' : (Request::is('admin/admin*') ? 'active' : 'bg-light') }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{url('admin/dokter')}}"
                                   class="nav-link {{ Request::is('admin/dokter*') ? 'active bg-dark' : ''}}">
