...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <h2 class="card-inside-title">Tambah Perpanjangan Sewa</h2>
                <div class="row clearfix">
                    <div class="col-sm-12">

                        <form id="form_validation" method="POST" action='{{ url("perpanjangan_sewa") }}'>
                            {{ csrf_field() }}

                            <div class="form-group form-float">
                                <label>Tagihan * (Otomatis)</label>
                                <div class="form-line {{ $errors->has('tagihan_id') ? "focused error" : "" }}" ng-init='a = 5'>
                                    <input name='tagihan_id' id='tagihan_id' type="text" class="form-control" placeholder="Tagihan Id" maxlength="50" minlength="1" readonly value="{{ $tagihan_id }}" />
                                </div>
                                ...
                                <div class="form-line {{ $errors->has('methode') ? "focused error" : "" }}">
                                    ...
                                    <select name="methode"  id='methode'  class="form-control" required>
                                        <option value="">--Pilih Methode Pembayaran--</option>
                                            ...
                                            <option value="Bank Nyicil"  @if(old('methode') === 'Bank Nyicil') selected @endif>Bank Nyicil (Mohon update tggl jatuh tempo di menu Tagihan secara manual jika sudah lunas)</option>
                                            <option value="Cash Nyicil"  @if(old('methode') === 'Cash Nyicil') selected @endif>Cash Nyicil (Mohon update tggl jatuh tempo di menu Tagihan secara manual jika sudah lunas)</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-line {{ $errors->has('jenis_perpanjangan') ? "focused error" : "" }}">
                                    ...
                                    <select name="jenis_perpanjangan" id='jenis_perpanjangan' class="form-control" required>
                                        <option value="">--Pilih Jenis Perpanjangan--</option>
                                            <option value="Harian" @if("Harian" == $jenis_perpanjangan) selected @endif>
                                                Harian
                                            </option>
                                            <option value="Mingguan" @if("Mingguan" == $jenis_perpanjangan) selected @endif>
                                                Mingguan
                                            </option>
                                            <option value="Bulanan" @if("Bulanan" == $jenis_perpanjangan) selected @endif>
                                                Bulanan
                                            </option>
                                            <option value="Tahunan" @if("Tahunan" == $jenis_perpanjangan) selected @endif>
                                                Tahunan
                                            </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('lama_perpanjangan') ? "focused error" : "" }}">
                                    ...
                                    <input name='lama_perpanjangan' id='lama_perpanjangan' type="number" min='1' max='3' class="form-control" placeholder="Lama Perpanjangan" value="1"/>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('untuk_tempo') ? "focused error" : "" }}">
                                    ...
                                    <input name='untuk_tempo' id='untuk_tempo' type="datetime-local" class="form-control" placeholder="Untuk Tempo"  value='{{ date('Y-m-d\Th:i:s', strtotime($untuk_tempo)) }}' readonly/>
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('biaya') ? "focused error" : "" }}">
                                    ...
                                    <input name='biaya' id='biaya' type="text" class="form-control cleave1" placeholder="Biaya"  value='{{ old("biaya") ?? $biaya }}' readonly/>
                                    @if($errors->has('biaya'))
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('biaya_tambahan') ? "focused error" : "" }}">
                                    <label>Biaya Tambahan @if($tagihan->status == "Menunggak") (<span class="text-danger">Terdeteksi menunggak lebih/sama dengan {{ $terdeteksimenunggaklebihdariatausamadengan }} hari (Biaya menunggak: {{ $format_idr($biaya_menunggak) }}, Biaya Perpanjangan: {{ $format_idr($biaya) }} </span>) </label> @endif
                                    <input name='biaya_tambahan' id='biaya_tambahan' type="text" class="form-control cleave2" placeholder="Biaya Tambahan"  value='{{ old("biaya_tambahan") ?? $biaya_tambahan }}' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('total') ? "focused error" : "" }}">
                                    ...
                                    <input name='total' id='total' type="text" class="form-control cleave3" placeholder="Total" value='{{ old("total") ?? $total }}' readonly/>
                                    @if($errors->has('total'))
