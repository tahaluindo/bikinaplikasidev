            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        ...
                        <form id="form_validation" method="POST" action='{{ url("type") }}'>
                            {{ csrf_field() }}
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('nama') ? "focused error" : "" }}">
                                    <label>Nama Type *</label>
                                    <input name='nama' type="text" class="form-control" placeholder="Nama" value='{{ old("nama") }}' maxlength="50" minlength="1" />
                                </div>
                                @if($errors->has('nama'))
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('harga_harian') ? "focused error" : "" }}">
                                    ...
                                    <input name='harga_harian' class="form-control cleave1" placeholder="Harga Harian"  value='{{ old("harga_harian") }}' min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('harian_tambahan') ? "focused error" : "" }}">
                                    ...
                                    <input name='harian_tambahan' class="form-control cleave5" placeholder="Harian Tambahan"  value='{{ old("harian_tambahan") }}' min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('harga_mingguan') ? "focused error" : "" }}">
                                    ...
                                    <input  name='harga_mingguan' class="form-control cleave2" placeholder="Harga Mingguan"  value='{{ old("harga_mingguan") }}'  min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('mingguan_tambahan') ? "focused error" : "" }}">
                                    ...
                                    <input name='mingguan_tambahan' class="form-control cleave6" placeholder="Mingguan Tambahan"  value='{{ old("mingguan_tambahan") }}' min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('harga_bulanan') ? "focused error" : "" }}">
                                    ...
                                    <input  name='harga_bulanan' class="form-control cleave3" placeholder="Harga Bulanan"  value='{{ old("harga_bulanan") }}'  min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('bulanan_tambahan') ? "focused error" : "" }}">
                                    ...
                                    <input name='bulanan_tambahan' class="form-control cleave7" placeholder="Bulanan Tambahan"  value='{{ old("bulanan_tambahan") }}' min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('harga_tahunan') ? "focused error" : "" }}">
                                    ...
                                    <input  name='harga_tahunan' class="form-control cleave4" placeholder="Harga Tahunan"  value='{{ old("harga_tahunan") }}'  min='0' max='999999999' />
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('tahunan_tambahan') ? "focused error" : "" }}">
                                    ...
                                    <input name='tahunan_tambahan' class="form-control cleave8" placeholder="Tahunan Tambahan"  value='{{ old("tahunan_tambahan") }}' min='0' max='999999999' />
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('fasilitas') ? "focused error" : "" }}">
                                    ...
                                    <input name='fasilitas' type="text" class="form-control" placeholder="Fasilitas (Pisahkan Dengan Koma)" value='{{ old("fasilitas") }}' maxlength="200" />
                                </div>
