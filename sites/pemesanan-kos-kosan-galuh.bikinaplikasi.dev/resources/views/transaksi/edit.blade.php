...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <h2 class="card-inside-title">Edit Transaksi</h2>
                <div class="row clearfix">
                    <div class="col-sm-12">

                        <form id="form_validation" method="POST" action='{{ url("transaksi/$data->id") }}'>
                            {{ csrf_field() }}
                            @method('put')
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('jenis') ? "focused error" : "" }}">
                                    ...
                                    <select name="jenis" id='jenis' class="form-control" required>
                                        ...
                                        <option value="Pengeluaran" @if($data->jenis  === 'Pengeluaran') selected @endif)>Pengeluaran</option>
                                        <option value="Pemasukan" @if($data->jenis  === 'Pemasukan') selected @endif)>Pemasukan</option>
                                    </select>
                                </div>
                                @if($errors->has('jenis'))
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('tggl') ? "focused error" : "" }}">
                                    ...
                                    <input name='tggl'  type="date" class="form-control" placeholder="tggl"  value='{{ $data->tggl }}' />
                                    @if($errors->has('tggl'))
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('total') ? "focused error" : "" }}">
                                    ...
                                    <input name='total' id='total' type="text" class="form-control cleave1" placeholder="Total" value='{{ $data->total }}' min='0' max='999999999' />
                                    @if($errors->has('total'))
                            ...
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('keterangan') ? "focused error" : "" }}">
                                    ...
                                    <textarea name='keterangan' class="form-control" placeholder="Keterangan" maxlength="500">{{ $data->keterangan }}</textarea>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('methode') ? "focused error" : "" }}">
                                    ...
                                    <select name="methode" id='methode' class="form-control" required @if($data->jenis == 'Tagihan') disabled @endif>
                                        <option value="">--Pilih Methode--</option>
                                            ...
                                            <option value="Nyicil"  @if($data->methode === 'Nyicil') selected @endif)>Nyicil</option>
                                    </select>
                                </div>
