    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">{{ ucwords("berita") }}</h4>
                    <ol class="breadcrumb">

                        <li class="breadcrumb-item"><a href="javaScript:void();">Halaman</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ ucwords("berita") }}</li>
                    </ol>
                </div>
            </div>
            <!-- End Breadcrumb-->
                                    ...
                                    <table class="table" id='dataTable'>
                                        ...
                                        @foreach($berita as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->berita_kategori->nama }}</td>
                                                <td>{{ $item->judul }}</td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="label label-primary"
                                                       href="{{ url('/berita/' . $item->id . '/edit') }}">Edit</a>

                                                    <form action="{{ url('/berita' . '/' . $item->id) }}"
