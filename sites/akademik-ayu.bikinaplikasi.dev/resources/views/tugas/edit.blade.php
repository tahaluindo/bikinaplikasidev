                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="mapel_id form-control w-100" name='mapel_id'>
                                    ...
                                    <option @if(old('mapel_id')==$mapel_detail->mapel->id || $tugas->mapel_id == $mapel_detail->mapel->id) selected @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Nama Tugas"
                                    ...
                                    value='{{ old('nama') == "" ? $tugas->nama : old('nama') }}' name='nama'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea placeholder="Deskripsi Tugas"
                                    ...
                                    name='deskripsi'>{{ old('deskripsi') == "" ? $tugas->deskripsi : old('deskripsi') }}</textarea>
