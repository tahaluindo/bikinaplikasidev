...
class SoalPilganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('soal_pilgan.index')->with('success', 'Berhasil menambah soal_pilgan');
    }
    ...
    public function update(Request $request, SoalPilgan $soal_pilgan)
    {
        ...
        return redirect()->route('soal_pilgan.index')->with('success', 'Berhasil mengupdate SoalPilgan');
    }
    ...
    public function hapus_semua(Request $request)
    {
        ...
        return back()->with('success', 'Berhasil menghapus banyak data soal_pilgan');
    }
    ...
    public function download_format()
    {
        ...
        $soalEssayTable = DB::select(DB::raw('select mapel_id, soal, jenis, opsi_a, opsi_b, opsi_c, opsi_d, jawaban from soal_pilgans limit 1'))[0];
