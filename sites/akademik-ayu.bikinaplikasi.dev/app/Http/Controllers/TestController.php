...
class TestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'mode'               => 'in:Essay Acak,Essay Normal,Pilgan Acak,Pilgan Normal',
        ...
        return redirect()->route('test.index')->with("success", "Berhasil menambah test");
    }
    ...
    public function show(Test $test)
    {
        ...
        // cek kalo usernya sudah pernah ikut test, kalo belum selesai tetap bisa lanjutkan
        // kalo sudah selesai bilang sudah mengikuti test ini
        $test_details = $test->test_details->where('user_id', auth()->user()->id);
        $test_detail  = $test_details->first();

        // pilih soal yang akan dikerjakan berdasarkan testnya soal pilgan atau essay
        ...
        // cek kalo testnya udah berakhir
        ...
        if (count($test_details) && $test_detail->status != "Belum Selesai") {
            return back()->with('error', "Kamu sudah mengikuti test ini!");
        }

        mulai_baru:
        // langsung isi ke tabel test_detail, kalo udah ada g perlu diisi
        ...
        // oper variable test_detail ke view test untuk nanti di update
        // dd($data);
    ...
    public function update(Request $request, Test $test)
    {
        ...
        return redirect()->route('test.index')->with("success", "Berhasil mengupdate Test");
    }
    ...
    public function destroy(Test $test)
    {
        ...
        return redirect()->route('test.index')->with("success", "Berhasil menghapus Test");
    }
    ...
    public function hapus_semua(Request $request)
    {
        ...
        return back()->with('success', 'Berhasil menghapus banyak data test');
    }
}
