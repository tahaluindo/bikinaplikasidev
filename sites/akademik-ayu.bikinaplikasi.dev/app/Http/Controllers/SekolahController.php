...
class SekolahController extends Controller
{
    ...
    public function update(Request $request, Sekolah $sekolah)
    {
        ...
        if($request->hasFile('struktur_organisasi')) {
            ...
            $data['input']['struktur_organisasi'] = "struktur_organisasi/" . $request->struktur_organisasi->getClientOriginalName();
            $request->struktur_organisasi->move("struktur_organisasi", $data['input']['struktur_organisasi']);

            $request->request->add(['struktur_organisasi' => $data['input']['struktur_organisasi']]);

            $sekolah->update($data['input']);
        } else {
