...
<h1 class="page-head-line">
    Pengembalian 
    @if($peminjaman->detail_peminjaman->count() && $peminjaman->status == 'Berlangsung')
    <a class='btn btn-success' href="{{ route('pengembalian.create') . "?peminjaman_id=$peminjaman->id" }}">Proses Pengembalian</a>
    @else
        @if($peminjaman->status == 'Berlangsung')
