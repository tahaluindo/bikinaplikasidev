...
class PengembalianController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $tanggal_awal = $request->tanggal_awal ? $request->tanggal_awal : Pengembalian::get()->first()->tanggal;
        $tanggal_akhir = $request->tanggal_akhir ? $request->tanggal_akhir : Pengembalian::get()->last()->tanggal;
