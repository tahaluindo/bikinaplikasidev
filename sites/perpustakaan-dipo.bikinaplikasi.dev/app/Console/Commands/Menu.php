...
class Menu extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($tables as $table) {
            ...
            $tablesReturn[] = "
            <li>
                <a @if(Route::current()->action['as'] == '$value.index') class='active-menu' @endif href=\"{{ route('$value.index') }}\"><i class=\"fa fa-square-o\"></i>$valueCaptialize</a>
            </li>\r";         

            $laporanReturn[] = "
            <li>
                <a  @if(Route::current()->action['as'] == '$value.laporan.index') class='active-menu' @endif href=\"{{ route('$value.laporan.index') }}\"><i class=\"fa fa-square-o\"></i>$valueCaptialize</a>
            </li>\r";
        }
