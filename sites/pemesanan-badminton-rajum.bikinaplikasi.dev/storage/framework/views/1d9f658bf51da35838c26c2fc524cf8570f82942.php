<div class="form-group <?php echo e($errors->has('user_id') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <input list="user_id" class="form-control form-control-line" name="user_id" value="<?php echo e(isset($rental_mobil->user_id) ? $rental_mobil->user_id : old('user_id')); ?>">
    ...
    <div class="col-md-12">
        ...
        <datalist id="mobil_id">
            <?php $__currentLoopData = $mobils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mobil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option
                    value="<?php echo e($mobil->id); ?>" <?php echo e((isset($rental_mobil->mobil_id) && $rental_mobil->mobil_id == $mobil->id) || old('mobil_id') == $mobil->id ? 'selected' : ''); ?>><?php echo e($mobil->nama); ?>, Biaya rental: <?php echo e(toIdr($mobil->biaya_rental)); ?>, Biaya supir: <?php echo e(toIdr($mobil->biaya_supir)); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </datalist>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\reservasi-dan-travel-zaky.bikinaplikasi.dev\resources\views/rental-mobil/form.blade.php ENDPATH**/ ?>