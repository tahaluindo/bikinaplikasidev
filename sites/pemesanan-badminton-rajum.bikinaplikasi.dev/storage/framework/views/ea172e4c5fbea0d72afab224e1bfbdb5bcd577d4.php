        ...
        <li class="mm-active">
            ...
            <ul>
                ...
                <?php if(in_array(auth()->user()->level, ['Admin', ''])): ?>
                    <li><a href="<?php echo e(url('pemesanan')); ?>">Pemesanan</a></li>
                <?php endif; ?>

                <?php if(in_array(auth()->user()->level, ['Admin', ''])): ?>
                    <li><a href="<?php echo e(url('lapangan')); ?>">Lapangan</a></li>
                <?php endif; ?>
...
<?php /**PATH D:\bikinaplikasi\project\setup_server_default\sites\pemesanan-badminton-rajum.bikinaplikasi.dev\resources\views/layouts/app3.blade.php ENDPATH**/ ?>