...
<body>
	...
	<center>
		...
		<tr>
			<td>
					<a href="form-daftar-kk.php" class="btn btn-primary">Daftar Baru</a>
					<a href="cetak-pra-kk.php" class="btn btn-primary">Cetak</a>
			</td>
			<td class="align-top">
				<form method="get">
		...
		<tbody>
			...
			{
				$tgl = $_GET['tanggal'];
				$sql = mysqli_query($db,"select * from daftar_kk where tanggal='$tgl'");
			}else
			{
			...
			<tr>
				...
				<td class="block"><small>
					...
					//{
						...
						echo "<a href='form-terima-opr-kk.php?id=".$data['id']." '>Terima</a> |";
					//}else{
					...
					//}
						...
						echo "<a onclick=\"return confirm('Yakin akan hapus data ini?')\" href='hapus-keterangan-kk.php?id=".$data['id']."'> Hapus </a> ";
					?>
				</small></td>
