...
<html>
<head>
    <title> Pendaftaran Akte Kematian</title>
</head>
...
<form action="proses-pendaftaran-akte-kematian.php" method="POST">
<div class="container">
  <div class="panel bg-primary text-white">
    <div class="panel panel-success" ><H3>Pendaftaran Akte Kematian</h3></div>
  </div>
    ...
    <table class="table  table-sm">
        ...
        <tr>
            <th width="200px">Nama Almarhum:</th>
            <th><input type="text" required maxlength="50" class="form-control form-control-sm" name="nama_almarhum" placeholder="Nama Almarhum"  ></th>
        </tr> 
