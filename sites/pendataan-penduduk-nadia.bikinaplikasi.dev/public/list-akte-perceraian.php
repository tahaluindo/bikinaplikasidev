...
<body>
	...
	<center>
		...
		<tr>
			<td>
					<a href="form-daftar-akte-perceraian.php" class="btn btn-primary">Daftar Baru</a>
					<a href="cetak-pra-akte-perceraian.php" class="btn btn-primary">Cetak</a>
			</td>
			<td class="align-top">
				<form method="get">
		...
		<tbody>
			...
			//deteksi jika tombol tampilkan di klikk
			if(isset($_GET['tanggal']))
			{
				$tgl = $_GET['tanggal'];
				$sql = mysqli_query($db,"select * from daftar_akte_perceraian where tanggal='$tgl'");
			}else
			{
				$sql = mysqli_query($db,"select * from daftar_akte_perceraian where tanggal='$tanggal_skrg'");
			}
			...
			<tr>
				...
				<td class="block"><small>
					...
					//{
						...
						echo "<a href='form-terima-opr-akte-perceraian.php?id=".$data['id']." '>Terima</a> |";
					//}else{
							//echo  "Terima | <a href='form-selesai-opr.php?id=".$data['id']."'>Status</a> | "; 
							echo  "<a href='form-selesai-opr-akte-perceraian.php?id=".$data['id']."'>Status</a> | ";
					//}
					echo "<a href='form-keterangan-akte-perceraian.php?id=".$data['id']."'> Ket</a>  | ";

						
					echo "<a onclick=\"return confirm('Yakin akan hapus data ini?')\" href='hapus-keterangan-akte-perceraian.php?id=".$data['id']."'> Hapus </a> ";
					?>
				</small></td>
