...
<body>
	...
	<center>
		...
		<h2>DAFTAR PEMOHON Akte Kelahiran</h2>
 </center>
		...
		<tr>
			<td>
					<a href="form-daftar-akte.php" class="btn btn-primary">Daftar Baru</a>
					<a href="cetak-pra-akte.php" class="btn btn-primary">Cetak</a>
			</td>
			<td class="align-top">
				<form method="get">
		...
		<thead class="thead-dark" align="center">
            ...
            <th class="align-middle" width="170px"><small>Nama Bayi</small></th>
		...
		<tbody>
			...
			{
				$tgl = $_GET['tanggal'];
				$sql = mysqli_query($db,"select * from daftar_akte where tanggal='$tgl'");
			}else
			{
				$sql = mysqli_query($db,"select * from daftar_akte where tanggal='$tanggal_skrg'");
			}
			...
			<tr>
				...
				<td><small><?php echo $data['nama_bayi']; ?></small></td>
				...
				<td class="block"><small>
					...
					//{
						...
						echo "<a href='form-terima-opr-akte.php?id=".$data['id']." '>Terima</a> |";
					//}else{
							//echo  "Terima | <a href='form-selesai-opr.php?id=".$data['id']."'>Status</a> | "; 
							echo  "<a href='form-selesai-opr-akte.php?id=".$data['id']."'>Status</a> | ";
					//}
					echo "<a href='form-keterangan-akte.php?id=".$data['id']."'> Ket</a>  | ";

						
					echo "<a onclick=\"return confirm('Yakin akan hapus data ini?')\" href='hapus-keterangan-akte.php?id=".$data['id']."'> Hapus </a> ";
					?>
				</small></td>
