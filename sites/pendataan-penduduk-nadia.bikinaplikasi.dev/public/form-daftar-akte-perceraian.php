...
<html>
<head>
    <title> Pendaftaran Akte Perceraian</title>
</head>
...
<form action="proses-pendaftaran-akte-perceraian.php" method="POST">
<div class="container">
  <div class="panel bg-primary text-white">
    <div class="panel panel-success" ><H3>Pendaftaran Akte Perceraian</h3></div>
  </div>
