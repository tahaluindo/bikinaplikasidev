...
<html>
<head>
    <title> Pendaftaran Akte Perkawinan</title>
</head>
...
<form action="proses-pendaftaran-akte-perkawinan.php" method="POST">
<div class="container">
  <div class="panel bg-primary text-white">
    <div class="panel panel-success" ><H3>Pendaftaran Akte Perkawinan</h3></div>
  </div>
    ...
    <table class="table  table-sm">
        ...
        <tr>
            <th width="200px">Nama Suami:</th>
            <th><input type="text" required maxlength="50" class="form-control form-control-sm" name="nama_suami" placeholder="Nama Suami"  ></th>
        </tr> 
        
        <tr>
            <th width="200px">Nama Istri:</th>
            <th><input type="text" required maxlength="50" class="form-control form-control-sm" name="nama_istri" placeholder="Nama Istri"  ></th>
        </tr> 

        <tr>
            <th width="200px">Kepala Keluarga:</th>
            <th><input type="text" required maxlength="16" class="form-control form-control-sm" name="kepala_keluarga" placeholder="Nama Kepala Keluarga"  ></th>
        </tr> 
		...
		<tr>
            <th>Operator:</th>
            <th>
					<select required name="operator" id="operator" class="form-control form-control-sm" required>
