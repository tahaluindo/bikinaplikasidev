...
$sql = "SELECT * FROM daftar_kk WHERE id=$id";
...
<body>
<form action="proses-keterangan-kk.php" method="POST">
...
<div class="container">
  <div class="panel bg-primary text-white">
    ...
    <table class="table  table-sm">
		...
		<tr>
            <th>Operator:</th>
            <th><?php echo $warga['operator'] ?>
			</th>
        </tr>
		<tr>
            <th>Jam Terima Operator:</th>
            <th><?php echo $warga['jam_dtrm_opr'] ?></th>
        </tr>
		<tr>
            <th>Keterangan:</th>
