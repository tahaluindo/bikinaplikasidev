...
if(isset($_POST['daftar'])){
    ...
    // buat query
    $sql = "INSERT INTO daftar_akte_perceraian (tanggal,    no_kk,  nama_suami, nama_istri, kec,          kel,    penerima,    jam_terima, jam_dtrm_opr, jam_slsai_opr, status,               ket, kepala_keluarga, operator) 
