...
<body>
	...
	<center>
		...
		<tr>
			<td>
					<a href="form-daftar-akte-kematian.php" class="btn btn-primary">Daftar Baru</a>
					<a href="cetak-pra-akte-kematian.php" class="btn btn-primary">Cetak</a>
			</td>
			<td class="align-top">
				<form method="get">
			...
			<tr>
				...
				<td class="block"><small>
					...
					//{
						...
						echo "<a href='form-terima-opr-akte-kematian.php?id=".$data['id']." '>Terima</a> |";
					//}else{
							//echo  "Terima | <a href='form-selesai-opr.php?id=".$data['id']."'>Status</a> | "; 
							echo  "<a href='form-selesai-opr-akte-kematian.php?id=".$data['id']."'>Status</a> | ";
					//}
					echo "<a href='form-keterangan-akte-kematian.php?id=".$data['id']."'> Ket</a>  | ";

						
					echo "<a onclick=\"return confirm('Yakin akan hapus data ini?')\" href='hapus-keterangan-akte-kematian.php?id=".$data['id']."'> Hapus </a> ";
					?>
				</small></td>
