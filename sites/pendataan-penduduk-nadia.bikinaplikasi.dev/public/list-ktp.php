	...
	<center>
		...
		<tbody>
			...
			<tr>
				...
				<td><small><?php echo $data['selesai_operator']; ?></small></td>
				<?php	
				...
				<td class="block"><small>
					<?php 
						echo  "<a href='form-selesai-opr-ktp.php?id=".$data['id']."'>Status</a> | ";
						echo "<a href='form-keterangan-ktp.php?id=".$data['id']."'> Ket</a> | ";

						
						echo "<a onclick=\"return confirm('Yakin akan hapus data ini?')\" href='hapus-keterangan-ktp.php?id=".$data['id']."'> Hapus </a> ";
					?>
				</small></td>
