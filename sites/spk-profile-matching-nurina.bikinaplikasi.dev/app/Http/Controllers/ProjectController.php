...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'tanggal_akhir_daftar'            => 'required|date',
            'tanggal_akhir_perubahan_profile' => 'required|date',
        ...
        return redirect()->route('project.index')->with("success", "Berhasil menambah penerima beasiswa");
    }
    ...
    public function update(Request $request, Project $project)
    {
        ...
        return redirect()->route('project.index')->with("success", "Berhasil mengupdate penerima beasiswa");
    }
    ...
    public function destroy(Project $project)
    {
        ...
        return redirect()->route('project.index')->with("success", "Berhasil menghapus penerima beasiswa");
    }
    ...
    public function register(Project $project)
    {
        ...
        return redirect()->back()->with('success', 'Berhasil meregistrasi alternatif ke data penerima beasiswa ini');
    }
}
