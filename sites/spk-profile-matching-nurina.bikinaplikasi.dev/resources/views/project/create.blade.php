...
@section('page') Tambah Data Penerima Beasiswa @endsection
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="date" placeholder="Tanggal Mulai Daftar"
                            ...
                            value='{{ old('tanggal_mulai_daftar') }}' name='tanggal_mulai_daftar'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="date" placeholder="Tanggal Akhir Daftar"
                            ...
                            value='{{ old('tanggal_akhir_daftar') }}' name='tanggal_akhir_daftar'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="date" placeholder="Tanggal Akhir Perubahan Profile"
                            ...
                            value='{{ old('tanggal_akhir_perubahan_profile') }}' name='tanggal_akhir_perubahan_profile'>
