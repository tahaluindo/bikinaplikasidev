        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    @forelse($materi->mapel_detail_ids as $mapel_detail_id)
                    @php 
                    $mapel_detail = \App\MapelDetail::find($mapel_detail_id); 
                    if(!$mapel_detail) continue;
                    @endphp
                    <li>{{ $mapel_detail->kelas->nama }} - {{ $mapel_detail->mapel->nama }}</li>
                    @empty
                    <li>Tidak ada mapel dan kelas yang anda ajar</li>
                    @endforelse
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ url($file) }}" download="{{ $file }}">{{ Str::limit($file, 50) }}</a>
                    </li>
                    @endforeach
                    @endif
                </ul>
