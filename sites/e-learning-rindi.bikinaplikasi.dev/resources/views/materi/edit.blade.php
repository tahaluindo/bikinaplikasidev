        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-block">
                    <form class="form-horizontal form-material" action="{{ url(route('materi.update', ['materi' => $materi->id])) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline">
                                  <label class="form-check-label">
                                    ...
                                    @if($mapel_detail->id == old("mapel_detail_id.$index") || in_array($mapel_detail->id, $materi->mapel_detail_ids)) checked @endif name="mapel_detail_ids[]">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Judul Materi"
                                    ...
                                    value='{{ old('judul') == "" ? $materi->judul : old('judul') }}' name='judul' required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="url" placeholder="Link Materi"
                                    ...
                                    value='{{ old('link') == "" ? $materi->link : old('link') }}' name='link'>
                        ...
                        <div class="form-group">
                            <ul>
                                <li class="d-block">
                                    <strong>List Files Terupload</strong>
                                </li>
