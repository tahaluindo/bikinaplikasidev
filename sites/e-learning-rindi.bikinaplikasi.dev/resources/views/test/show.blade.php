...
<body>
    <div class="container" style="margin:0px auto">
        <h1 class='text-center' style='margin-left: -250px;'>{{ $test->nama }}</h1>
                                    ...
                                    <li class="font-size-30 answer-number">
                                        <input type="radio" data-alternatetype="radio"
                                            ...
                                            class="answer-text"><span></span> 
                                             <span >{{ preg_replace('/&nbsp;|<\/p>|<p>|<div>|<\/div>/', '', $soal->opsi_a) }}</span>
                                        </label>
                                    </li>
                                    <li class="font-size-30 answer-number">
                                        <input type="radio" data-alternatetype="radio"
                                            ...
                                            class="answer-text" ><span></span>
                                            <span >{{ preg_replace('/&nbsp;|<\/p>|<p>|<div>|<\/div>/', '', $soal->opsi_b) }}</span>
                                        </label>
                                    </li>
                                    <li class="font-size-30 answer-number">
                                        <input type="radio" data-alternatetype="radio"
                                            ...
                                            class="answer-text"><span></span>
                                            <span >{{ preg_replace('/&nbsp;|<\/p>|<p>|<div>|<\/div>/', '', $soal->opsi_c) }}</span>
                                        </label>
                                    </li>
                                    <li class="font-size-30 answer-number">
                                        <input type="radio" data-alternatetype="radio"
                                            ...
                                            class="answer-text"><span></span>
                                            <span >{{ preg_replace('/&nbsp;|<\/p>|<p>|<div>|<\/div>/', '', $soal->opsi_d) }}</span>
                                        </label>
                                    </li>
                                </ol>
                                @else
