        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-block">
                    ...
                    <form class="form-horizontal form-material" action="{{ url(route('test.store')) }}"
                            ...
                            <div class="col-md-12">
                                @foreach($mapel_details as $index => $mapel_detail)
                                    <div class="pretty p-switch p-fill">
                                        ...
                                        @if($mapel_detail->id == old("mapel_detail_ids.$index")) checked @endif name="mapel_detail_ids[]">
                        ...
                        <div class="form-group">
                            <label class="col-md-12">Nama Kuis</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="Jumlah Soal"
                                    ...
                                    value='{{ old('jumlah_soal') }}' name='jumlah_soal' required min="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="number" placeholder="Jumlah Menit"
                                    ...
                                    value='{{ old('jumlah_menit') }}' name='jumlah_menit' required min="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="jenis_soal form-control w-100" name='jenis_soal'>
                                    <option @if(old('jenis_soal')=='Latihan') selected @endif value='Latihan'>
                                        Latihan</option>
                                    <option @if(old('jenis_soal')=='Ujian') selected @endif value='Ujian'>
                                        Ujian</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="mode form-control w-100" name='mode' id="mode" required>
                                    ...
                                    <option @if(old('mode')=='Essay Acak') selected @endif value='Essay Acak'>
                                        Essay Acak</option>
                                    <option @if(old('mode')=='Essay Normal') selected @endif value='Essay Normal'>
                                        Essay Normal</option>
                                    <option @if(old('mode')=='Pilgan Acak') selected @endif value='Pilgan Acak'>
                                        Pilgan Acak</option>
                                    <option @if(old('mode')=='Pilgan Normal') selected @endif value='Pilgan Normal'>
                        ...
                        <input type="hidden" name="soal_ids" id="soal_ids" value="{{ old('soal_ids') == "" || old('soal_ids') == "[]" ? "[]" : json_encode(array_unique($soal_ids)) }}">
                ...
                <ul class="p-0" data-mapel-detail-id="{{ $mapel_detail->id }}" data-mode="Pilgan Normal" data-jenis="Latihan">
                    ...
                    <li class="d-block">
                        <table class="table table-responsive table-striped w-100 table-sm">
                            ...
                            <tbody>
                                @foreach($mapel_detail->mapel->soal_pilgans->where('jenis', "Latihan") as $soal_pilgan)
                                <tr>
                                    <td>{{ $loop->iteration }}.</td>
                                    <td class='replace'>{{ substr($soal_pilgan->soal, 0, 100) }}...</td>
                                    <td class="text-right">
                                        <div class="pretty p-switch p-fill">
                                            <input class="form-check-input" type="checkbox" value="{{ $soal_pilgan->id }}"
                                            @if($soal_pilgan->id == old("soal_pilgan.$index") || in_array($soal_pilgan->id, $soal_ids)) checked @endif name="soal_pilgan[]">
                                            <div class="state p-success">
                                                <label></label>
                                            </div>
                                        </div>
                ...
                <ul class="p-0" data-mapel-detail-id="{{ $mapel_detail->id }}" data-mode="Pilgan Normal" data-jenis="Ujian">
                    ...
                    <li class="d-block">
                        <table class="table table-responsive table-striped w-100 table-sm">
                            ...
                            <tbody>
                                @foreach($mapel_detail->mapel->soal_pilgans->where('jenis', "Ujian") as $soal_pilgan)
                                <tr>
                                    <td>{{ $loop->iteration }}.</td>
                                    <td class='replace'>{{ substr($soal_pilgan->soal, 0, 100) }}...</td>
                                    <td class="text-right">
                ...
                <ul class="p-0" data-mapel-detail-id="{{ $mapel_detail->id }}" data-mode="Essay Normal" data-jenis="Latihan">
                    ...
                    <li class="d-block">
                        <table class="table table-responsive table-striped w-100 table-sm">
                            ...
                            <tbody>
                                @foreach($mapel_detail->mapel->soal_essays->where('jenis', "Latihan") as $soal_essay)
                                <tr>
                                    <td>{{ $loop->iteration }}.</td>
                                    <td class='replace'>{{ substr($soal_essay->soal, 0, 100) }}...</td>
                                    <td class="text-right">
                                        <div class="pretty p-switch p-fill">
                                            <input class="form-check-input" type="checkbox" value="{{ $soal_essay->id }}"
                                            @if($soal_essay->id == old("soal_essay.$index") || in_array($soal_essay->id, $soal_ids)) checked @endif name="soal_essay[]">
                                            <div class="state p-success">
                                                <label></label>
                                            </div>
                                        </div>
                ...
                <ul class="p-0" data-mapel-detail-id="{{ $mapel_detail->id }}" data-mode="Essay Normal" data-jenis="Ujian">
                    ...
                    <li class="d-block">
                        <table class="table table-responsive table-striped w-100 table-sm">
                            ...
                            <tbody>
                                @foreach($mapel_detail->mapel->soal_essays->where('jenis', "Ujian") as $soal_essay)
                                <tr>
                                    <td>{{ $loop->iteration }}.</td>
                                    <td class='replace'>{{  substr($soal_essay->soal, 0, 100)  }}...</td>
                                    <td class="text-right">
