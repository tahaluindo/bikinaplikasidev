...
class SekolahsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('sekolahs')->insert(array (
            ...
            array (
                'id' => 1,
                'nama' => 'SMAN 8 Tanjung jabung timur',
                'no_telp' => '085368739455',
                'alamat' => 'Jl.Kapten A.Bakarudin Kel.Beliung Kec.Alam Barajo Tanjung jabung timur Kode Pos 36125',
                'deskripsi' => '<p>Adalah salah satu sekolah SMA di Tanjung jabung timur</p>',
