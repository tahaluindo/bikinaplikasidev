<div class="form-group {{ $errors->has('nama') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="nama" class="form-control form-control-line @error('nama') is-invalid @enderror" name="nama"
               type="text" id="nama" value="{{ isset($pasien->nama) ? $pasien->nama : old('nama') }}">
...
<div class="form-group {{ $errors->has('umur') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <input placeholder="umur" class="form-control form-control-line @error('umur') is-invalid @enderror" name="umur"
               type="number" id="umur" value="{{ isset($pasien->umur) ? $pasien->umur : old('umur') }}">
...
<div class="form-group">
    <div class="col-sm-12">
        <button class="btn btn-success" type="submit">Simpan & Lanjutkan Ke Riwayat Berobat >></button>
    </div>
</div>
