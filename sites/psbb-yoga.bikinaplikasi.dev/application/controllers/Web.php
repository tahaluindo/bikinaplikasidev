            ...
            if (!$this->upload->do_upload('file_persyaratan')) {
                ...
                $this->session->set_flashdata('msg',
					...
					<div class="alert alert-warning alert-dismissible" role="alert">
						 ...
						 <strong>Gagal Mendaftar PPDB Online!</strong> Maaf <b>' . $nama_lengkap . '</b> tidak bisa mendaftar PPDB dikarenakan gagal mengupload file.
					</div>'
                );
                redirect('pendaftaran');
            }

            $file_persyaratan = "assets/uploads/" . $this->upload->data('file_name');
