      ...
      <div class="panel panel-flat bg-info">
        <div class="panel-heading">
          <h3 class="panel-title">
            <center>Selamat Datang Calon Siswa SMK Negeri 9 Muaro Jambi, <?php echo ucwords($nama); ?></center>
          </h3>
        </div>
      </div>
      <!-- /basic datatable -->
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-flat bg-success">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    <i class="glyphicon glyphicon-bullhorn"></i> Selamat <b><?php echo $nama; ?></b> <span class="label label-info" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Peserta Didik Baru <b>SMK Negeri 9 Muaro Jambi</b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
                    <hr style="margin:0px;margin-bottom:10px;">
                    <a href="<?= base_url("panel_admin/set_pengumuman/download_kelulusan/$cek->no_pendaftaran") ?>" class="btn btn-default btn-lg" target="_blank"><i class="icon-printer4"></i> Cetak Bukti Lulus</a>
                  </center>
                </h4>
              </div>
            </div>
              ...
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    ...
                    Sebagai Calon Peserta Didik Baru <b>SMK Negeri 9 Muaro Jambi</b>.
                  </center>
                </h4>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              <!-- Current server load -->
            <center>
              <a href="files/Panduan_PPDB_Online_SMKN9MuaroJambi.pdf">
