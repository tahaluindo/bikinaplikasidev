            ...
            <div class="col-md-3">
                <div class="panel panel-flat">
                    <div class="panel-body">
                        <center>
                            <img src="assets/panel/images/default.png" alt="<?php echo $user->nama_lengkap; ?>" class=""
                                 width="176">
                        </center>
                        <br>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <td><a href="<?= base_url($user->file_persyaratan) ?>"
                                               target="_blank"><?= strlen($user->file_persyaratan) ? "Lihat" : "-- Tidak Ada --" ?></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Status</th>
                                        ...
                                        <td align="left">
                                            <?php if (!$user->status_verifikasi == 0) { ?>
                                                <a class="btn btn-info btn-xs" title="Verifikasi"><i
                                                            class="icon-checkmark4"></i> Terverifikasi</a>
                                            <?php } else { ?>
                                                <a class="btn btn-danger btn-xs" title="Batal Verifikasi">Belum Diverifikasi<i
