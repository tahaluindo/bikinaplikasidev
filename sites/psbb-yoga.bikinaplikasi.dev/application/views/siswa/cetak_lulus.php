...
<html>
  ...
  <body onload="window.print();">
    ...
    <table width="100%" border="0">
      <tr>
        <td colspan="3">Kepala SMK Negeri 9 Muaro Jambi dengan ini menyatakan bahwa :</td>
      </tr>
      <tr>
    ...
    <div style="float:right;">
      Muaro Jambi, 07 Juli <?php echo date('Y'); ?> <br>
			Kepala Sekolah,  <br>
      <br>
      <center>dto</center>
      <b><u>Ir. INGGIT GUNARSIH S.pd</u></b><br>
      NIP. 196507262005012001
    </div>
    <br><br><br><br><br><br>
