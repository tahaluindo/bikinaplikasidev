...
<head>
    ...
    <title>PPDB SMK 9 Muaro Jambi</title>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> SMK 9 Muaro Jambi</strong></h2>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SMK 9 Muaro Jambi hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="http://www.sman1belitang.sch.id" target="_blank">SMK 9 Muaro Jambi</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
