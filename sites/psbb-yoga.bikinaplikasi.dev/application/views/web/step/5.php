<div class="panel panel-primary">
  ...
  <div class="form-group">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Rayon SMK Negeri 9 Muaro Jambi <span class="text-danger">*</span></label>
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Rayon SMK Negeri 9 Muaro Jambi" name="rayonisasi" data-parsley-group="block4" data-parsley-errors-container='div[id="error-rayonisasi"]' required>
                <option value=""> - Rayon SMK Negeri 9 Muaro Jambi - </option>
