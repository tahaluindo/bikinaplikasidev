          ...
          <div class="heading-elements">
            <ul class="icons-list">
              <li><a data-action="collapse"></a></li>
                    ...
                    <a href="panel_admin/update_kelulusan/<?= $this->uri->segment(4) ?>" class="btn btn-warning" onclick="return confirm('Anda yakin? Berkas yang belum diverifikasi tidak akan diluluskan!')">Update Kelulusan</a>
                  ...
                  <td align="center">
                    <?php if ($baris->status_pendaftaran == 'lulus') {?>
                      <label class="label label-success">Lulus</label>
                        <a href="panel_admin/set_pengumuman/download_kelulusan/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-xs" title="Lulus" target="_blank"><i class="icon-download"></i> Surat Pengumuman Kelulusan</a>
                    <?php }elseif ($baris->status_pendaftaran == 'tidak lulus') {?>
                      <label class="label label-danger">Tidak Lulus</label>
                        <a href="panel_admin/set_pengumuman/download_kelulusan/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-xs" title="Tidak Lulus" target="_blank"><i class="icon-download"></i> Surat Pengumuman Kelulusan</a>
                    <?php }else{ ?>
