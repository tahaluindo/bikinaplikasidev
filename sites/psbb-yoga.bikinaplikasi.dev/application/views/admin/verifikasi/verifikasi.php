          ...
          <div class="heading-elements">
            <ul class="icons-list">
              <li><a data-action="collapse"></a></li>
                    ...
                    <br>
                    <a href="panel_admin/edit_materi" class="btn btn-primary" style="visibility: hidden;">Edit Materi & Jadwal Ujian</a>
          ...
          <tbody>
              ...
              foreach ($v_siswa->result() as $baris) {?>
                <tr>
                  ...
                  <td><a href="<?= strlen($baris->file_persyaratan) ? base_url($baris->file_persyaratan) : "-" ?>" target="_blank"><?= strlen($baris->file_persyaratan) ? "Lihat" : "-- Tidak Ada --" ?></a></td>
                  <td align="center">
