                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material"
                            action="{{ route('transaksi_lainnya_detail.update', ['transaksi_lainnya' => $transaksiLainnya->id, 'transaksi_lainnya_detail' => $transaksiLainnyaDetail->id]) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="number" placeholder="100000"
                                        ...
                                        value='{{ old('nominal_dibayar') == "" ? $transaksiLainnyaDetail->nominal_dibayar : old('nominal_dibayar') }}'
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control form-control-line" name='status'>
                                        <option value="Lunas" @if(old('status')=="Lunas" || $transaksiLainnyaDetail->status == "Lunas") selected @endif>Lunas
                                        </option>
                                        <option value="Belum Lunas" @if(old('status')=="Belum Lunas" || $transaksiLainnyaDetail->status == "Belum Lunas" ) selected @endif>
                                            Belum Lunas</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text"
                                        ...
                                        value='{{ old('tanggal_bayar') == "" ? $transaksiLainnyaDetail->tanggal_bayar : old('tanggal_bayar') }}'
                            ...
                            {{--  <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea id='editor-1' style="height: 130px !important;"
                                        ...
                                        name='catatan'>{{ old('catatan') == "" ? $transaksiLainnyaDetail->catatan : old('catatan') }}</textarea>
