<div class='row'>
    <div class='col-md-6'>
    <form class="form-horizontal form-material" action="{{ url(route('gerejaku.print')) }}"
    ...
    <div class="form-group">
        ...
        <div class="col-md-12">
            <select class="form-control form-control-line" name='field'  required>
                @foreach(['id','created_at','updated_at','pemilik','alamat_lengkap','alamat_gmaps','deskripsi','no_hp','jumlah_kamar','fasilitas','gambar','kategori','harga_terendah','harga_tertinggi'] as $field)
