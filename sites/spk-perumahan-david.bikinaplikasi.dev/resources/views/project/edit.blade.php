...
@section('page') Edit Data Pemilih Rumah @endsection
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <select class="form-control form-control-line" name='lokasi_id'>
                            ...
                            <option value="{{ $lokasi->id }}" @if(old('lokasi_id') == $lokasi->id || $project->lokasi_id == $lokasi->id) selected @endif>{{ $lokasi->lokasi }}</option>
                            @endforeach
                        </select>
