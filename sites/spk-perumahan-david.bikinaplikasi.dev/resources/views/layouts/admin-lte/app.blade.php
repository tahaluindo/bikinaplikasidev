...
{{--                            <img src="{{ url('foto/logo.png') }}" class='logo-gambar'>--}}
                            <h3 style="margin:-5px 0 0; display: inline;">SPK Pemilihan Rumah Astri Garden 9</h3>
                        </a>
        ...
        <aside class="left-side sidebar-offcanvas" style="min-height: 248px;">
            <section class="sidebar" style="padding-top: 51px;">
                <ul class="sidebar-menu">
                    ...
                    <li class="">
                        <a href="{{ url('type') }}">
                            <i class="fa fa-table"></i> <span>Type</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="">
                        <a href="{{ url('lokasi') }}">
                            <i class="fa fa-table"></i> <span>Lokasi</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="">
                        <a href="{{ url('rumah') }}">
                            <i class="fa fa-table"></i> <span>Rumah</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="">
                        @if(auth()->user()->level == "Admin")
                        <a href="{{ url('project') }}">
                            <i class="fa fa-table"></i> <span>Data Pemilih Rumah</span>
                        </a>
                        @else
                    ...
                    <li class="">
                        <a href="{{ url('project') }}">
                            <i class="fa fa-table"></i> <span>Data Permilih Rumah</span>
